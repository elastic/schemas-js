...
import _inputSchemaRaw from '../../../kibana/json/elastic-package-manager-epm.delete-fleet-epm-packages-pkgname-pkgversion-datastream-assets.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const delete_fleet_epm_packages_pkgname_pkgversion_datastream_assetsDefinitions: KbApiDefinition[] = [
  {
