...
import _inputSchemaRaw from '../../../kibana/json/elastic-package-manager-epm.get-fleet-epm-packages-installed.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_fleet_epm_packages_installedDefinitions: KbApiDefinition[] = [
  {
