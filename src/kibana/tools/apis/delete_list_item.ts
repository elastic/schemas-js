...
import _inputSchemaRaw from '../../../kibana/json/security-lists-api.delete-list-item.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const delete_list_itemDefinitions: KbApiDefinition[] = [
  {
