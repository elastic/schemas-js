...
import _inputSchemaRaw from '../../../kibana/json/elastic-agents.post-fleet-agents-bulk-privilege-level-change.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const post_fleet_agents_bulk_privilege_level_changeDefinitions: KbApiDefinition[] = [
  {
