...
import _inputSchemaRaw from '../../../kibana/json/fleet-agentless-policies.post-fleet-agentless-policies.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const post_fleet_agentless_policiesDefinitions: KbApiDefinition[] = [
  {
