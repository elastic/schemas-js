...
import _inputSchemaRaw from '../../../kibana/json/apm-agent-configuration.get-agent-name-for-service.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_agent_name_for_serviceDefinitions: KbApiDefinition[] = [
  {
