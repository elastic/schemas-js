...
import _inputSchemaRaw from '../../../kibana/json/security-timeline-api.copy-timeline.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const copy_timelineDefinitions: KbApiDefinition[] = [
  {
    name: 'copy-timeline',
