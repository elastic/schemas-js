...
import _inputSchemaRaw from '../../../kibana/json/security-osquery-api.osquery-get-live-query-details.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const osquery_get_live_query_detailsDefinitions: KbApiDefinition[] = [
  {
