...
import _inputSchemaRaw from '../../../kibana/json/elastic-agents.get-fleet-agents-tags.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_fleet_agents_tagsDefinitions: KbApiDefinition[] = [
  {
