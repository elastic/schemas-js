...
import _inputSchemaRaw from '../../../kibana/json/security-attack-discovery-api.get-attack-discovery-generations.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_attack_discovery_generationsDefinitions: KbApiDefinition[] = [
  {
