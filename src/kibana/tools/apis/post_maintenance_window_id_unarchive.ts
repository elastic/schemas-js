...
import _inputSchemaRaw from '../../../kibana/json/maintenance-window.post-maintenance-window-id-unarchive.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const post_maintenance_window_id_unarchiveDefinitions: KbApiDefinition[] = [
  {
