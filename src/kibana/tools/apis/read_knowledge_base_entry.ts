...
import _inputSchemaRaw from '../../../kibana/json/security-ai-assistant-api.read-knowledge-base-entry.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const read_knowledge_base_entryDefinitions: KbApiDefinition[] = [
  {
