...
import _inputSchemaRaw from '../../../kibana/json/security-exceptions-api.read-exception-list.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const read_exception_listDefinitions: KbApiDefinition[] = [
  {
