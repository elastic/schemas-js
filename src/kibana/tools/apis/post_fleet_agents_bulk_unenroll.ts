...
import _inputSchemaRaw from '../../../kibana/json/elastic-agent-actions.post-fleet-agents-bulk-unenroll.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const post_fleet_agents_bulk_unenrollDefinitions: KbApiDefinition[] = [
  {
