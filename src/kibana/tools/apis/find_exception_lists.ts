...
import _inputSchemaRaw from '../../../kibana/json/security-exceptions-api.find-exception-lists.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const find_exception_listsDefinitions: KbApiDefinition[] = [
  {
