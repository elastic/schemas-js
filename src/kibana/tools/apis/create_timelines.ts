...
import _inputSchemaRaw from '../../../kibana/json/security-timeline-api.create-timelines.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const create_timelinesDefinitions: KbApiDefinition[] = [
  {
