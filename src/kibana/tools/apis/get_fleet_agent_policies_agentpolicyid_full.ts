...
import _inputSchemaRaw from '../../../kibana/json/elastic-agent-policies.get-fleet-agent-policies-agentpolicyid-full.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_fleet_agent_policies_agentpolicyid_fullDefinitions: KbApiDefinition[] = [
  {
