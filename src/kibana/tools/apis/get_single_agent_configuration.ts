...
import _inputSchemaRaw from '../../../kibana/json/apm-agent-configuration.get-single-agent-configuration.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_single_agent_configurationDefinitions: KbApiDefinition[] = [
  {
