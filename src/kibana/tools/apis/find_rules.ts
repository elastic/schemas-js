...
import _inputSchemaRaw from '../../../kibana/json/security-detections-api.find-rules.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const find_rulesDefinitions: KbApiDefinition[] = [
  {
    name: 'find-rules',
