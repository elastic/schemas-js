...
import _inputSchemaRaw from '../../../kibana/json/agent-builder.get-agent-builder-plugins-pluginid.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_agent_builder_plugins_pluginidDefinitions: KbApiDefinition[] = [
  {
