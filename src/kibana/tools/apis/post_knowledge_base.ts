...
import _inputSchemaRaw from '../../../kibana/json/security-ai-assistant-api.post-knowledge-base.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const post_knowledge_baseDefinitions: KbApiDefinition[] = [
  {
