...
import _inputSchemaRaw from '../../../kibana/json/apm-annotations.create-annotation.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const create_annotationDefinitions: KbApiDefinition[] = [
  {
