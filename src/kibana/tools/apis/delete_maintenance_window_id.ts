...
import _inputSchemaRaw from '../../../kibana/json/maintenance-window.delete-maintenance-window-id.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const delete_maintenance_window_idDefinitions: KbApiDefinition[] = [
  {
