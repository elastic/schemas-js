...
import _inputSchemaRaw from '../../../kibana/json/fleet-package-policies.get-fleet-package-policies-packagepolicyid.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_fleet_package_policies_packagepolicyidDefinitions: KbApiDefinition[] = [
  {
