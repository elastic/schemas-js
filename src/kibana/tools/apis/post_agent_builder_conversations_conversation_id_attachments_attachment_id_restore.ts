...
import _inputSchemaRaw from '../../../kibana/json/post_agent_builder_conversations_conversation_id_attachments_attachment_id_restore.request.json' with { type: 'json' }
