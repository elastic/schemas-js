...
import _inputSchemaRaw from '../../../kibana/json/security-attack-discovery-api.update-attack-discovery-schedules.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const update_attack_discovery_schedulesDefinitions: KbApiDefinition[] = [
  {
