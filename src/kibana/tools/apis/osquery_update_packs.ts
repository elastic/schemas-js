...
import _inputSchemaRaw from '../../../kibana/json/security-osquery-api.osquery-update-packs.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const osquery_update_packsDefinitions: KbApiDefinition[] = [
  {
