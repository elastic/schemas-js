...
import _inputSchemaRaw from '../../../kibana/json/security-timeline-api.persist-favorite-route.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const persist_favorite_routeDefinitions: KbApiDefinition[] = [
  {
