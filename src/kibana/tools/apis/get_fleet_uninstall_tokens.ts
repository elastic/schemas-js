...
import _inputSchemaRaw from '../../../kibana/json/fleet-uninstall-tokens.get-fleet-uninstall-tokens.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_fleet_uninstall_tokensDefinitions: KbApiDefinition[] = [
  {
