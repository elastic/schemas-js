...
import _inputSchemaRaw from '../../../kibana/json/security-endpoint-management-api.get-protection-updates-note.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const get_protection_updates_noteDefinitions: KbApiDefinition[] = [
  {
