...
import _inputSchemaRaw from '../../../kibana/json/security-entity-analytics-api.init-entity-engine.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const init_entity_engineDefinitions: KbApiDefinition[] = [
  {
