...
import _inputSchemaRaw from '../../../kibana/json/security-endpoint-management-api.endpoint-file-download.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const endpoint_file_downloadDefinitions: KbApiDefinition[] = [
  {
