...
import _inputSchemaRaw from '../../../kibana/json/fleet-agentless-policies.delete-fleet-agentless-policies-policyid.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const delete_fleet_agentless_policies_policyidDefinitions: KbApiDefinition[] = [
  {
