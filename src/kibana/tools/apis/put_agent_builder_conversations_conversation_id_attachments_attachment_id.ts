...
import _inputSchemaRaw from '../../../kibana/json/agent-builder.put-agent-builder-conversations-conversation-id-attachments-attachment-id.request.json' with { type: 'json' }
