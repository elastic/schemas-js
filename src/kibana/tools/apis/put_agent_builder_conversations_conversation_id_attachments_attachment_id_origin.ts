...
import _inputSchemaRaw from '../../../kibana/json/agent-builder.put-agent-builder-conversations-conversation-id-attachments-attachment-id-origin.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const put_agent_builder_conversations_conversation_id_attachments_attachment_id_originDefinitions: KbApiDefinition[] = [
  {
