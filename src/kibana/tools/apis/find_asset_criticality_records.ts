...
import _inputSchemaRaw from '../../../kibana/json/security-entity-analytics-api.find-asset-criticality-records.request.json' with { type: 'json' }
import type { KbApiDefinition } from '../types.ts'

const _inputSchema = _inputSchemaRaw as unknown as JsonSchemaObject

export const find_asset_criticality_recordsDefinitions: KbApiDefinition[] = [
  {
