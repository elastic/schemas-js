...
}).meta({ id: 'GetFleetCloudOnboardingDeploymentsIdResponse' })
export type GetFleetCloudOnboardingDeploymentsIdResponse = z.infer<typeof GetFleetCloudOnboardingDeploymentsIdResponse>
