...
export const PutMarkdownsIdRequest = z.object({
  ...
  title: z.string()
}).meta({ id: 'PutMarkdownsIdRequest' })
export type PutMarkdownsIdRequest = z.infer<typeof PutMarkdownsIdRequest>

export const PutMarkdownsIdResponse200 = z.object({
  data: z.object({
    content: z.string(),
    description: z.string().optional(),
    settings: z.object({
...
}).meta({ id: 'PutMarkdownsIdResponse200' })
export type PutMarkdownsIdResponse200 = z.infer<typeof PutMarkdownsIdResponse200>

export const PutMarkdownsIdResponse201 = z.object({
  data: z.object({
    content: z.string(),
    description: z.string().optional(),
    settings: z.object({
