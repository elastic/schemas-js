...
export const Kibana_HTTP_APIs_new_output_otlp = z.object({
  ...
  type: z.enum(['otlp'])
}).meta({ id: 'Kibana_HTTP_APIs_new_output_otlp' })
export type Kibana_HTTP_APIs_new_output_otlp = z.infer<typeof Kibana_HTTP_APIs_new_output_otlp>

export const Kibana_HTTP_APIs_new_output_elasticsearch = z.object({
  allow_edit: z.array(z.string()).optional(),
...
}).meta({ id: 'Kibana_HTTP_APIs_new_output_kafka' })
export type Kibana_HTTP_APIs_new_output_kafka = z.infer<typeof Kibana_HTTP_APIs_new_output_kafka>

export const Kibana_HTTP_APIs_new_output_logstash = z.object({
  allow_edit: z.array(z.string()).optional(),
  ca_sha256: z.string().nullable().optional(),
  ca_trusted_fingerprint: z.string().nullable().optional(),
  config_yaml: z.string().nullable().optional(),
...
}).meta({ id: 'Kibana_HTTP_APIs_new_output_logstash' })
export type Kibana_HTTP_APIs_new_output_logstash = z.infer<typeof Kibana_HTTP_APIs_new_output_logstash>

export const Kibana_HTTP_APIs_new_output_remote_elasticsearch = z.object({
  allow_edit: z.array(z.string()).optional(),
  ca_sha256: z.string().nullable().optional(),
  ca_trusted_fingerprint: z.string().nullable().optional(),
  config_yaml: z.string().nullable().optional(),
  ...
  write_to_logs_streams: z.boolean().nullable().optional()
}).meta({ id: 'Kibana_HTTP_APIs_new_output_remote_elasticsearch' })
...
export const PostFleetOutputsRequest = z.discriminatedUnion('type', [Kibana_HTTP_APIs_new_output_elasticsearch, Kibana_HTTP_APIs_new_output_remote_elasticsearch, Kibana_HTTP_APIs_new_output_logstash, Kibana_HTTP_APIs_new_output_kafka, Kibana_HTTP_APIs_new_output_otlp]).meta({ id: 'PostFleetOutputsRequest' })
export type PostFleetOutputsRequest = z.infer<typeof PostFleetOutputsRequest>

export const PostFleetOutputsResponse = z.object({
...
}).meta({ id: 'PostFleetOutputsResponse' })
