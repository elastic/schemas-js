...
export const Security_Endpoint_Management_API_KillProcessRouteRequestBody = z.object({
...
})).meta({ id: 'Security_Endpoint_Management_API_KillProcessRouteRequestBody' })
