...
export const PutSecurityEntityStoreEntitiesBulkRequest = z.object({
  entities: z.array(z.object({
    doc: z.union([z.object({
    ...
    type: z.enum(['user', 'host', 'service', 'generic'])
  }))
}).meta({ id: 'PutSecurityEntityStoreEntitiesBulkRequest' })
