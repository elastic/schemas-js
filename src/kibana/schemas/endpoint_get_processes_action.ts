...
export const Security_Endpoint_Management_API_GetProcessesRouteRequestBody = z.object({
...
}).meta({ id: 'Security_Endpoint_Management_API_GetProcessesRouteRequestBody' })
