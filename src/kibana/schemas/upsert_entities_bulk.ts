...
export const Security_Entity_Analytics_API_EntityContainer = z.object({
  record: Security_Entity_Analytics_API_Entity,
  type: Security_Entity_Analytics_API_EntityType
}).meta({ id: 'Security_Entity_Analytics_API_EntityContainer' })
export type Security_Entity_Analytics_API_EntityContainer = z.infer<typeof Security_Entity_Analytics_API_EntityContainer>

export const Security_Entity_Analytics_API_EntitiesContainer = z.object({
  entities: z.array(Security_Entity_Analytics_API_EntityContainer)
}).meta({ id: 'Security_Entity_Analytics_API_EntitiesContainer' })
