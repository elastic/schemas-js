...
export const Security_Exceptions_API_ExceptionListType = z.enum(['detection', 'rule_default', 'endpoint', 'endpoint_trusted_apps', 'endpoint_trusted_devices', 'endpoint_events', 'endpoint_host_isolation_exceptions', 'endpoint_blocklists']).meta({ id: 'Security_Exceptions_API_ExceptionListType' })
