...
export const Kibana_HTTP_APIs_alerting_action_policy_list_response = z.object({
  items: z.array(Kibana_HTTP_APIs_alerting_action_policy_response),
  page: z.number(),
  per_page: z.number(),
  total: z.number()
}).meta({ id: 'Kibana_HTTP_APIs_alerting_action_policy_list_response' })
