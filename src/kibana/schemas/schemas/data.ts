...
export const Data_views_400_response = z.object({
  ...
  message: z.string(),
  statusCode: z.number()
}).meta({ id: 'Data_views_400_response' })
export type Data_views_400_response = z.infer<typeof Data_views_400_response>

export const Data_views_404_response = z.object({
  error: z.enum(['Not Found']).optional(),
  message: z.string().optional(),
  statusCode: z.literal(404).optional()
}).meta({ id: 'Data_views_404_response' })
export type Data_views_404_response = z.infer<typeof Data_views_404_response>
