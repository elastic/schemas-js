...
import { z } from 'zod'
import { Security_Detections_API_RuleResponse, Security_Detections_API_WarningSchema } from './schemas/security.js'
...
export const FindRulesResponse = z.object({
  ...
  perPage: z.number(),
  total: z.number(),
  warnings: z.array(Security_Detections_API_WarningSchema).optional()
}).meta({ id: 'FindRulesResponse' })
