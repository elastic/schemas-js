...
import { z } from 'zod'
import { MlFlushJobRequest } from '../../../es/schemas/ml.flush_job.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlFlushJobRequest) as Record<string, unknown>
...
export const ml_flush_job_definitions: EsApiDefinition[] = [
  {
    name: 'flush-job',
    namespace: 'ml',
