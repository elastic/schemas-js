...
import { z } from 'zod'
import { IngestSimulateRequest } from '../../../es/schemas/ingest.simulate.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IngestSimulateRequest) as Record<string, unknown>
...
export const ingest_simulate_definitions: EsApiDefinition[] = [
  {
    name: 'simulate',
    namespace: 'ingest',
