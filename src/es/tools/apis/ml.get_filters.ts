...
import { z } from 'zod'
import { MlGetFiltersRequest } from '../../../es/schemas/ml.get_filters.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetFiltersRequest) as Record<string, unknown>
...
export const ml_get_filters_definitions: EsApiDefinition[] = [
  {
    name: 'get-filters',
    namespace: 'ml',
