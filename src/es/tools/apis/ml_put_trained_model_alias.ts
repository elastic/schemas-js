...
import { z } from 'zod'
import { MlPutTrainedModelAliasRequest } from '../../../es/schemas/ml_put_trained_model_alias.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlPutTrainedModelAliasRequest) as Record<string, unknown>
