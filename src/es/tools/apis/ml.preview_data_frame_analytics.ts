...
import { z } from 'zod'
import { MlPreviewDataFrameAnalyticsRequest } from '../../../es/schemas/ml.preview_data_frame_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlPreviewDataFrameAnalyticsRequest) as Record<string, unknown>
