...
import { z } from 'zod'
import { ClusterRemoteInfoRequest } from '../../../es/schemas/cluster.remote_info.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ClusterRemoteInfoRequest) as Record<string, unknown>
...
export const cluster_remote_info_definitions: EsApiDefinition[] = [
  {
    name: 'remote-info',
    namespace: 'cluster',
