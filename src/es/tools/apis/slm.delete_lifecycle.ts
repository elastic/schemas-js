...
import { z } from 'zod'
import { SlmDeleteLifecycleRequest } from '../../../es/schemas/slm.delete_lifecycle.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SlmDeleteLifecycleRequest) as Record<string, unknown>
...
export const slm_delete_lifecycle_definitions: EsApiDefinition[] = [
  {
