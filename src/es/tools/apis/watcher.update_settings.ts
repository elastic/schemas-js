...
import { z } from 'zod'
import { WatcherUpdateSettingsRequest } from '../../../es/schemas/watcher.update_settings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(WatcherUpdateSettingsRequest) as Record<string, unknown>
