...
import { z } from 'zod'
import { EsqlAsyncQueryStopRequest } from '../../../es/schemas/esql.async_query_stop.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EsqlAsyncQueryStopRequest) as Record<string, unknown>
