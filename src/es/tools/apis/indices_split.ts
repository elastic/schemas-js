...
import { z } from 'zod'
import { IndicesSplitRequest } from '../../../es/schemas/indices_split.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesSplitRequest) as Record<string, unknown>
...
export const indices_split_definitions: EsApiDefinition[] = [
  {
    name: 'split',
    namespace: 'indices',
