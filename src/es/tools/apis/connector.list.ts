...
import { z } from 'zod'
import { ConnectorListRequest } from '../../../es/schemas/connector.list.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorListRequest) as Record<string, unknown>
...
export const connector_list_definitions: EsApiDefinition[] = [
  {
    name: 'list',
    namespace: 'connector',
