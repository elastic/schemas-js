...
import { z } from 'zod'
import { ClusterHealthRequest } from '../../../es/schemas/cluster.health.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ClusterHealthRequest) as Record<string, unknown>
...
export const cluster_health_definitions: EsApiDefinition[] = [
  {
    name: 'health',
    namespace: 'cluster',
