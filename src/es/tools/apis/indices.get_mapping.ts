...
import { z } from 'zod'
import { IndicesGetMappingRequest } from '../../../es/schemas/indices.get_mapping.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetMappingRequest) as Record<string, unknown>
