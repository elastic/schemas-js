...
import { z } from 'zod'
import { SearchableSnapshotsClearCacheRequest } from '../../../es/schemas/searchable_snapshots_clear_cache.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SearchableSnapshotsClearCacheRequest) as Record<string, unknown>
