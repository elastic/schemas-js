...
import { z } from 'zod'
import { MlStopDataFrameAnalyticsRequest } from '../../../es/schemas/ml.stop_data_frame_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlStopDataFrameAnalyticsRequest) as Record<string, unknown>
