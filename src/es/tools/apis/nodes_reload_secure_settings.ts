...
import { z } from 'zod'
import { NodesReloadSecureSettingsRequest } from '../../../es/schemas/nodes_reload_secure_settings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(NodesReloadSecureSettingsRequest) as Record<string, unknown>
...
export const nodes_reload_secure_settings_definitions: EsApiDefinition[] = [
  {
