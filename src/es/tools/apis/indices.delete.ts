...
import { z } from 'zod'
import { IndicesDeleteRequest } from '../../../es/schemas/indices.delete.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesDeleteRequest) as Record<string, unknown>
...
export const indices_delete_definitions: EsApiDefinition[] = [
  {
    name: 'delete',
    namespace: 'indices',
