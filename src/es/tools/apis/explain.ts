...
import { z } from 'zod'
import { ExplainRequest } from '../../../es/schemas/explain.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ExplainRequest) as Record<string, unknown>
...
export const explain_definitions: EsApiDefinition[] = [
  {
    name: 'explain',
