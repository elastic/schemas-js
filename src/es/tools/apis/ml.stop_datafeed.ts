...
import { z } from 'zod'
import { MlStopDatafeedRequest } from '../../../es/schemas/ml.stop_datafeed.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlStopDatafeedRequest) as Record<string, unknown>
...
export const ml_stop_datafeed_definitions: EsApiDefinition[] = [
  {
    name: 'stop-datafeed',
    namespace: 'ml',
