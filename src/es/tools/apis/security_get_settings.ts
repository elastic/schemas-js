...
import { z } from 'zod'
import { SecurityGetSettingsRequest } from '../../../es/schemas/security_get_settings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetSettingsRequest) as Record<string, unknown>
