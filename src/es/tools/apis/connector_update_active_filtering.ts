...
import { z } from 'zod'
import { ConnectorUpdateActiveFilteringRequest } from '../../../es/schemas/connector_update_active_filtering.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateActiveFilteringRequest) as Record<string, unknown>
