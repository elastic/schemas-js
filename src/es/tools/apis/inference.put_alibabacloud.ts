...
import { z } from 'zod'
import { InferencePutAlibabacloudRequest } from '../../../es/schemas/inference.put_alibabacloud.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutAlibabacloudRequest) as Record<string, unknown>
