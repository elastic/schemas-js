...
import { z } from 'zod'
import { TextStructureTestGrokPatternRequest } from '../../../es/schemas/text_structure_test_grok_pattern.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TextStructureTestGrokPatternRequest) as Record<string, unknown>
