...
import { z } from 'zod'
import { IndicesDownsampleRequest } from '../../../es/schemas/indices.downsample.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesDownsampleRequest) as Record<string, unknown>
...
export const indices_downsample_definitions: EsApiDefinition[] = [
  {
    name: 'downsample',
    namespace: 'indices',
