...
import { z } from 'zod'
import { UpdateByQueryRethrottleRequest } from '../../../es/schemas/update_by_query_rethrottle.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(UpdateByQueryRethrottleRequest) as Record<string, unknown>
