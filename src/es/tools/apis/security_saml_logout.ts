...
import { z } from 'zod'
import { SecuritySamlLogoutRequest } from '../../../es/schemas/security_saml_logout.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecuritySamlLogoutRequest) as Record<string, unknown>
