...
import { z } from 'zod'
import { IndicesAnalyzeRequest } from '../../../es/schemas/indices.analyze.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesAnalyzeRequest) as Record<string, unknown>
...
export const indices_analyze_definitions: EsApiDefinition[] = [
  {
    name: 'analyze',
    namespace: 'indices',
