...
import { z } from 'zod'
import { IndicesGetSettingsRequest } from '../../../es/schemas/indices_get_settings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetSettingsRequest) as Record<string, unknown>
