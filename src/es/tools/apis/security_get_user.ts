...
import { z } from 'zod'
import { SecurityGetUserRequest } from '../../../es/schemas/security_get_user.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetUserRequest) as Record<string, unknown>
...
export const security_get_user_definitions: EsApiDefinition[] = [
  {
    name: 'get-user',
    namespace: 'security',
