...
import { z } from 'zod'
import { IndicesShrinkRequest } from '../../../es/schemas/indices.shrink.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesShrinkRequest) as Record<string, unknown>
...
export const indices_shrink_definitions: EsApiDefinition[] = [
  {
    name: 'shrink',
    namespace: 'indices',
