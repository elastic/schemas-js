...
import { z } from 'zod'
import { ConnectorUpdateErrorRequest } from '../../../es/schemas/connector.update_error.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateErrorRequest) as Record<string, unknown>
...
export const connector_update_error_definitions: EsApiDefinition[] = [
  {
    name: 'update-error',
    namespace: 'connector',
