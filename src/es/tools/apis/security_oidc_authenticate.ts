...
import { z } from 'zod'
import { SecurityOidcAuthenticateRequest } from '../../../es/schemas/security_oidc_authenticate.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityOidcAuthenticateRequest) as Record<string, unknown>
...
export const security_oidc_authenticate_definitions: EsApiDefinition[] = [
  {
