...
import { z } from 'zod'
import { EnrichExecutePolicyRequest } from '../../../es/schemas/enrich_execute_policy.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EnrichExecutePolicyRequest) as Record<string, unknown>
...
export const enrich_execute_policy_definitions: EsApiDefinition[] = [
  {
    name: 'execute-policy',
    namespace: 'enrich',
