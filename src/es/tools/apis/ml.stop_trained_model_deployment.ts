...
import { z } from 'zod'
import { MlStopTrainedModelDeploymentRequest } from '../../../es/schemas/ml.stop_trained_model_deployment.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlStopTrainedModelDeploymentRequest) as Record<string, unknown>
