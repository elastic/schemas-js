...
import { z } from 'zod'
import { SynonymsDeleteSynonymRuleRequest } from '../../../es/schemas/synonyms.delete_synonym_rule.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SynonymsDeleteSynonymRuleRequest) as Record<string, unknown>
...
export const synonyms_delete_synonym_rule_definitions: EsApiDefinition[] = [
  {
