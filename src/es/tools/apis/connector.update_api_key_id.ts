...
import { z } from 'zod'
import { ConnectorUpdateApiKeyIdRequest } from '../../../es/schemas/connector.update_api_key_id.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateApiKeyIdRequest) as Record<string, unknown>
