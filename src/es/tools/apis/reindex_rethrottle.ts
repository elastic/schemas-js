...
import { z } from 'zod'
import { ReindexRethrottleRequest } from '../../../es/schemas/reindex_rethrottle.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ReindexRethrottleRequest) as Record<string, unknown>
