...
import { z } from 'zod'
import { SecurityInvalidateTokenRequest } from '../../../es/schemas/security.invalidate_token.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityInvalidateTokenRequest) as Record<string, unknown>
...
export const security_invalidate_token_definitions: EsApiDefinition[] = [
  {
