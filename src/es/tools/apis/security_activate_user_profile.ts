...
import { z } from 'zod'
import { SecurityActivateUserProfileRequest } from '../../../es/schemas/security_activate_user_profile.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityActivateUserProfileRequest) as Record<string, unknown>
...
export const security_activate_user_profile_definitions: EsApiDefinition[] = [
  {
