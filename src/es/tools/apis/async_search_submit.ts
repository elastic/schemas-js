...
import { z } from 'zod'
import { AsyncSearchSubmitRequest } from '../../../es/schemas/async_search_submit.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(AsyncSearchSubmitRequest) as Record<string, unknown>
