...
import { z } from 'zod'
import { ConnectorSyncJobUpdateStatsRequest } from '../../../es/schemas/connector_sync_job_update_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorSyncJobUpdateStatsRequest) as Record<string, unknown>
