...
import { z } from 'zod'
import { MlGetCalendarsRequest } from '../../../es/schemas/ml_get_calendars.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetCalendarsRequest) as Record<string, unknown>
...
export const ml_get_calendars_definitions: EsApiDefinition[] = [
  {
    name: 'get-calendars',
    namespace: 'ml',
