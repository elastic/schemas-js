...
import { z } from 'zod'
import { IndicesGetDataStreamOptionsRequest } from '../../../es/schemas/indices_get_data_stream_options.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetDataStreamOptionsRequest) as Record<string, unknown>
