...
import { z } from 'zod'
import { SlmExecuteLifecycleRequest } from '../../../es/schemas/slm_execute_lifecycle.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SlmExecuteLifecycleRequest) as Record<string, unknown>
...
export const slm_execute_lifecycle_definitions: EsApiDefinition[] = [
  {
