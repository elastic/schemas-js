...
import { z } from 'zod'
import { SecurityEnrollNodeRequest } from '../../../es/schemas/security.enroll_node.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityEnrollNodeRequest) as Record<string, unknown>
...
export const security_enroll_node_definitions: EsApiDefinition[] = [
  {
    name: 'enroll-node',
    namespace: 'security',
