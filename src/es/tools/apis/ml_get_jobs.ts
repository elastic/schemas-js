...
import { z } from 'zod'
import { MlGetJobsRequest } from '../../../es/schemas/ml_get_jobs.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetJobsRequest) as Record<string, unknown>
...
export const ml_get_jobs_definitions: EsApiDefinition[] = [
  {
    name: 'get-jobs',
    namespace: 'ml',
