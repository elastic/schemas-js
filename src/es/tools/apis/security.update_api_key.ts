...
import { z } from 'zod'
import { SecurityUpdateApiKeyRequest } from '../../../es/schemas/security.update_api_key.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityUpdateApiKeyRequest) as Record<string, unknown>
