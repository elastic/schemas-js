...
import { z } from 'zod'
import { SecurityGetBuiltinPrivilegesRequest } from '../../../es/schemas/security_get_builtin_privileges.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetBuiltinPrivilegesRequest) as Record<string, unknown>
