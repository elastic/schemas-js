...
import { z } from 'zod'
import { QueryRulesPutRuleRequest } from '../../../es/schemas/query_rules_put_rule.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(QueryRulesPutRuleRequest) as Record<string, unknown>
...
export const query_rules_put_rule_definitions: EsApiDefinition[] = [
  {
    name: 'put-rule',
