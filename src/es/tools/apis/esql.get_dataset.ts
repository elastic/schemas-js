...
import { z } from 'zod'
import { EsqlGetDatasetRequest } from '../../../es/schemas/esql.get_dataset.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EsqlGetDatasetRequest) as Record<string, unknown>
...
export const esql_get_dataset_definitions: EsApiDefinition[] = [
  {
    name: 'get-dataset',
    namespace: 'esql',
