...
import { z } from 'zod'
import { InferencePutWatsonxRequest } from '../../../es/schemas/inference.put_watsonx.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutWatsonxRequest) as Record<string, unknown>
...
export const inference_put_watsonx_definitions: EsApiDefinition[] = [
  {
    name: 'put-watsonx',
    namespace: 'inference',
