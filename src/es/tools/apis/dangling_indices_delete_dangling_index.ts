...
import { z } from 'zod'
import { DanglingIndicesDeleteDanglingIndexRequest } from '../../../es/schemas/dangling_indices_delete_dangling_index.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(DanglingIndicesDeleteDanglingIndexRequest) as Record<string, unknown>
