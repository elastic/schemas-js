...
import { z } from 'zod'
import { GetScriptContextRequest } from '../../../es/schemas/get_script_context.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(GetScriptContextRequest) as Record<string, unknown>
...
export const get_script_context_definitions: EsApiDefinition[] = [
  {
