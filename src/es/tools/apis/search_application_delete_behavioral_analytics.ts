...
import { z } from 'zod'
import { SearchApplicationDeleteBehavioralAnalyticsRequest } from '../../../es/schemas/search_application_delete_behavioral_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SearchApplicationDeleteBehavioralAnalyticsRequest) as Record<string, unknown>
