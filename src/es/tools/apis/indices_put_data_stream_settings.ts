...
import { z } from 'zod'
import { IndicesPutDataStreamSettingsRequest } from '../../../es/schemas/indices_put_data_stream_settings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesPutDataStreamSettingsRequest) as Record<string, unknown>
...
export const indices_put_data_stream_settings_definitions: EsApiDefinition[] = [
  {
