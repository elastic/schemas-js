...
import { z } from 'zod'
import { IndicesSimulateTemplateRequest } from '../../../es/schemas/indices.simulate_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesSimulateTemplateRequest) as Record<string, unknown>
...
export const indices_simulate_template_definitions: EsApiDefinition[] = [
  {
