...
import { z } from 'zod'
import { SecuritySamlInvalidateRequest } from '../../../es/schemas/security.saml_invalidate.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecuritySamlInvalidateRequest) as Record<string, unknown>
...
export const security_saml_invalidate_definitions: EsApiDefinition[] = [
  {
