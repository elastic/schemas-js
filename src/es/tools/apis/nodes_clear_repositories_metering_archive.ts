...
import { z } from 'zod'
import { NodesClearRepositoriesMeteringArchiveRequest } from '../../../es/schemas/nodes_clear_repositories_metering_archive.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(NodesClearRepositoriesMeteringArchiveRequest) as Record<string, unknown>
