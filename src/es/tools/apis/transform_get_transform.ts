...
import { z } from 'zod'
import { TransformGetTransformRequest } from '../../../es/schemas/transform_get_transform.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformGetTransformRequest) as Record<string, unknown>
