...
import { z } from 'zod'
import { SnapshotRestoreRequest } from '../../../es/schemas/snapshot_restore.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SnapshotRestoreRequest) as Record<string, unknown>
...
export const snapshot_restore_definitions: EsApiDefinition[] = [
  {
    name: 'restore',
    namespace: 'snapshot',
