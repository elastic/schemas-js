...
import { z } from 'zod'
import { InferenceInferenceRequest } from '../../../es/schemas/inference_inference.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceInferenceRequest) as Record<string, unknown>
...
export const inference_inference_definitions: EsApiDefinition[] = [
  {
    name: 'inference',
    namespace: 'inference',
