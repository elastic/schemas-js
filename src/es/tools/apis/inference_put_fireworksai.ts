...
import { z } from 'zod'
import { InferencePutFireworksaiRequest } from '../../../es/schemas/inference_put_fireworksai.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutFireworksaiRequest) as Record<string, unknown>
