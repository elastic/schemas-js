...
import { z } from 'zod'
import { ConnectorUpdateIndexNameRequest } from '../../../es/schemas/connector.update_index_name.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateIndexNameRequest) as Record<string, unknown>
