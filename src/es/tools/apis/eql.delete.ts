...
import { z } from 'zod'
import { EqlDeleteRequest } from '../../../es/schemas/eql.delete.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EqlDeleteRequest) as Record<string, unknown>
...
export const eql_delete_definitions: EsApiDefinition[] = [
  {
    name: 'delete',
    namespace: 'eql',
