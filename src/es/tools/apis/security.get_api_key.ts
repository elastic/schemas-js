...
import { z } from 'zod'
import { SecurityGetApiKeyRequest } from '../../../es/schemas/security.get_api_key.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetApiKeyRequest) as Record<string, unknown>
