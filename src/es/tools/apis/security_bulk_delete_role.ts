...
import { z } from 'zod'
import { SecurityBulkDeleteRoleRequest } from '../../../es/schemas/security_bulk_delete_role.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityBulkDeleteRoleRequest) as Record<string, unknown>
