...
import { z } from 'zod'
import { CatCircuitBreakerRequest } from '../../../es/schemas/cat.circuit_breaker.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatCircuitBreakerRequest) as Record<string, unknown>
...
export const cat_circuit_breaker_definitions: EsApiDefinition[] = [
  {
