...
import { z } from 'zod'
import { ConnectorSyncJobListRequest } from '../../../es/schemas/connector_sync_job_list.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorSyncJobListRequest) as Record<string, unknown>
