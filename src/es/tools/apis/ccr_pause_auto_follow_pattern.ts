...
import { z } from 'zod'
import { CcrPauseAutoFollowPatternRequest } from '../../../es/schemas/ccr_pause_auto_follow_pattern.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CcrPauseAutoFollowPatternRequest) as Record<string, unknown>
