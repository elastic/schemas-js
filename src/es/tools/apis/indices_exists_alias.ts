...
import { z } from 'zod'
import { IndicesExistsAliasRequest } from '../../../es/schemas/indices_exists_alias.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesExistsAliasRequest) as Record<string, unknown>
...
export const indices_exists_alias_definitions: EsApiDefinition[] = [
  {
    name: 'exists-alias',
    namespace: 'indices',
