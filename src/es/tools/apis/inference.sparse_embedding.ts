...
import { z } from 'zod'
import { InferenceSparseEmbeddingRequest } from '../../../es/schemas/inference.sparse_embedding.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceSparseEmbeddingRequest) as Record<string, unknown>
...
export const inference_sparse_embedding_definitions: EsApiDefinition[] = [
  {
