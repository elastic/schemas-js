...
import { z } from 'zod'
import { InferencePutDeepseekRequest } from '../../../es/schemas/inference_put_deepseek.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutDeepseekRequest) as Record<string, unknown>
