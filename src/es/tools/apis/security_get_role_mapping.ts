...
import { z } from 'zod'
import { SecurityGetRoleMappingRequest } from '../../../es/schemas/security_get_role_mapping.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetRoleMappingRequest) as Record<string, unknown>
