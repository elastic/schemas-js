...
import { z } from 'zod'
import { SecurityAuthenticateRequest } from '../../../es/schemas/security.authenticate.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityAuthenticateRequest) as Record<string, unknown>
...
export const security_authenticate_definitions: EsApiDefinition[] = [
  {
    name: 'authenticate',
    namespace: 'security',
