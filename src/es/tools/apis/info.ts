...
import { z } from 'zod'
import { InfoRequest } from '../../../es/schemas/info.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InfoRequest) as Record<string, unknown>
...
export const info_definitions: EsApiDefinition[] = [
  {
    name: 'info',
