...
import { z } from 'zod'
import { InferenceDeleteRequest } from '../../../es/schemas/inference.delete.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceDeleteRequest) as Record<string, unknown>
...
export const inference_delete_definitions: EsApiDefinition[] = [
  {
    name: 'delete',
    namespace: 'inference',
