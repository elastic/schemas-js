...
import { z } from 'zod'
import { MlGetCalendarEventsRequest } from '../../../es/schemas/ml_get_calendar_events.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetCalendarEventsRequest) as Record<string, unknown>
...
export const ml_get_calendar_events_definitions: EsApiDefinition[] = [
  {
