...
import { z } from 'zod'
import { SecuritySamlServiceProviderMetadataRequest } from '../../../es/schemas/security_saml_service_provider_metadata.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecuritySamlServiceProviderMetadataRequest) as Record<string, unknown>
