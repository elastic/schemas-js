...
import { z } from 'zod'
import { MlStartTrainedModelDeploymentRequest } from '../../../es/schemas/ml.start_trained_model_deployment.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlStartTrainedModelDeploymentRequest) as Record<string, unknown>
