...
import { z } from 'zod'
import { MlGetInfluencersRequest } from '../../../es/schemas/ml_get_influencers.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetInfluencersRequest) as Record<string, unknown>
...
export const ml_get_influencers_definitions: EsApiDefinition[] = [
  {
