...
import { z } from 'zod'
import { WatcherStatsRequest } from '../../../es/schemas/watcher_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(WatcherStatsRequest) as Record<string, unknown>
...
export const watcher_stats_definitions: EsApiDefinition[] = [
  {
    name: 'stats',
    namespace: 'watcher',
