...
import { z } from 'zod'
import { ClearScrollRequest } from '../../../es/schemas/clear_scroll.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ClearScrollRequest) as Record<string, unknown>
...
export const clear_scroll_definitions: EsApiDefinition[] = [
  {
    name: 'clear-scroll',
