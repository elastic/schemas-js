...
import { z } from 'zod'
import { InferencePutAzureopenaiRequest } from '../../../es/schemas/inference.put_azureopenai.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutAzureopenaiRequest) as Record<string, unknown>
...
export const inference_put_azureopenai_definitions: EsApiDefinition[] = [
  {
