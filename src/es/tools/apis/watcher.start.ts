...
import { z } from 'zod'
import { WatcherStartRequest } from '../../../es/schemas/watcher.start.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(WatcherStartRequest) as Record<string, unknown>
...
export const watcher_start_definitions: EsApiDefinition[] = [
  {
    name: 'start',
    namespace: 'watcher',
