...
import { z } from 'zod'
import { TasksCancelRequest } from '../../../es/schemas/tasks.cancel.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TasksCancelRequest) as Record<string, unknown>
...
export const tasks_cancel_definitions: EsApiDefinition[] = [
  {
    name: 'cancel',
    namespace: 'tasks',
