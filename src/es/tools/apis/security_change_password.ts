...
import { z } from 'zod'
import { SecurityChangePasswordRequest } from '../../../es/schemas/security_change_password.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityChangePasswordRequest) as Record<string, unknown>
...
export const security_change_password_definitions: EsApiDefinition[] = [
  {
