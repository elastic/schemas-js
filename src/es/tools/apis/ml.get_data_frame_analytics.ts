...
import { z } from 'zod'
import { MlGetDataFrameAnalyticsRequest } from '../../../es/schemas/ml.get_data_frame_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetDataFrameAnalyticsRequest) as Record<string, unknown>
