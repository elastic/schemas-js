...
import { z } from 'zod'
import { InferenceChatCompletionUnifiedRequest } from '../../../es/schemas/inference_chat_completion_unified.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceChatCompletionUnifiedRequest) as Record<string, unknown>
