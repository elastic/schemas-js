...
import { z } from 'zod'
import { SearchApplicationListRequest } from '../../../es/schemas/search_application.list.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SearchApplicationListRequest) as Record<string, unknown>
...
export const search_application_list_definitions: EsApiDefinition[] = [
  {
    name: 'list',
