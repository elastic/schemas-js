...
import { z } from 'zod'
import { SecurityDeleteUserRequest } from '../../../es/schemas/security_delete_user.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityDeleteUserRequest) as Record<string, unknown>
...
export const security_delete_user_definitions: EsApiDefinition[] = [
  {
    name: 'delete-user',
    namespace: 'security',
