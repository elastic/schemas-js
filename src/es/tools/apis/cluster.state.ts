...
import { z } from 'zod'
import { ClusterStateRequest } from '../../../es/schemas/cluster.state.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ClusterStateRequest) as Record<string, unknown>
...
export const cluster_state_definitions: EsApiDefinition[] = [
  {
    name: 'state',
    namespace: 'cluster',
