...
import { z } from 'zod'
import { SecurityCreateCrossClusterApiKeyRequest } from '../../../es/schemas/security.create_cross_cluster_api_key.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityCreateCrossClusterApiKeyRequest) as Record<string, unknown>
...
export const security_create_cross_cluster_api_key_definitions: EsApiDefinition[] = [
  {
