...
import { z } from 'zod'
import { InferencePutGroqRequest } from '../../../es/schemas/inference_put_groq.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutGroqRequest) as Record<string, unknown>
...
export const inference_put_groq_definitions: EsApiDefinition[] = [
  {
    name: 'put-groq',
    namespace: 'inference',
