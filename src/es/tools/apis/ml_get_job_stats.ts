...
import { z } from 'zod'
import { MlGetJobStatsRequest } from '../../../es/schemas/ml_get_job_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetJobStatsRequest) as Record<string, unknown>
...
export const ml_get_job_stats_definitions: EsApiDefinition[] = [
  {
    name: 'get-job-stats',
    namespace: 'ml',
