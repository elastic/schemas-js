...
import { z } from 'zod'
import { IndicesGetAliasRequest } from '../../../es/schemas/indices_get_alias.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetAliasRequest) as Record<string, unknown>
...
export const indices_get_alias_definitions: EsApiDefinition[] = [
  {
    name: 'get-alias',
    namespace: 'indices',
