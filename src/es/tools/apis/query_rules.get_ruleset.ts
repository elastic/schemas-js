...
import { z } from 'zod'
import { QueryRulesGetRulesetRequest } from '../../../es/schemas/query_rules.get_ruleset.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(QueryRulesGetRulesetRequest) as Record<string, unknown>
