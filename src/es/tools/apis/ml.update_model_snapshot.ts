...
import { z } from 'zod'
import { MlUpdateModelSnapshotRequest } from '../../../es/schemas/ml.update_model_snapshot.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlUpdateModelSnapshotRequest) as Record<string, unknown>
