...
import { z } from 'zod'
import { MlDeleteExpiredDataRequest } from '../../../es/schemas/ml_delete_expired_data.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlDeleteExpiredDataRequest) as Record<string, unknown>
...
export const ml_delete_expired_data_definitions: EsApiDefinition[] = [
  {
