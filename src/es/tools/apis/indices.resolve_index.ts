...
import { z } from 'zod'
import { IndicesResolveIndexRequest } from '../../../es/schemas/indices.resolve_index.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesResolveIndexRequest) as Record<string, unknown>
