...
import { z } from 'zod'
import { ConnectorUpdateFilteringValidationRequest } from '../../../es/schemas/connector_update_filtering_validation.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateFilteringValidationRequest) as Record<string, unknown>
