...
import { z } from 'zod'
import { SecurityEnableUserRequest } from '../../../es/schemas/security.enable_user.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityEnableUserRequest) as Record<string, unknown>
...
export const security_enable_user_definitions: EsApiDefinition[] = [
  {
    name: 'enable-user',
    namespace: 'security',
