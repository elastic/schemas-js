...
import { z } from 'zod'
import { MlGetBucketsRequest } from '../../../es/schemas/ml_get_buckets.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetBucketsRequest) as Record<string, unknown>
...
export const ml_get_buckets_definitions: EsApiDefinition[] = [
  {
    name: 'get-buckets',
    namespace: 'ml',
