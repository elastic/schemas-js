...
import { z } from 'zod'
import { ConnectorUpdateServiceTypeRequest } from '../../../es/schemas/connector_update_service_type.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateServiceTypeRequest) as Record<string, unknown>
