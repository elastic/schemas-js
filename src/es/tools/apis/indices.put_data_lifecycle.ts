...
import { z } from 'zod'
import { IndicesPutDataLifecycleRequest } from '../../../es/schemas/indices.put_data_lifecycle.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesPutDataLifecycleRequest) as Record<string, unknown>
...
export const indices_put_data_lifecycle_definitions: EsApiDefinition[] = [
  {
