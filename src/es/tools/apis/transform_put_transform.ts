...
import { z } from 'zod'
import { TransformPutTransformRequest } from '../../../es/schemas/transform_put_transform.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformPutTransformRequest) as Record<string, unknown>
