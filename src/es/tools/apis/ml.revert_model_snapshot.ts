...
import { z } from 'zod'
import { MlRevertModelSnapshotRequest } from '../../../es/schemas/ml.revert_model_snapshot.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlRevertModelSnapshotRequest) as Record<string, unknown>
