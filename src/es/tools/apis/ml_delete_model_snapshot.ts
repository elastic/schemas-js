...
import { z } from 'zod'
import { MlDeleteModelSnapshotRequest } from '../../../es/schemas/ml_delete_model_snapshot.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlDeleteModelSnapshotRequest) as Record<string, unknown>
