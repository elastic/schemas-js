...
import { z } from 'zod'
import { InferencePutGooglevertexaiRequest } from '../../../es/schemas/inference.put_googlevertexai.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutGooglevertexaiRequest) as Record<string, unknown>
...
export const inference_put_googlevertexai_definitions: EsApiDefinition[] = [
  {
