...
import { z } from 'zod'
import { SecurityGetServiceAccountsRequest } from '../../../es/schemas/security.get_service_accounts.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetServiceAccountsRequest) as Record<string, unknown>
