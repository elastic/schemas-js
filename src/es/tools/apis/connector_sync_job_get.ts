...
import { z } from 'zod'
import { ConnectorSyncJobGetRequest } from '../../../es/schemas/connector_sync_job_get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorSyncJobGetRequest) as Record<string, unknown>
...
export const connector_sync_job_get_definitions: EsApiDefinition[] = [
  {
    name: 'sync-job-get',
    namespace: 'connector',
