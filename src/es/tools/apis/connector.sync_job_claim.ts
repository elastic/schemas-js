...
import { z } from 'zod'
import { ConnectorSyncJobClaimRequest } from '../../../es/schemas/connector.sync_job_claim.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorSyncJobClaimRequest) as Record<string, unknown>
