...
import { z } from 'zod'
import { MlPutTrainedModelVocabularyRequest } from '../../../es/schemas/ml.put_trained_model_vocabulary.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlPutTrainedModelVocabularyRequest) as Record<string, unknown>
...
export const ml_put_trained_model_vocabulary_definitions: EsApiDefinition[] = [
  {
