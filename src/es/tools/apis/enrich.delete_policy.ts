...
import { z } from 'zod'
import { EnrichDeletePolicyRequest } from '../../../es/schemas/enrich.delete_policy.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EnrichDeletePolicyRequest) as Record<string, unknown>
