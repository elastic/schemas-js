...
import { z } from 'zod'
import { AsyncSearchStatusRequest } from '../../../es/schemas/async_search.status.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(AsyncSearchStatusRequest) as Record<string, unknown>
