...
import { z } from 'zod'
import { GetScriptLanguagesRequest } from '../../../es/schemas/get_script_languages.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(GetScriptLanguagesRequest) as Record<string, unknown>
...
export const get_script_languages_definitions: EsApiDefinition[] = [
  {
