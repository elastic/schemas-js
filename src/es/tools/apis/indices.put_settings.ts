...
import { z } from 'zod'
import { IndicesPutSettingsRequest } from '../../../es/schemas/indices.put_settings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesPutSettingsRequest) as Record<string, unknown>
