...
import { z } from 'zod'
import { InferencePutAmazonsagemakerRequest } from '../../../es/schemas/inference.put_amazonsagemaker.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutAmazonsagemakerRequest) as Record<string, unknown>
