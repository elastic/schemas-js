...
import { z } from 'zod'
import { IndicesPromoteDataStreamRequest } from '../../../es/schemas/indices_promote_data_stream.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesPromoteDataStreamRequest) as Record<string, unknown>
