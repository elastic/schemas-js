...
import { z } from 'zod'
import { ScriptsPainlessExecuteRequest } from '../../../es/schemas/scripts_painless_execute.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ScriptsPainlessExecuteRequest) as Record<string, unknown>
...
export const scripts_painless_execute_definitions: EsApiDefinition[] = [
  {
