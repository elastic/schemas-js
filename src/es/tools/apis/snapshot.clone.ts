...
import { z } from 'zod'
import { SnapshotCloneRequest } from '../../../es/schemas/snapshot.clone.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SnapshotCloneRequest) as Record<string, unknown>
...
export const snapshot_clone_definitions: EsApiDefinition[] = [
  {
    name: 'clone',
    namespace: 'snapshot',
