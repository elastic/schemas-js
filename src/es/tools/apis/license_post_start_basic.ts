...
import { z } from 'zod'
import { LicensePostStartBasicRequest } from '../../../es/schemas/license_post_start_basic.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(LicensePostStartBasicRequest) as Record<string, unknown>
