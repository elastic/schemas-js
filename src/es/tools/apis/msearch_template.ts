...
import { z } from 'zod'
import { MsearchTemplateRequest } from '../../../es/schemas/msearch_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MsearchTemplateRequest) as Record<string, unknown>
...
export const msearch_template_definitions: EsApiDefinition[] = [
  {
