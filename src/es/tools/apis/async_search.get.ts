...
import { z } from 'zod'
import { AsyncSearchGetRequest } from '../../../es/schemas/async_search.get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(AsyncSearchGetRequest) as Record<string, unknown>
...
export const async_search_get_definitions: EsApiDefinition[] = [
  {
    name: 'get',
