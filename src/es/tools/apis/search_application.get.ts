...
import { z } from 'zod'
import { SearchApplicationGetRequest } from '../../../es/schemas/search_application.get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SearchApplicationGetRequest) as Record<string, unknown>
