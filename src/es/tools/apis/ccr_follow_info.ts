...
import { z } from 'zod'
import { CcrFollowInfoRequest } from '../../../es/schemas/ccr_follow_info.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CcrFollowInfoRequest) as Record<string, unknown>
...
export const ccr_follow_info_definitions: EsApiDefinition[] = [
  {
    name: 'follow-info',
    namespace: 'ccr',
