...
import { z } from 'zod'
import { LicenseGetBasicStatusRequest } from '../../../es/schemas/license.get_basic_status.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(LicenseGetBasicStatusRequest) as Record<string, unknown>
...
export const license_get_basic_status_definitions: EsApiDefinition[] = [
  {
