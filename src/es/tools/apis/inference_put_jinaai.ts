...
import { z } from 'zod'
import { InferencePutJinaaiRequest } from '../../../es/schemas/inference_put_jinaai.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutJinaaiRequest) as Record<string, unknown>
...
export const inference_put_jinaai_definitions: EsApiDefinition[] = [
  {
    name: 'put-jinaai',
    namespace: 'inference',
