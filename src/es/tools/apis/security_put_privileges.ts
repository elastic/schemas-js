...
import { z } from 'zod'
import { SecurityPutPrivilegesRequest } from '../../../es/schemas/security_put_privileges.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityPutPrivilegesRequest) as Record<string, unknown>
