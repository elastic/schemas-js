...
import { z } from 'zod'
import { TransformStopTransformRequest } from '../../../es/schemas/transform_stop_transform.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformStopTransformRequest) as Record<string, unknown>
