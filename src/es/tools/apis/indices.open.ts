...
import { z } from 'zod'
import { IndicesOpenRequest } from '../../../es/schemas/indices.open.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesOpenRequest) as Record<string, unknown>
...
export const indices_open_definitions: EsApiDefinition[] = [
  {
    name: 'open',
    namespace: 'indices',
