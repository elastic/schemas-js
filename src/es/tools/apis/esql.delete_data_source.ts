...
import { z } from 'zod'
import { EsqlDeleteDataSourceRequest } from '../../../es/schemas/esql.delete_data_source.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EsqlDeleteDataSourceRequest) as Record<string, unknown>
