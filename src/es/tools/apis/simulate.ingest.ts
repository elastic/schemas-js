...
import { z } from 'zod'
import { SimulateIngestRequest } from '../../../es/schemas/simulate.ingest.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SimulateIngestRequest) as Record<string, unknown>
...
export const simulate_ingest_definitions: EsApiDefinition[] = [
  {
    name: 'ingest',
    namespace: 'simulate',
