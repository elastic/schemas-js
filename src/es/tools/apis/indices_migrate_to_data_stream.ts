...
import { z } from 'zod'
import { IndicesMigrateToDataStreamRequest } from '../../../es/schemas/indices_migrate_to_data_stream.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesMigrateToDataStreamRequest) as Record<string, unknown>
