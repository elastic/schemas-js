...
import { z } from 'zod'
import { FeaturesGetFeaturesRequest } from '../../../es/schemas/features_get_features.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(FeaturesGetFeaturesRequest) as Record<string, unknown>
