...
import { z } from 'zod'
import { MlSetUpgradeModeRequest } from '../../../es/schemas/ml.set_upgrade_mode.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlSetUpgradeModeRequest) as Record<string, unknown>
...
export const ml_set_upgrade_mode_definitions: EsApiDefinition[] = [
  {
