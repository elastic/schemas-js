...
import { z } from 'zod'
import { CcrPutAutoFollowPatternRequest } from '../../../es/schemas/ccr.put_auto_follow_pattern.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CcrPutAutoFollowPatternRequest) as Record<string, unknown>
