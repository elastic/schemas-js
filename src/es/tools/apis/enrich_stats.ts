...
import { z } from 'zod'
import { EnrichStatsRequest } from '../../../es/schemas/enrich_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EnrichStatsRequest) as Record<string, unknown>
...
export const enrich_stats_definitions: EsApiDefinition[] = [
  {
    name: 'stats',
    namespace: 'enrich',
