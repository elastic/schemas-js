...
import { z } from 'zod'
import { StreamsStatusRequest } from '../../../es/schemas/streams.status.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(StreamsStatusRequest) as Record<string, unknown>
...
export const streams_status_definitions: EsApiDefinition[] = [
  {
    name: 'status',
    namespace: 'streams',
