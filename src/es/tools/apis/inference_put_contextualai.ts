...
import { z } from 'zod'
import { InferencePutContextualaiRequest } from '../../../es/schemas/inference_put_contextualai.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutContextualaiRequest) as Record<string, unknown>
...
export const inference_put_contextualai_definitions: EsApiDefinition[] = [
  {
