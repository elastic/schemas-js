...
import { z } from 'zod'
import { EsqlAsyncQueryRequest } from '../../../es/schemas/esql.async_query.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EsqlAsyncQueryRequest) as Record<string, unknown>
...
export const esql_async_query_definitions: EsApiDefinition[] = [
  {
    name: 'async-query',
    namespace: 'esql',
