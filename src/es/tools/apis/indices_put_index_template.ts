...
import { z } from 'zod'
import { IndicesPutIndexTemplateRequest } from '../../../es/schemas/indices_put_index_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesPutIndexTemplateRequest) as Record<string, unknown>
