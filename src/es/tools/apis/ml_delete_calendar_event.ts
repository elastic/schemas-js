...
import { z } from 'zod'
import { MlDeleteCalendarEventRequest } from '../../../es/schemas/ml_delete_calendar_event.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlDeleteCalendarEventRequest) as Record<string, unknown>
