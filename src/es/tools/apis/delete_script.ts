...
import { z } from 'zod'
import { DeleteScriptRequest } from '../../../es/schemas/delete_script.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(DeleteScriptRequest) as Record<string, unknown>
...
export const delete_script_definitions: EsApiDefinition[] = [
  {
    name: 'delete-script',
