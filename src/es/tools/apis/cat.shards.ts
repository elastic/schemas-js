...
import { z } from 'zod'
import { CatShardsRequest } from '../../../es/schemas/cat.shards.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatShardsRequest) as Record<string, unknown>
...
export const cat_shards_definitions: EsApiDefinition[] = [
  {
    name: 'shards',
    namespace: 'cat',
