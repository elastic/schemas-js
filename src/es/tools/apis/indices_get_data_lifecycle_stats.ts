...
import { z } from 'zod'
import { IndicesGetDataLifecycleStatsRequest } from '../../../es/schemas/indices_get_data_lifecycle_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetDataLifecycleStatsRequest) as Record<string, unknown>
...
export const indices_get_data_lifecycle_stats_definitions: EsApiDefinition[] = [
  {
