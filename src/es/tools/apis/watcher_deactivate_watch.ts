...
import { z } from 'zod'
import { WatcherDeactivateWatchRequest } from '../../../es/schemas/watcher_deactivate_watch.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(WatcherDeactivateWatchRequest) as Record<string, unknown>
