...
import { z } from 'zod'
import { IngestGetIpLocationDatabaseRequest } from '../../../es/schemas/ingest.get_ip_location_database.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IngestGetIpLocationDatabaseRequest) as Record<string, unknown>
