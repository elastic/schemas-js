...
import { z } from 'zod'
import { SearchApplicationDeleteRequest } from '../../../es/schemas/search_application_delete.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SearchApplicationDeleteRequest) as Record<string, unknown>
