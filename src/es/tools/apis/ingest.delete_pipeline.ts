...
import { z } from 'zod'
import { IngestDeletePipelineRequest } from '../../../es/schemas/ingest.delete_pipeline.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IngestDeletePipelineRequest) as Record<string, unknown>
...
export const ingest_delete_pipeline_definitions: EsApiDefinition[] = [
  {
