...
import { z } from 'zod'
import { SecurityUpdateUserProfileDataRequest } from '../../../es/schemas/security.update_user_profile_data.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityUpdateUserProfileDataRequest) as Record<string, unknown>
...
export const security_update_user_profile_data_definitions: EsApiDefinition[] = [
  {
