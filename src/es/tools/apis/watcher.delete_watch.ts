...
import { z } from 'zod'
import { WatcherDeleteWatchRequest } from '../../../es/schemas/watcher.delete_watch.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(WatcherDeleteWatchRequest) as Record<string, unknown>
...
export const watcher_delete_watch_definitions: EsApiDefinition[] = [
  {
    name: 'delete-watch',
    namespace: 'watcher',
