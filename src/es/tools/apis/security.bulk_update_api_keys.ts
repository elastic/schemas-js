...
import { z } from 'zod'
import { SecurityBulkUpdateApiKeysRequest } from '../../../es/schemas/security.bulk_update_api_keys.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityBulkUpdateApiKeysRequest) as Record<string, unknown>
