...
import { z } from 'zod'
import { MlGetOverallBucketsRequest } from '../../../es/schemas/ml_get_overall_buckets.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetOverallBucketsRequest) as Record<string, unknown>
