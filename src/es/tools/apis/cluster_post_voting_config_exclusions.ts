...
import { z } from 'zod'
import { ClusterPostVotingConfigExclusionsRequest } from '../../../es/schemas/cluster_post_voting_config_exclusions.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ClusterPostVotingConfigExclusionsRequest) as Record<string, unknown>
