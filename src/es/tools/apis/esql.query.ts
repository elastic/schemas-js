...
import { z } from 'zod'
import { EsqlQueryRequest } from '../../../es/schemas/esql.query.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EsqlQueryRequest) as Record<string, unknown>
...
export const esql_query_definitions: EsApiDefinition[] = [
  {
    name: 'query',
    namespace: 'esql',
