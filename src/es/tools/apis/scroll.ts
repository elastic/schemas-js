...
import { z } from 'zod'
import { ScrollRequest } from '../../../es/schemas/scroll.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ScrollRequest) as Record<string, unknown>
...
export const scroll_definitions: EsApiDefinition[] = [
  {
    name: 'scroll',
