...
import { z } from 'zod'
import { SecuritySamlPrepareAuthenticationRequest } from '../../../es/schemas/security_saml_prepare_authentication.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecuritySamlPrepareAuthenticationRequest) as Record<string, unknown>
...
export const security_saml_prepare_authentication_definitions: EsApiDefinition[] = [
  {
