...
import { z } from 'zod'
import { InferenceGetRequest } from '../../../es/schemas/inference.get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceGetRequest) as Record<string, unknown>
...
export const inference_get_definitions: EsApiDefinition[] = [
  {
    name: 'get',
    namespace: 'inference',
