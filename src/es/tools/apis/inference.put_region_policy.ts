...
import { z } from 'zod'
import { InferencePutRegionPolicyRequest } from '../../../es/schemas/inference.put_region_policy.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutRegionPolicyRequest) as Record<string, unknown>
