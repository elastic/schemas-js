...
import { z } from 'zod'
import { SecurityDeleteRoleMappingRequest } from '../../../es/schemas/security.delete_role_mapping.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityDeleteRoleMappingRequest) as Record<string, unknown>
...
export const security_delete_role_mapping_definitions: EsApiDefinition[] = [
  {
