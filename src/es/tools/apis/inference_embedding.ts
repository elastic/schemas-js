...
import { z } from 'zod'
import { InferenceEmbeddingRequest } from '../../../es/schemas/inference_embedding.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceEmbeddingRequest) as Record<string, unknown>
...
export const inference_embedding_definitions: EsApiDefinition[] = [
  {
    name: 'embedding',
    namespace: 'inference',
