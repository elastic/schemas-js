...
import { z } from 'zod'
import { PingRequest } from '../../../es/schemas/ping.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(PingRequest) as Record<string, unknown>
...
export const ping_definitions: EsApiDefinition[] = [
  {
    name: 'ping',
