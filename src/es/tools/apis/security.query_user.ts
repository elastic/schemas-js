...
import { z } from 'zod'
import { SecurityQueryUserRequest } from '../../../es/schemas/security.query_user.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityQueryUserRequest) as Record<string, unknown>
