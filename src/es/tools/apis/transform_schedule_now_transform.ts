...
import { z } from 'zod'
import { TransformScheduleNowTransformRequest } from '../../../es/schemas/transform_schedule_now_transform.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformScheduleNowTransformRequest) as Record<string, unknown>
