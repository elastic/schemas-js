...
import { z } from 'zod'
import { InferencePutCustomRequest } from '../../../es/schemas/inference_put_custom.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutCustomRequest) as Record<string, unknown>
