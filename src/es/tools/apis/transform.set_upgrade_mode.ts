...
import { z } from 'zod'
import { TransformSetUpgradeModeRequest } from '../../../es/schemas/transform.set_upgrade_mode.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformSetUpgradeModeRequest) as Record<string, unknown>
