...
import { z } from 'zod'
import { SecurityDisableUserRequest } from '../../../es/schemas/security_disable_user.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityDisableUserRequest) as Record<string, unknown>
...
export const security_disable_user_definitions: EsApiDefinition[] = [
  {
    name: 'disable-user',
    namespace: 'security',
