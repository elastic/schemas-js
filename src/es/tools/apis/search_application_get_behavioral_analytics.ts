...
import { z } from 'zod'
import { SearchApplicationGetBehavioralAnalyticsRequest } from '../../../es/schemas/search_application_get_behavioral_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SearchApplicationGetBehavioralAnalyticsRequest) as Record<string, unknown>
...
export const search_application_get_behavioral_analytics_definitions: EsApiDefinition[] = [
  {
