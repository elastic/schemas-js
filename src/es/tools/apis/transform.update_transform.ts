...
import { z } from 'zod'
import { TransformUpdateTransformRequest } from '../../../es/schemas/transform.update_transform.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformUpdateTransformRequest) as Record<string, unknown>
