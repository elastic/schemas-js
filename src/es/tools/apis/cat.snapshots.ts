...
import { z } from 'zod'
import { CatSnapshotsRequest } from '../../../es/schemas/cat.snapshots.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatSnapshotsRequest) as Record<string, unknown>
...
export const cat_snapshots_definitions: EsApiDefinition[] = [
  {
    name: 'snapshots',
    namespace: 'cat',
