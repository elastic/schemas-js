...
import { z } from 'zod'
import { TransformDeleteTransformRequest } from '../../../es/schemas/transform_delete_transform.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformDeleteTransformRequest) as Record<string, unknown>
