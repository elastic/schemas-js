...
import { z } from 'zod'
import { TransformGetNodeStatsRequest } from '../../../es/schemas/transform_get_node_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformGetNodeStatsRequest) as Record<string, unknown>
