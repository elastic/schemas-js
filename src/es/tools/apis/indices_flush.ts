...
import { z } from 'zod'
import { IndicesFlushRequest } from '../../../es/schemas/indices_flush.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesFlushRequest) as Record<string, unknown>
...
export const indices_flush_definitions: EsApiDefinition[] = [
  {
    name: 'flush',
    namespace: 'indices',
