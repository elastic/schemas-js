...
import { z } from 'zod'
import { MlPostDataRequest } from '../../../es/schemas/ml.post_data.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlPostDataRequest) as Record<string, unknown>
...
export const ml_post_data_definitions: EsApiDefinition[] = [
  {
    name: 'post-data',
    namespace: 'ml',
