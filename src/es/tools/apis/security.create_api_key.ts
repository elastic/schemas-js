...
import { z } from 'zod'
import { SecurityCreateApiKeyRequest } from '../../../es/schemas/security.create_api_key.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityCreateApiKeyRequest) as Record<string, unknown>
...
export const security_create_api_key_definitions: EsApiDefinition[] = [
  {
    name: 'create-api-key',
    namespace: 'security',
