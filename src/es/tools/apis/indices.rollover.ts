...
import { z } from 'zod'
import { IndicesRolloverRequest } from '../../../es/schemas/indices.rollover.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesRolloverRequest) as Record<string, unknown>
...
export const indices_rollover_definitions: EsApiDefinition[] = [
  {
    name: 'rollover',
    namespace: 'indices',
