...
import { z } from 'zod'
import { SecurityDeletePrivilegesRequest } from '../../../es/schemas/security_delete_privileges.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityDeletePrivilegesRequest) as Record<string, unknown>
...
export const security_delete_privileges_definitions: EsApiDefinition[] = [
  {
