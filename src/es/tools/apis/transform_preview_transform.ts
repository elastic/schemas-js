...
import { z } from 'zod'
import { TransformPreviewTransformRequest } from '../../../es/schemas/transform_preview_transform.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformPreviewTransformRequest) as Record<string, unknown>
...
export const transform_preview_transform_definitions: EsApiDefinition[] = [
  {
