...
import { z } from 'zod'
import { SecurityHasPrivilegesRequest } from '../../../es/schemas/security_has_privileges.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityHasPrivilegesRequest) as Record<string, unknown>
...
export const security_has_privileges_definitions: EsApiDefinition[] = [
  {
    name: 'has-privileges',
    namespace: 'security',
