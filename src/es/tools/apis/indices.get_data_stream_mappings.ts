...
import { z } from 'zod'
import { IndicesGetDataStreamMappingsRequest } from '../../../es/schemas/indices.get_data_stream_mappings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetDataStreamMappingsRequest) as Record<string, unknown>
