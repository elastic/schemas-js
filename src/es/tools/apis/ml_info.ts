...
import { z } from 'zod'
import { MlInfoRequest } from '../../../es/schemas/ml_info.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlInfoRequest) as Record<string, unknown>
...
export const ml_info_definitions: EsApiDefinition[] = [
  {
    name: 'info',
    namespace: 'ml',
