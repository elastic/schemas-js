...
import { z } from 'zod'
import { LogstashDeletePipelineRequest } from '../../../es/schemas/logstash.delete_pipeline.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(LogstashDeletePipelineRequest) as Record<string, unknown>
...
export const logstash_delete_pipeline_definitions: EsApiDefinition[] = [
  {
