...
import { z } from 'zod'
import { RollupGetRollupCapsRequest } from '../../../es/schemas/rollup.get_rollup_caps.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(RollupGetRollupCapsRequest) as Record<string, unknown>
