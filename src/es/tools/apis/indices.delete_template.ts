...
import { z } from 'zod'
import { IndicesDeleteTemplateRequest } from '../../../es/schemas/indices.delete_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesDeleteTemplateRequest) as Record<string, unknown>
...
export const indices_delete_template_definitions: EsApiDefinition[] = [
  {
