...
import { z } from 'zod'
import { SecurityDelegatePkiRequest } from '../../../es/schemas/security_delegate_pki.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityDelegatePkiRequest) as Record<string, unknown>
...
export const security_delegate_pki_definitions: EsApiDefinition[] = [
  {
    name: 'delegate-pki',
    namespace: 'security',
