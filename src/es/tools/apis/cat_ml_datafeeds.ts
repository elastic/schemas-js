...
import { z } from 'zod'
import { CatMlDatafeedsRequest } from '../../../es/schemas/cat_ml_datafeeds.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatMlDatafeedsRequest) as Record<string, unknown>
...
export const cat_ml_datafeeds_definitions: EsApiDefinition[] = [
  {
    name: 'ml-datafeeds',
    namespace: 'cat',
