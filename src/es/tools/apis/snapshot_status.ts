...
import { z } from 'zod'
import { SnapshotStatusRequest } from '../../../es/schemas/snapshot_status.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SnapshotStatusRequest) as Record<string, unknown>
...
export const snapshot_status_definitions: EsApiDefinition[] = [
  {
    name: 'status',
    namespace: 'snapshot',
