...
import { z } from 'zod'
import { ClusterPutSettingsRequest } from '../../../es/schemas/cluster_put_settings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ClusterPutSettingsRequest) as Record<string, unknown>
