...
import { z } from 'zod'
import { TextStructureFindFieldStructureRequest } from '../../../es/schemas/text_structure_find_field_structure.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TextStructureFindFieldStructureRequest) as Record<string, unknown>
