...
import { z } from 'zod'
import { InferenceGetRegionPolicyRequest } from '../../../es/schemas/inference.get_region_policy.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceGetRegionPolicyRequest) as Record<string, unknown>
