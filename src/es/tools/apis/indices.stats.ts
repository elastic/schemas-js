...
import { z } from 'zod'
import { IndicesStatsRequest } from '../../../es/schemas/indices.stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesStatsRequest) as Record<string, unknown>
...
export const indices_stats_definitions: EsApiDefinition[] = [
  {
    name: 'stats',
    namespace: 'indices',
