...
import { z } from 'zod'
import { CcrDeleteAutoFollowPatternRequest } from '../../../es/schemas/ccr.delete_auto_follow_pattern.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CcrDeleteAutoFollowPatternRequest) as Record<string, unknown>
