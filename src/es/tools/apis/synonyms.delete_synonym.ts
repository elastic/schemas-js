...
import { z } from 'zod'
import { SynonymsDeleteSynonymRequest } from '../../../es/schemas/synonyms.delete_synonym.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SynonymsDeleteSynonymRequest) as Record<string, unknown>
...
export const synonyms_delete_synonym_definitions: EsApiDefinition[] = [
  {
    name: 'delete-synonym',
    namespace: 'synonyms',
