...
import { z } from 'zod'
import { CatPluginsRequest } from '../../../es/schemas/cat.plugins.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatPluginsRequest) as Record<string, unknown>
...
export const cat_plugins_definitions: EsApiDefinition[] = [
  {
    name: 'plugins',
    namespace: 'cat',
