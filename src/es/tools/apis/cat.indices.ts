...
import { z } from 'zod'
import { CatIndicesRequest } from '../../../es/schemas/cat.indices.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatIndicesRequest) as Record<string, unknown>
...
export const cat_indices_definitions: EsApiDefinition[] = [
  {
    name: 'indices',
    namespace: 'cat',
