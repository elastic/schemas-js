...
import { z } from 'zod'
import { IndicesShardStoresRequest } from '../../../es/schemas/indices_shard_stores.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesShardStoresRequest) as Record<string, unknown>
...
export const indices_shard_stores_definitions: EsApiDefinition[] = [
  {
    name: 'shard-stores',
    namespace: 'indices',
