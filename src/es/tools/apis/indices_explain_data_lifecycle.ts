...
import { z } from 'zod'
import { IndicesExplainDataLifecycleRequest } from '../../../es/schemas/indices_explain_data_lifecycle.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesExplainDataLifecycleRequest) as Record<string, unknown>
...
export const indices_explain_data_lifecycle_definitions: EsApiDefinition[] = [
  {
