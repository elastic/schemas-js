...
import { z } from 'zod'
import { SecurityClearCachedRealmsRequest } from '../../../es/schemas/security_clear_cached_realms.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityClearCachedRealmsRequest) as Record<string, unknown>
...
export const security_clear_cached_realms_definitions: EsApiDefinition[] = [
  {
