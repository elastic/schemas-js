...
import { z } from 'zod'
import { LicenseGetRequest } from '../../../es/schemas/license.get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(LicenseGetRequest) as Record<string, unknown>
...
export const license_get_definitions: EsApiDefinition[] = [
  {
    name: 'get',
    namespace: 'license',
