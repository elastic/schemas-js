...
import { z } from 'zod'
import { TextStructureFindStructureRequest } from '../../../es/schemas/text_structure.find_structure.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TextStructureFindStructureRequest) as Record<string, unknown>
