...
import { z } from 'zod'
import { TransformUpgradeTransformsRequest } from '../../../es/schemas/transform_upgrade_transforms.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformUpgradeTransformsRequest) as Record<string, unknown>
