...
import { z } from 'zod'
import { IngestPutGeoipDatabaseRequest } from '../../../es/schemas/ingest.put_geoip_database.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IngestPutGeoipDatabaseRequest) as Record<string, unknown>
