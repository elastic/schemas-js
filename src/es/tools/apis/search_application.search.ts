...
import { z } from 'zod'
import { SearchApplicationSearchRequest } from '../../../es/schemas/search_application.search.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SearchApplicationSearchRequest) as Record<string, unknown>
