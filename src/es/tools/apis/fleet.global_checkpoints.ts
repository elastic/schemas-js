...
import { z } from 'zod'
import { FleetGlobalCheckpointsRequest } from '../../../es/schemas/fleet.global_checkpoints.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(FleetGlobalCheckpointsRequest) as Record<string, unknown>
