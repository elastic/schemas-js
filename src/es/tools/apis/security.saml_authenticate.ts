...
import { z } from 'zod'
import { SecuritySamlAuthenticateRequest } from '../../../es/schemas/security.saml_authenticate.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecuritySamlAuthenticateRequest) as Record<string, unknown>
