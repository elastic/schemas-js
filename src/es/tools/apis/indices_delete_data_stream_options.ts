...
import { z } from 'zod'
import { IndicesDeleteDataStreamOptionsRequest } from '../../../es/schemas/indices_delete_data_stream_options.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesDeleteDataStreamOptionsRequest) as Record<string, unknown>
