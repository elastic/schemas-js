...
import { z } from 'zod'
import { SecurityGetTokenRequest } from '../../../es/schemas/security_get_token.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetTokenRequest) as Record<string, unknown>
...
export const security_get_token_definitions: EsApiDefinition[] = [
  {
    name: 'get-token',
    namespace: 'security',
