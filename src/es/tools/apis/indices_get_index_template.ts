...
import { z } from 'zod'
import { IndicesGetIndexTemplateRequest } from '../../../es/schemas/indices_get_index_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetIndexTemplateRequest) as Record<string, unknown>
...
export const indices_get_index_template_definitions: EsApiDefinition[] = [
  {
