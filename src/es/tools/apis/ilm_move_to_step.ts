...
import { z } from 'zod'
import { IlmMoveToStepRequest } from '../../../es/schemas/ilm_move_to_step.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IlmMoveToStepRequest) as Record<string, unknown>
...
export const ilm_move_to_step_definitions: EsApiDefinition[] = [
  {
    name: 'move-to-step',
    namespace: 'ilm',
