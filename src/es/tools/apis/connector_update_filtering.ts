...
import { z } from 'zod'
import { ConnectorUpdateFilteringRequest } from '../../../es/schemas/connector_update_filtering.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateFilteringRequest) as Record<string, unknown>
