...
import { z } from 'zod'
import { LicenseGetTrialStatusRequest } from '../../../es/schemas/license.get_trial_status.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(LicenseGetTrialStatusRequest) as Record<string, unknown>
