...
import { z } from 'zod'
import { LogstashPutPipelineRequest } from '../../../es/schemas/logstash_put_pipeline.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(LogstashPutPipelineRequest) as Record<string, unknown>
...
export const logstash_put_pipeline_definitions: EsApiDefinition[] = [
  {
    name: 'put-pipeline',
    namespace: 'logstash',
