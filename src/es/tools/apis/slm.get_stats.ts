...
import { z } from 'zod'
import { SlmGetStatsRequest } from '../../../es/schemas/slm.get_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SlmGetStatsRequest) as Record<string, unknown>
...
export const slm_get_stats_definitions: EsApiDefinition[] = [
  {
    name: 'get-stats',
    namespace: 'slm',
