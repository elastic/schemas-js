...
import { z } from 'zod'
import { MlPreviewDatafeedRequest } from '../../../es/schemas/ml_preview_datafeed.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlPreviewDatafeedRequest) as Record<string, unknown>
...
export const ml_preview_datafeed_definitions: EsApiDefinition[] = [
  {
