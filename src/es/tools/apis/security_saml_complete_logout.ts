...
import { z } from 'zod'
import { SecuritySamlCompleteLogoutRequest } from '../../../es/schemas/security_saml_complete_logout.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecuritySamlCompleteLogoutRequest) as Record<string, unknown>
