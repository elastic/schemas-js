...
import { z } from 'zod'
import { LicenseDeleteRequest } from '../../../es/schemas/license_delete.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(LicenseDeleteRequest) as Record<string, unknown>
...
export const license_delete_definitions: EsApiDefinition[] = [
  {
    name: 'delete',
    namespace: 'license',
