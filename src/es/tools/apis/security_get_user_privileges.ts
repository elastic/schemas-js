...
import { z } from 'zod'
import { SecurityGetUserPrivilegesRequest } from '../../../es/schemas/security_get_user_privileges.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetUserPrivilegesRequest) as Record<string, unknown>
