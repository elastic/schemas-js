...
import { z } from 'zod'
import { InferencePutMistralRequest } from '../../../es/schemas/inference.put_mistral.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutMistralRequest) as Record<string, unknown>
...
export const inference_put_mistral_definitions: EsApiDefinition[] = [
  {
    name: 'put-mistral',
    namespace: 'inference',
