...
import { z } from 'zod'
import { InferencePutAzureaistudioRequest } from '../../../es/schemas/inference.put_azureaistudio.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutAzureaistudioRequest) as Record<string, unknown>
...
export const inference_put_azureaistudio_definitions: EsApiDefinition[] = [
  {
