...
import { z } from 'zod'
import { TransformGetTransformStatsRequest } from '../../../es/schemas/transform.get_transform_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(TransformGetTransformStatsRequest) as Record<string, unknown>
