...
import { z } from 'zod'
import { LicensePostRequest } from '../../../es/schemas/license_post.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(LicensePostRequest) as Record<string, unknown>
...
export const license_post_definitions: EsApiDefinition[] = [
  {
    name: 'post',
    namespace: 'license',
