...
import { z } from 'zod'
import { SecurityGetUserProfileRequest } from '../../../es/schemas/security.get_user_profile.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityGetUserProfileRequest) as Record<string, unknown>
...
export const security_get_user_profile_definitions: EsApiDefinition[] = [
  {
