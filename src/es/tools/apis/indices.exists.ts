...
import { z } from 'zod'
import { IndicesExistsRequest } from '../../../es/schemas/indices.exists.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesExistsRequest) as Record<string, unknown>
...
export const indices_exists_definitions: EsApiDefinition[] = [
  {
    name: 'exists',
    namespace: 'indices',
