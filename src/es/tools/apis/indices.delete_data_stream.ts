...
import { z } from 'zod'
import { IndicesDeleteDataStreamRequest } from '../../../es/schemas/indices.delete_data_stream.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesDeleteDataStreamRequest) as Record<string, unknown>
