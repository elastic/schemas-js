...
import { z } from 'zod'
import { ConnectorCheckInRequest } from '../../../es/schemas/connector.check_in.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorCheckInRequest) as Record<string, unknown>
...
export const connector_check_in_definitions: EsApiDefinition[] = [
  {
    name: 'check-in',
    namespace: 'connector',
