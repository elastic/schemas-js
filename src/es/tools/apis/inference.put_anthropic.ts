...
import { z } from 'zod'
import { InferencePutAnthropicRequest } from '../../../es/schemas/inference.put_anthropic.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutAnthropicRequest) as Record<string, unknown>
...
export const inference_put_anthropic_definitions: EsApiDefinition[] = [
  {
    name: 'put-anthropic',
    namespace: 'inference',
