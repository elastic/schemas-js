...
import { z } from 'zod'
import { EqlGetRequest } from '../../../es/schemas/eql.get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EqlGetRequest) as Record<string, unknown>
...
export const eql_get_definitions: EsApiDefinition[] = [
  {
    name: 'get',
    namespace: 'eql',
