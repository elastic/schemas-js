...
import { z } from 'zod'
import { NodesGetRepositoriesMeteringInfoRequest } from '../../../es/schemas/nodes_get_repositories_metering_info.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(NodesGetRepositoriesMeteringInfoRequest) as Record<string, unknown>
