...
import { z } from 'zod'
import { CatHealthRequest } from '../../../es/schemas/cat_health.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatHealthRequest) as Record<string, unknown>
...
export const cat_health_definitions: EsApiDefinition[] = [
  {
    name: 'health',
    namespace: 'cat',
