...
import { z } from 'zod'
import { SecurityUpdateCrossClusterApiKeyRequest } from '../../../es/schemas/security.update_cross_cluster_api_key.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityUpdateCrossClusterApiKeyRequest) as Record<string, unknown>
