...
import { z } from 'zod'
import { ProjectGetManyRoutingRequest } from '../../../es/schemas/project.get_many_routing.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ProjectGetManyRoutingRequest) as Record<string, unknown>
