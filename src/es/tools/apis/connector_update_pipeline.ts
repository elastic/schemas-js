...
import { z } from 'zod'
import { ConnectorUpdatePipelineRequest } from '../../../es/schemas/connector_update_pipeline.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdatePipelineRequest) as Record<string, unknown>
...
export const connector_update_pipeline_definitions: EsApiDefinition[] = [
  {
