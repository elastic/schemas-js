...
import { z } from 'zod'
import { IngestGetGeoipDatabaseRequest } from '../../../es/schemas/ingest.get_geoip_database.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IngestGetGeoipDatabaseRequest) as Record<string, unknown>
