...
import { z } from 'zod'
import { ClusterPutComponentTemplateRequest } from '../../../es/schemas/cluster_put_component_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ClusterPutComponentTemplateRequest) as Record<string, unknown>
