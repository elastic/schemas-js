...
import { z } from 'zod'
import { IngestGetPipelineRequest } from '../../../es/schemas/ingest_get_pipeline.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IngestGetPipelineRequest) as Record<string, unknown>
...
export const ingest_get_pipeline_definitions: EsApiDefinition[] = [
  {
    name: 'get-pipeline',
    namespace: 'ingest',
