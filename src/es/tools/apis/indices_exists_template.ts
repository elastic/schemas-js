...
import { z } from 'zod'
import { IndicesExistsTemplateRequest } from '../../../es/schemas/indices_exists_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesExistsTemplateRequest) as Record<string, unknown>
