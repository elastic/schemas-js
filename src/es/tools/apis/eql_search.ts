...
import { z } from 'zod'
import { EqlSearchRequest } from '../../../es/schemas/eql_search.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EqlSearchRequest) as Record<string, unknown>
...
export const eql_search_definitions: EsApiDefinition[] = [
  {
    name: 'search',
    namespace: 'eql',
