...
import { z } from 'zod'
import { InferencePutGoogleaistudioRequest } from '../../../es/schemas/inference.put_googleaistudio.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutGoogleaistudioRequest) as Record<string, unknown>
...
export const inference_put_googleaistudio_definitions: EsApiDefinition[] = [
  {
