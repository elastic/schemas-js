...
import { z } from 'zod'
import { IndicesSegmentsRequest } from '../../../es/schemas/indices_segments.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesSegmentsRequest) as Record<string, unknown>
...
export const indices_segments_definitions: EsApiDefinition[] = [
  {
    name: 'segments',
    namespace: 'indices',
