...
import { z } from 'zod'
import { IndicesModifyDataStreamRequest } from '../../../es/schemas/indices.modify_data_stream.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesModifyDataStreamRequest) as Record<string, unknown>
...
export const indices_modify_data_stream_definitions: EsApiDefinition[] = [
  {
