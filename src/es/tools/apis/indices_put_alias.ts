...
import { z } from 'zod'
import { IndicesPutAliasRequest } from '../../../es/schemas/indices_put_alias.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesPutAliasRequest) as Record<string, unknown>
...
export const indices_put_alias_definitions: EsApiDefinition[] = [
  {
    name: 'put-alias',
    namespace: 'indices',
