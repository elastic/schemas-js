...
import { z } from 'zod'
import { CountRequest } from '../../../es/schemas/count.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CountRequest) as Record<string, unknown>
...
export const count_definitions: EsApiDefinition[] = [
  {
    name: 'count',
