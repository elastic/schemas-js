...
import { z } from 'zod'
import { IndicesGetRequest } from '../../../es/schemas/indices_get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetRequest) as Record<string, unknown>
...
export const indices_get_definitions: EsApiDefinition[] = [
  {
    name: 'get',
    namespace: 'indices',
