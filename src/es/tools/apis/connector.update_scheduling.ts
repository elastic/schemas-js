...
import { z } from 'zod'
import { ConnectorUpdateSchedulingRequest } from '../../../es/schemas/connector.update_scheduling.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateSchedulingRequest) as Record<string, unknown>
