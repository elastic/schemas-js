...
import { z } from 'zod'
import { SecurityClearApiKeyCacheRequest } from '../../../es/schemas/security.clear_api_key_cache.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityClearApiKeyCacheRequest) as Record<string, unknown>
...
export const security_clear_api_key_cache_definitions: EsApiDefinition[] = [
  {
