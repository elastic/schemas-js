...
import { z } from 'zod'
import { MlDeleteDataFrameAnalyticsRequest } from '../../../es/schemas/ml_delete_data_frame_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlDeleteDataFrameAnalyticsRequest) as Record<string, unknown>
