...
import { z } from 'zod'
import { AsyncSearchDeleteRequest } from '../../../es/schemas/async_search_delete.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(AsyncSearchDeleteRequest) as Record<string, unknown>
...
export const async_search_delete_definitions: EsApiDefinition[] = [
  {
    name: 'delete',
