...
import { z } from 'zod'
import { SynonymsGetSynonymRuleRequest } from '../../../es/schemas/synonyms.get_synonym_rule.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SynonymsGetSynonymRuleRequest) as Record<string, unknown>
...
export const synonyms_get_synonym_rule_definitions: EsApiDefinition[] = [
  {
