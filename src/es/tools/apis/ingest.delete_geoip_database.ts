...
import { z } from 'zod'
import { IngestDeleteGeoipDatabaseRequest } from '../../../es/schemas/ingest.delete_geoip_database.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IngestDeleteGeoipDatabaseRequest) as Record<string, unknown>
...
export const ingest_delete_geoip_database_definitions: EsApiDefinition[] = [
  {
