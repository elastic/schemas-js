...
import { z } from 'zod'
import { WatcherActivateWatchRequest } from '../../../es/schemas/watcher_activate_watch.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(WatcherActivateWatchRequest) as Record<string, unknown>
...
export const watcher_activate_watch_definitions: EsApiDefinition[] = [
  {
    name: 'activate-watch',
    namespace: 'watcher',
