...
import { z } from 'zod'
import { ConnectorSyncJobCancelRequest } from '../../../es/schemas/connector.sync_job_cancel.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorSyncJobCancelRequest) as Record<string, unknown>
