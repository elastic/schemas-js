...
import { z } from 'zod'
import { CatNodesRequest } from '../../../es/schemas/cat_nodes.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatNodesRequest) as Record<string, unknown>
...
export const cat_nodes_definitions: EsApiDefinition[] = [
  {
    name: 'nodes',
    namespace: 'cat',
