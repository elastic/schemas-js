...
import { z } from 'zod'
import { IndicesGetDataStreamSettingsRequest } from '../../../es/schemas/indices.get_data_stream_settings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetDataStreamSettingsRequest) as Record<string, unknown>
