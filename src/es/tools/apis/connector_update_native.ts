...
import { z } from 'zod'
import { ConnectorUpdateNativeRequest } from '../../../es/schemas/connector_update_native.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorUpdateNativeRequest) as Record<string, unknown>
