...
import { z } from 'zod'
import { SqlDeleteAsyncRequest } from '../../../es/schemas/sql.delete_async.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SqlDeleteAsyncRequest) as Record<string, unknown>
...
export const sql_delete_async_definitions: EsApiDefinition[] = [
  {
    name: 'delete-async',
    namespace: 'sql',
