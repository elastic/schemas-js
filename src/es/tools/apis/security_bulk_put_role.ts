...
import { z } from 'zod'
import { SecurityBulkPutRoleRequest } from '../../../es/schemas/security_bulk_put_role.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityBulkPutRoleRequest) as Record<string, unknown>
