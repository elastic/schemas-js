...
import { z } from 'zod'
import { InferencePutOpenshiftAiRequest } from '../../../es/schemas/inference_put_openshift_ai.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutOpenshiftAiRequest) as Record<string, unknown>
