...
import { z } from 'zod'
import { MlPutDataFrameAnalyticsRequest } from '../../../es/schemas/ml_put_data_frame_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlPutDataFrameAnalyticsRequest) as Record<string, unknown>
...
export const ml_put_data_frame_analytics_definitions: EsApiDefinition[] = [
  {
