...
import { z } from 'zod'
import { SnapshotGetRequest } from '../../../es/schemas/snapshot_get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SnapshotGetRequest) as Record<string, unknown>
...
export const snapshot_get_definitions: EsApiDefinition[] = [
  {
    name: 'get',
    namespace: 'snapshot',
