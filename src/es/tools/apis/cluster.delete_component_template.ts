...
import { z } from 'zod'
import { ClusterDeleteComponentTemplateRequest } from '../../../es/schemas/cluster.delete_component_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ClusterDeleteComponentTemplateRequest) as Record<string, unknown>
...
export const cluster_delete_component_template_definitions: EsApiDefinition[] = [
  {
