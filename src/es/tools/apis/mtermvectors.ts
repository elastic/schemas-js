...
import { z } from 'zod'
import { MtermvectorsRequest } from '../../../es/schemas/mtermvectors.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MtermvectorsRequest) as Record<string, unknown>
...
export const mtermvectors_definitions: EsApiDefinition[] = [
  {
    name: 'mtermvectors',
