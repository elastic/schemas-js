...
import { z } from 'zod'
import { MlOpenJobRequest } from '../../../es/schemas/ml.open_job.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlOpenJobRequest) as Record<string, unknown>
...
export const ml_open_job_definitions: EsApiDefinition[] = [
  {
    name: 'open-job',
    namespace: 'ml',
