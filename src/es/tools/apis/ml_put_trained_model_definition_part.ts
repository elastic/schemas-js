...
import { z } from 'zod'
import { MlPutTrainedModelDefinitionPartRequest } from '../../../es/schemas/ml_put_trained_model_definition_part.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlPutTrainedModelDefinitionPartRequest) as Record<string, unknown>
