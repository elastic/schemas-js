...
import { z } from 'zod'
import { FeaturesResetFeaturesRequest } from '../../../es/schemas/features_reset_features.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(FeaturesResetFeaturesRequest) as Record<string, unknown>
...
export const features_reset_features_definitions: EsApiDefinition[] = [
  {
    name: 'reset-features',
    namespace: 'features',
