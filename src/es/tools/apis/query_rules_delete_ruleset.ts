...
import { z } from 'zod'
import { QueryRulesDeleteRulesetRequest } from '../../../es/schemas/query_rules_delete_ruleset.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(QueryRulesDeleteRulesetRequest) as Record<string, unknown>
