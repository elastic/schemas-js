...
import { z } from 'zod'
import { SecurityOidcLogoutRequest } from '../../../es/schemas/security_oidc_logout.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityOidcLogoutRequest) as Record<string, unknown>
...
export const security_oidc_logout_definitions: EsApiDefinition[] = [
  {
    name: 'oidc-logout',
    namespace: 'security',
