...
import { z } from 'zod'
import { EsqlPutDatasetRequest } from '../../../es/schemas/esql.put_dataset.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EsqlPutDatasetRequest) as Record<string, unknown>
...
export const esql_put_dataset_definitions: EsApiDefinition[] = [
  {
    name: 'put-dataset',
    namespace: 'esql',
