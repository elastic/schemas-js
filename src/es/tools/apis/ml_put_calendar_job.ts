...
import { z } from 'zod'
import { MlPutCalendarJobRequest } from '../../../es/schemas/ml_put_calendar_job.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlPutCalendarJobRequest) as Record<string, unknown>
...
export const ml_put_calendar_job_definitions: EsApiDefinition[] = [
  {
