...
import { z } from 'zod'
import { GetScriptRequest } from '../../../es/schemas/get_script.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(GetScriptRequest) as Record<string, unknown>
...
export const get_script_definitions: EsApiDefinition[] = [
  {
    name: 'get-script',
