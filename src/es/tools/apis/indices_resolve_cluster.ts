...
import { z } from 'zod'
import { IndicesResolveClusterRequest } from '../../../es/schemas/indices_resolve_cluster.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesResolveClusterRequest) as Record<string, unknown>
