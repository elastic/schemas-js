...
import { z } from 'zod'
import { IndicesPutTemplateRequest } from '../../../es/schemas/indices.put_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesPutTemplateRequest) as Record<string, unknown>
