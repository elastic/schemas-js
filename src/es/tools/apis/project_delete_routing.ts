...
import { z } from 'zod'
import { ProjectDeleteRoutingRequest } from '../../../es/schemas/project_delete_routing.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ProjectDeleteRoutingRequest) as Record<string, unknown>
