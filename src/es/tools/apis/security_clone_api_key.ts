...
import { z } from 'zod'
import { SecurityCloneApiKeyRequest } from '../../../es/schemas/security_clone_api_key.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityCloneApiKeyRequest) as Record<string, unknown>
