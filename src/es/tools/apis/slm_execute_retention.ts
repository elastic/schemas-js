...
import { z } from 'zod'
import { SlmExecuteRetentionRequest } from '../../../es/schemas/slm_execute_retention.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SlmExecuteRetentionRequest) as Record<string, unknown>
