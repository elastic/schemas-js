...
import { z } from 'zod'
import { CatMlJobsRequest } from '../../../es/schemas/cat.ml_jobs.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CatMlJobsRequest) as Record<string, unknown>
...
export const cat_ml_jobs_definitions: EsApiDefinition[] = [
  {
    name: 'ml-jobs',
    namespace: 'cat',
