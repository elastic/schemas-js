...
import { z } from 'zod'
import { InferencePutAmazonbedrockRequest } from '../../../es/schemas/inference_put_amazonbedrock.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutAmazonbedrockRequest) as Record<string, unknown>
...
export const inference_put_amazonbedrock_definitions: EsApiDefinition[] = [
  {
