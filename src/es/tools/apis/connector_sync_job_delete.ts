...
import { z } from 'zod'
import { ConnectorSyncJobDeleteRequest } from '../../../es/schemas/connector_sync_job_delete.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorSyncJobDeleteRequest) as Record<string, unknown>
