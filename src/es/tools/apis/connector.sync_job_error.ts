...
import { z } from 'zod'
import { ConnectorSyncJobErrorRequest } from '../../../es/schemas/connector.sync_job_error.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(ConnectorSyncJobErrorRequest) as Record<string, unknown>
