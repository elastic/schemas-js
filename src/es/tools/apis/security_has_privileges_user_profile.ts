...
import { z } from 'zod'
import { SecurityHasPrivilegesUserProfileRequest } from '../../../es/schemas/security_has_privileges_user_profile.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityHasPrivilegesUserProfileRequest) as Record<string, unknown>
