...
import { z } from 'zod'
import { SecurityClearCachedServiceTokensRequest } from '../../../es/schemas/security_clear_cached_service_tokens.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityClearCachedServiceTokensRequest) as Record<string, unknown>
...
export const security_clear_cached_service_tokens_definitions: EsApiDefinition[] = [
  {
