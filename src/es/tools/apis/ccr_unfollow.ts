...
import { z } from 'zod'
import { CcrUnfollowRequest } from '../../../es/schemas/ccr_unfollow.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CcrUnfollowRequest) as Record<string, unknown>
...
export const ccr_unfollow_definitions: EsApiDefinition[] = [
  {
    name: 'unfollow',
    namespace: 'ccr',
