...
import { z } from 'zod'
import { MlGetDataFrameAnalyticsStatsRequest } from '../../../es/schemas/ml_get_data_frame_analytics_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlGetDataFrameAnalyticsStatsRequest) as Record<string, unknown>
