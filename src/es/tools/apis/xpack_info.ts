...
import { z } from 'zod'
import { XpackInfoRequest } from '../../../es/schemas/xpack_info.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(XpackInfoRequest) as Record<string, unknown>
...
export const xpack_info_definitions: EsApiDefinition[] = [
  {
    name: 'info',
    namespace: 'xpack',
