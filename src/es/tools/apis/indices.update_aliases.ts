...
import { z } from 'zod'
import { IndicesUpdateAliasesRequest } from '../../../es/schemas/indices.update_aliases.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesUpdateAliasesRequest) as Record<string, unknown>
