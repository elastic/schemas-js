...
import { z } from 'zod'
import { InferenceStreamCompletionRequest } from '../../../es/schemas/inference.stream_completion.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceStreamCompletionRequest) as Record<string, unknown>
