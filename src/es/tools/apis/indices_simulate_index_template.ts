...
import { z } from 'zod'
import { IndicesSimulateIndexTemplateRequest } from '../../../es/schemas/indices_simulate_index_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesSimulateIndexTemplateRequest) as Record<string, unknown>
