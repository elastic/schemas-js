...
import { z } from 'zod'
import { SynonymsGetSynonymRequest } from '../../../es/schemas/synonyms_get_synonym.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SynonymsGetSynonymRequest) as Record<string, unknown>
