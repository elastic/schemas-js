...
import { z } from 'zod'
import { CcrGetAutoFollowPatternRequest } from '../../../es/schemas/ccr_get_auto_follow_pattern.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CcrGetAutoFollowPatternRequest) as Record<string, unknown>
...
export const ccr_get_auto_follow_pattern_definitions: EsApiDefinition[] = [
  {
