...
import { z } from 'zod'
import { MlDeleteCalendarJobRequest } from '../../../es/schemas/ml.delete_calendar_job.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlDeleteCalendarJobRequest) as Record<string, unknown>
...
export const ml_delete_calendar_job_definitions: EsApiDefinition[] = [
  {
