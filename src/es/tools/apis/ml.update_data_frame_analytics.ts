...
import { z } from 'zod'
import { MlUpdateDataFrameAnalyticsRequest } from '../../../es/schemas/ml.update_data_frame_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(MlUpdateDataFrameAnalyticsRequest) as Record<string, unknown>
