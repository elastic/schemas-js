...
import { z } from 'zod'
import { IndicesClearCacheRequest } from '../../../es/schemas/indices.clear_cache.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesClearCacheRequest) as Record<string, unknown>
...
export const indices_clear_cache_definitions: EsApiDefinition[] = [
  {
    name: 'clear-cache',
    namespace: 'indices',
