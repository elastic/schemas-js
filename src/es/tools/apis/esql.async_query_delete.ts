...
import { z } from 'zod'
import { EsqlAsyncQueryDeleteRequest } from '../../../es/schemas/esql.async_query_delete.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EsqlAsyncQueryDeleteRequest) as Record<string, unknown>
