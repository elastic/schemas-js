...
import { z } from 'zod'
import { IndicesPutDataStreamMappingsRequest } from '../../../es/schemas/indices_put_data_stream_mappings.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesPutDataStreamMappingsRequest) as Record<string, unknown>
