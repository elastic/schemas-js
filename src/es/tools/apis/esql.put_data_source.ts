...
import { z } from 'zod'
import { EsqlPutDataSourceRequest } from '../../../es/schemas/esql.put_data_source.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(EsqlPutDataSourceRequest) as Record<string, unknown>
...
export const esql_put_data_source_definitions: EsApiDefinition[] = [
  {
