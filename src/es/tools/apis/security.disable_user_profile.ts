...
import { z } from 'zod'
import { SecurityDisableUserProfileRequest } from '../../../es/schemas/security.disable_user_profile.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityDisableUserProfileRequest) as Record<string, unknown>
