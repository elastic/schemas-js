...
import { z } from 'zod'
import { RollupStartJobRequest } from '../../../es/schemas/rollup_start_job.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(RollupStartJobRequest) as Record<string, unknown>
...
export const rollup_start_job_definitions: EsApiDefinition[] = [
  {
    name: 'start-job',
    namespace: 'rollup',
