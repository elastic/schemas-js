...
import { z } from 'zod'
import { InferencePutLlamaRequest } from '../../../es/schemas/inference_put_llama.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutLlamaRequest) as Record<string, unknown>
...
export const inference_put_llama_definitions: EsApiDefinition[] = [
  {
    name: 'put-llama',
    namespace: 'inference',
