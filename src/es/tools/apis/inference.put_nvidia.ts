...
import { z } from 'zod'
import { InferencePutNvidiaRequest } from '../../../es/schemas/inference.put_nvidia.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutNvidiaRequest) as Record<string, unknown>
...
export const inference_put_nvidia_definitions: EsApiDefinition[] = [
  {
    name: 'put-nvidia',
    namespace: 'inference',
