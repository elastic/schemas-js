...
import { z } from 'zod'
import { SearchApplicationPutBehavioralAnalyticsRequest } from '../../../es/schemas/search_application_put_behavioral_analytics.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SearchApplicationPutBehavioralAnalyticsRequest) as Record<string, unknown>
