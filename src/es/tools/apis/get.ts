...
import { z } from 'zod'
import { GetRequest } from '../../../es/schemas/get.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(GetRequest) as Record<string, unknown>
...
export const get_definitions: EsApiDefinition[] = [
  {
    name: 'get',
