...
import { z } from 'zod'
import { SlmGetStatusRequest } from '../../../es/schemas/slm.get_status.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SlmGetStatusRequest) as Record<string, unknown>
...
export const slm_get_status_definitions: EsApiDefinition[] = [
  {
    name: 'get-status',
    namespace: 'slm',
