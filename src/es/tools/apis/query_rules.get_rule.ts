...
import { z } from 'zod'
import { QueryRulesGetRuleRequest } from '../../../es/schemas/query_rules.get_rule.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(QueryRulesGetRuleRequest) as Record<string, unknown>
