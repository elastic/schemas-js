...
import { z } from 'zod'
import { InferencePutAi21Request } from '../../../es/schemas/inference_put_ai21.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferencePutAi21Request) as Record<string, unknown>
...
export const inference_put_ai21_definitions: EsApiDefinition[] = [
  {
    name: 'put-ai21',
    namespace: 'inference',
