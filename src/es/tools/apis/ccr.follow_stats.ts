...
import { z } from 'zod'
import { CcrFollowStatsRequest } from '../../../es/schemas/ccr.follow_stats.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(CcrFollowStatsRequest) as Record<string, unknown>
...
export const ccr_follow_stats_definitions: EsApiDefinition[] = [
  {
    name: 'follow-stats',
    namespace: 'ccr',
