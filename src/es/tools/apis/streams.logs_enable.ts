...
import { z } from 'zod'
import { StreamsLogsEnableRequest } from '../../../es/schemas/streams.logs_enable.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(StreamsLogsEnableRequest) as Record<string, unknown>
