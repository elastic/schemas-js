...
import { z } from 'zod'
import { SecurityPutRoleMappingRequest } from '../../../es/schemas/security_put_role_mapping.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityPutRoleMappingRequest) as Record<string, unknown>
...
export const security_put_role_mapping_definitions: EsApiDefinition[] = [
  {
