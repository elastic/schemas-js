...
import { z } from 'zod'
import { SnapshotCreateRequest } from '../../../es/schemas/snapshot.create.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SnapshotCreateRequest) as Record<string, unknown>
...
export const snapshot_create_definitions: EsApiDefinition[] = [
  {
    name: 'create',
    namespace: 'snapshot',
