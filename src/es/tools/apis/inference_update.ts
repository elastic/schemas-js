...
import { z } from 'zod'
import { InferenceUpdateRequest } from '../../../es/schemas/inference_update.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(InferenceUpdateRequest) as Record<string, unknown>
...
export const inference_update_definitions: EsApiDefinition[] = [
  {
    name: 'update',
    namespace: 'inference',
