...
import { z } from 'zod'
import { SecurityQueryRoleRequest } from '../../../es/schemas/security_query_role.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(SecurityQueryRoleRequest) as Record<string, unknown>
