...
import { z } from 'zod'
import { IndicesGetTemplateRequest } from '../../../es/schemas/indices.get_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesGetTemplateRequest) as Record<string, unknown>
...
export const indices_get_template_definitions: EsApiDefinition[] = [
  {
    name: 'get-template',
    namespace: 'indices',
