...
import { z } from 'zod'
import { IndicesDeleteIndexTemplateRequest } from '../../../es/schemas/indices.delete_index_template.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesDeleteIndexTemplateRequest) as Record<string, unknown>
...
export const indices_delete_index_template_definitions: EsApiDefinition[] = [
  {
