...
import { z } from 'zod'
import { IndicesMigrateReindexRequest } from '../../../es/schemas/indices_migrate_reindex.ts'

import type { JsonSchemaObject } from '../../../json-schema.ts'
import type { EsApiDefinition } from '../types.ts'

const _rawSchema = z.toJSONSchema(IndicesMigrateReindexRequest) as Record<string, unknown>
