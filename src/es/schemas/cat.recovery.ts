...
export const CatRecoveryRecoveryRecord = z.object({
  ...
  start_time: z.lazy(() => DateTime).describe('The recovery start time. For recoveries in the `created` stage (not yet started), this value is the Unix epoch (1970-01-01T00:00:00.000Z).').optional(),
  start: z.lazy(() => DateTime).describe('The recovery start time. For recoveries in the `created` stage (not yet started), this value is the Unix epoch (1970-01-01T00:00:00.000Z).').optional(),
  start_time_millis: z.lazy(() => EpochTime).describe('The recovery start time in epoch milliseconds. For recoveries in the `created` stage (not yet started), this value is 0.').optional(),
  start_millis: z.lazy(() => EpochTime).describe('The recovery start time in epoch milliseconds. For recoveries in the `created` stage (not yet started), this value is 0.').optional(),
  stop_time: z.lazy(() => DateTime).describe('The recovery stop time. For recoveries that have not yet completed, this value is the Unix epoch (1970-01-01T00:00:00.000Z).').optional(),
  stop: z.lazy(() => DateTime).describe('The recovery stop time. For recoveries that have not yet completed, this value is the Unix epoch (1970-01-01T00:00:00.000Z).').optional(),
  stop_time_millis: z.lazy(() => EpochTime).describe('The recovery stop time in epoch milliseconds. For recoveries that have not yet completed, this value is 0.').optional(),
  stop_millis: z.lazy(() => EpochTime).describe('The recovery stop time in epoch milliseconds. For recoveries that have not yet completed, this value is 0.').optional(),
  time: z.lazy(() => Duration).describe('The recovery time. For recoveries in the `created` stage (not yet started), this value is 0.').optional(),
  t: z.lazy(() => Duration).describe('The recovery time. For recoveries in the `created` stage (not yet started), this value is 0.').optional(),
  ti: z.lazy(() => Duration).describe('The recovery time. For recoveries in the `created` stage (not yet started), this value is 0.').optional(),
