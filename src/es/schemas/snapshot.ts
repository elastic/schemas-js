...
import { ByteSize, DateTime, Duration, DurationValue, EpochTime, Id, IndexName, Indices, Metadata, Name, ShardStatistics, Uuid, VersionNumber, VersionString, integer, long } from './_types.js'
