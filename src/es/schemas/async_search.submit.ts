...
import { Duration, ExpandWildcards, Field, Fields, IndexName, Indices, KnnSearch, Routing, ScriptField, SearchType, SlicedScroll, Sort, SortResults, SuggestMode, double, integer, long } from './_types.js'
...
import { SearchFieldCollapse, SearchHighlight, SearchPointInTimeReference, SearchRescore, SearchSourceConfig, SearchSuggester, SearchTrackHits } from './search.js'
