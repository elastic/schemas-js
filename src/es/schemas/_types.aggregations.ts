...
import { CartesianPoint, DateTime, DistanceUnit, Duration, DurationLarge, EmptyObject, EpochTime, Field, FieldValue, Fields, GeoBounds, GeoDistanceType, GeoHash, GeoHashPrecision, GeoHexCell, GeoLine, GeoLocation, GeoTile, GeoTilePrecision, Metadata, Name, RelationName, Script, ScriptField, ScriptSource, Sort, SortMode, SortOrder, TimeZone, TopLeftBottomRightGeoBounds, double, float, integer, long } from './_types.js'
import type { ScriptFieldShape, ScriptShape, ScriptSourceShape, SortShape } from './_types.js'
...
import { SearchHighlight, SearchHitsMetadata, SearchSourceConfig } from './search.js'
import type { SearchHighlightShape } from './search.js'
import { AggregationsAggregationRange, AggregationsBuckets, AggregationsCardinalityAggregate, AggregationsCardinalityAggregation, AggregationsCompositeAggregate, AggregationsCompositeAggregateKey, AggregationsCompositeAggregation, AggregationsDateRangeAggregate, AggregationsDateRangeAggregation, AggregationsDoubleTermsAggregate, AggregationsFilterAggregate, AggregationsFiltersAggregate, AggregationsLongTermsAggregate, AggregationsMissingAggregate, AggregationsMissingAggregation, AggregationsMissingOrder, AggregationsMultiTermsAggregate, AggregationsRangeAggregate, AggregationsRangeAggregation, AggregationsStringTermsAggregate, AggregationsUnmappedTermsAggregate, AggregationsValueCountAggregate, AggregationsValueCountAggregation, AggregationsValueType } from './security.query_api_keys.js'
...
export const AggregationsAutoDateHistogramAggregation = z.object({
  ...
  time_zone: z.lazy(() => TimeZone).describe('Time zone ID.').optional()
...
export const AggregationsChildrenAggregation = z.object({
  type: z.lazy(() => RelationName).describe('The child type that should be selected.').optional()
...
export const AggregationsAggregateOrder = z.union([z.record(z.lazy(() => Field), z.lazy(() => SortOrder)), z.array(z.record(z.lazy(() => Field), z.lazy(() => SortOrder)))]).meta({ id: 'AggregationsAggregateOrder' })
...
export const AggregationsDateHistogramAggregation = z.object({
  ...
  params: z.record(z.string(), z.any()).optional(),
  get script () { return z.union([Script, ScriptSource]).optional() },
  time_zone: z.lazy(() => TimeZone).describe('Time zone used for bucketing and rounding. Defaults to Coordinated Universal Time (UTC).').optional(),
...
export const AggregationsGeoDistanceAggregation = z.object({
  distance_type: z.lazy(() => GeoDistanceType).describe('The distance calculation type.').optional(),
  ...
  unit: z.lazy(() => DistanceUnit).describe('The distance unit.').optional()
...
export const AggregationsGeoHashGridAggregation = z.object({
  bounds: z.lazy(() => GeoBounds).describe('The bounding box to filter the points in each bucket.').optional(),
...
export const AggregationsGeoLineAggregation = z.object({
  ...
  sort_order: z.lazy(() => SortOrder).describe('The order in which the line is sorted (ascending or descending).').optional(),
...
export const AggregationsGeoTileGridAggregation = z.object({
  ...
  precision: z.lazy(() => GeoTilePrecision).describe('Integer zoom of the key used to define cells/buckets in the results. Values outside of the range [0,29] will be rejected.').optional(),
  shard_size: z.lazy(() => integer).describe('Allows for more accurate counting of the top cells returned in the final result the aggregation. Defaults to returning `max(10,(size x number-of-shards))` buckets from each shard.').optional(),
  size: z.lazy(() => integer).describe('The maximum number of buckets to return.').optional(),
  bounds: z.lazy(() => GeoBounds).describe('A bounding box to filter the geo-points or geo-shapes in each bucket.').optional()
...
export const AggregationsGeohexGridAggregation = z.object({
  ...
  bounds: z.lazy(() => GeoBounds).describe('Bounding box used to filter the geo-points in each bucket.').optional(),
...
export const AggregationsMatrixStatsAggregation = z.object({
  ...
  mode: z.lazy(() => SortMode).describe('Array value the aggregation will use for array or multi-valued fields.').optional()
...
const AggregationsMultiTermLookupExclusiveProps = z.union([z.object({ field: z.lazy(() => Field) }), z.object({ script: z.union([z.lazy(() => Script), z.lazy(() => ScriptSource)]) })])
...
export interface AggregationsScriptedMetricAggregationShape {
  ...
  missing?: AggregationsMissing | undefined
  script?: ScriptShape | ScriptSourceShape | undefined
  combine_script?: ScriptShape | ScriptSourceShape | undefined
  init_script?: ScriptShape | ScriptSourceShape | undefined
  map_script?: ScriptShape | ScriptSourceShape | undefined
  params?: Record<string, unknown> | undefined
  reduce_script?: ScriptShape | ScriptSourceShape | undefined
}
...
export const AggregationsSignificantTermsAggregation = z.object({
  ...
  jlh: z.lazy(() => EmptyObject).describe('Use JLH score as the significance score.').optional(),
...
export const AggregationsTopHitsAggregation = z.object({
  ...
  missing: z.lazy(() => AggregationsMissing).describe('The value to apply to documents that do not have a value. By default, documents without a value are ignored.').optional(),
  get script () { return z.union([Script, ScriptSource]).optional() },
  docvalue_fields: z.array(z.union([z.lazy(() => QueryDslFieldAndFormat), z.lazy(() => Field)])).describe('Fields for which to return doc values.').optional(),
  explain: z.boolean().describe('If `true`, returns detailed information about score computation as part of a hit.').optional(),
  fields: z.array(z.union([z.lazy(() => QueryDslFieldAndFormat), z.lazy(() => Field)])).describe('Array of wildcard (*) patterns. The request returns values for field names matching these patterns in the hits.fields property of the response.').optional(),
...
export const AggregationsCartesianBoundsAggregate = z.object({
  meta: z.lazy(() => Metadata).optional(),
  bounds: z.lazy(() => TopLeftBottomRightGeoBounds).optional()
...
export const AggregationsCartesianCentroidAggregate = z.object({
  meta: z.lazy(() => Metadata).optional(),
  count: z.lazy(() => long),
  location: z.lazy(() => CartesianPoint).optional()
...
export const AggregationsGeoLineAggregate = z.object({
  meta: z.lazy(() => Metadata).optional(),
  type: z.string(),
  geometry: z.lazy(() => GeoLine),
  properties: z.any()
}).meta({ id: 'AggregationsGeoLineAggregate' })
export type AggregationsGeoLineAggregate = z.infer<typeof AggregationsGeoLineAggregate>

export const AggregationsAggregate = z.union([z.lazy(() => AggregationsCardinalityAggregate), AggregationsHdrPercentilesAggregate, AggregationsHdrPercentileRanksAggregate, AggregationsTDigestPercentilesAggregate, AggregationsTDigestPercentileRanksAggregate, AggregationsPercentilesBucketAggregate, AggregationsMedianAbsoluteDeviationAggregate, AggregationsMinAggregate, AggregationsMaxAggregate, AggregationsSumAggregate, AggregationsAvgAggregate, AggregationsWeightedAvgAggregate, z.lazy(() => AggregationsValueCountAggregate), AggregationsSimpleValueAggregate, AggregationsDerivativeAggregate, AggregationsBucketMetricValueAggregate, AggregationsChangePointAggregate, AggregationsStatsAggregate, AggregationsStatsBucketAggregate, AggregationsExtendedStatsAggregate, AggregationsExtendedStatsBucketAggregate, AggregationsCartesianBoundsAggregate, AggregationsCartesianCentroidAggregate, AggregationsGeoBoundsAggregate, AggregationsGeoCentroidAggregate, AggregationsHistogramAggregate, AggregationsDateHistogramAggregate, AggregationsAutoDateHistogramAggregate, AggregationsVariableWidthHistogramAggregate, z.lazy(() => AggregationsStringTermsAggregate), z.lazy(() => AggregationsLongTermsAggregate), z.lazy(() => AggregationsDoubleTermsAggregate), z.lazy(() => AggregationsUnmappedTermsAggregate), AggregationsLongRareTermsAggregate, AggregationsStringRareTermsAggregate, AggregationsUnmappedRareTermsAggregate, z.lazy(() => AggregationsMultiTermsAggregate), z.lazy(() => AggregationsMissingAggregate), AggregationsNestedAggregate, AggregationsReverseNestedAggregate, AggregationsGlobalAggregate, z.lazy(() => AggregationsFilterAggregate), AggregationsChildrenAggregate, AggregationsParentAggregate, AggregationsSamplerAggregate, AggregationsUnmappedSamplerAggregate, AggregationsGeoHashGridAggregate, AggregationsGeoTileGridAggregate, AggregationsGeoHexGridAggregate, z.lazy(() => AggregationsRangeAggregate), z.lazy(() => AggregationsDateRangeAggregate), AggregationsGeoDistanceAggregate, AggregationsIpRangeAggregate, AggregationsIpPrefixAggregate, z.lazy(() => AggregationsFiltersAggregate), AggregationsAdjacencyMatrixAggregate, AggregationsSignificantLongTermsAggregate, AggregationsSignificantStringTermsAggregate, AggregationsUnmappedSignificantTermsAggregate, z.lazy(() => AggregationsCompositeAggregate), AggregationsFrequentItemSetsAggregate, AggregationsTimeSeriesAggregate, AggregationsScriptedMetricAggregate, AggregationsTopHitsAggregate, AggregationsInferenceAggregate, AggregationsStringStatsAggregate, AggregationsBoxPlotAggregate, AggregationsTopMetricsAggregate, AggregationsTTestAggregate, AggregationsRateAggregate, AggregationsCumulativeCardinalityAggregate, AggregationsMatrixStatsAggregate, AggregationsGeoLineAggregate]).meta({ id: 'AggregationsAggregate' })
...
export const AggregationsCompositeBucket = z.object({
  doc_count: z.lazy(() => long),
  key: z.lazy(() => AggregationsCompositeAggregateKey)
