...
import { Name, RelationName, Username, long } from './_types.js'
...
export const SecuritySuggestUserProfilesHint = z.object({
  uids: z.array(z.lazy(() => SecurityUserProfileId)).describe('A list of profile UIDs to match against.').optional(),
...
export const SecuritySuggestUserProfilesResponse = z.object({
  ...
  profiles: z.array(z.lazy(() => SecurityUserProfile)).describe('A list of profile documents, ordered by relevance, that match the search criteria.')
