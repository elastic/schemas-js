...
export const FlushStats = z.object({
  ...
  total_time: Duration.optional(),
  total_time_in_millis: DurationValue,
  total_time_excluding_waiting: Duration.optional(),
  total_time_excluding_waiting_on_lock_in_millis: DurationValue
}).meta({ id: 'FlushStats' })
...
export const RefreshStats = z.object({
  external_total: long,
  external_total_time: Duration.optional(),
...
export const ClusterStatsDenseVectorOffHeapStats = z.object({
  ...
  total_cenivf_size: ByteSize.optional(),
...
export const IndicesStatsShardStats = z.object({
  ...
  dense_vector: ClusterStatsDenseVectorStats.optional(),
  ...
  sparse_vector: ClusterStatsSparseVectorStats.optional(),
...
export const NodesAllocations = z.object({
  shards: integer.describe('Number of shards allocated to the node.').optional(),
  undesired_shards: integer.describe('Number of shards allocated to the node that are currently undesired.').optional(),
  forecasted_ingest_load: double.describe('Forecasted ingest load for the node.').optional(),
  forecasted_disk_usage: z.string().describe('Forecasted disk usage for the node.').optional(),
  forecasted_disk_usage_in_bytes: long.describe('Forecasted disk usage, in bytes, for the node.').optional(),
  current_disk_usage: z.string().describe('Current disk usage for the node.').optional(),
  current_disk_usage_in_bytes: long.describe('Current disk usage, in bytes, for the node.').optional()
...
export const NodesClient = z.object({
  ...
  opened_time: z.string().describe('Time at which the client opened the connection.').optional(),
  opened_time_millis: long.describe('Time at which the client opened the connection.').optional(),
  closed_time: z.string().describe('Time at which the client closed the connection if the connection is closed.').optional(),
  closed_time_millis: long.describe('Time at which the client closed the connection if the connection is closed.').optional(),
  last_request_time: z.string().describe('Time of the most recent request from this client.').optional(),
...
export const NodesCpu = z.object({
  available_processors: integer.describe('The number of processors available to the Java virtual machine.').optional(),
...
export const NodesDataPathStats = z.object({
  ...
  low_watermark_free_space_in_bytes: long.describe('The amount of free disk space, in bytes, that, once reached, triggers the low disk watermark.').optional(),
  ...
  high_watermark_free_space_in_bytes: long.describe('The amount of free disk space, in bytes, that, once reached, triggers the high disk watermark.').optional(),
  ...
  flood_stage_free_space_in_bytes: long.describe('The amount of free disk space, in bytes, that, once reached, triggers the flood stage disk watermark.').optional(),
  ...
  frozen_flood_stage_free_space_in_bytes: long.describe('The amount of free disk space, in bytes, that, once reached, triggers the frozen flood stage disk watermark.').optional(),
...
export const NodesProcessor = z.object({
  ...
  time: Duration.describe('Time spent by the processor transforming documents.').optional(),
...
export const NodesIngestStats = z.object({
  ...
  time: Duration.describe('Total time spent preprocessing ingest documents during the lifetime of this node.').optional(),
  ...
  ingested_as_first_pipeline: ByteSize.describe('Total size of all documents ingested by the pipeline. The value counts documents for which this pipeline was the first to process them; for pipelines that are not the first to process a document (for example, a final pipeline after a default pipeline, a pipeline run after a reroute processor, or a pipeline invoked by a pipeline processor), the value is `0`.').optional(),
  ingested_as_first_pipeline_in_bytes: long.describe('Total number of bytes of all documents ingested by the pipeline. The value counts documents for which this pipeline was the first to process them; for pipelines that are not the first to process a document, the value is `0`.'),
  produced_as_first_pipeline: ByteSize.describe('Total size of all documents produced by the pipeline. The value counts documents for which this pipeline was the first to process them; for pipelines that are not the first to process a document, the value is `0`. In situations where there are subsequent pipelines, the value represents the size of the document after all pipelines have run.').optional(),
  produced_as_first_pipeline_in_bytes: long.describe('Total number of bytes of all documents produced by the pipeline. The value counts documents for which this pipeline was the first to process them; for pipelines that are not the first to process a document, the value is `0`. In situations where there are subsequent pipelines, the value represents the size of the document after all pipelines have run.')
...
export const NodesJvmMemoryStats = z.object({
  heap_used: ByteSize.describe('Memory currently in use by the heap.').optional(),
  ...
  heap_committed: ByteSize.describe('Amount of memory available for use by the heap.').optional(),
  ...
  non_heap_used: ByteSize.describe('Non-heap memory used.').optional(),
  non_heap_used_in_bytes: long.describe('Non-heap memory used, in bytes.').optional(),
  non_heap_committed: ByteSize.describe('Amount of non-heap memory available.').optional(),
...
export const NodesRepositorySnapshotStats = z.object({
  total_read_throttled_time: Duration.describe('The cumulative time spent throttling read operations for this repository.').optional(),
  total_write_throttled_time: Duration.describe('The cumulative time spent throttling write operations for this repository.').optional(),
  total_read_throttled_time_nanos: DurationValue.describe('The cumulative time, in nanoseconds, spent throttling read operations for this repository.'),
  total_write_throttled_time_nanos: DurationValue.describe('The cumulative time, in nanoseconds, spent throttling write operations for this repository.'),
  shard_snapshots_started: long.describe('The number of shard snapshots started for this repository.'),
  shard_snapshots_completed: long.describe('The number of shard snapshots completed for this repository.'),
  shard_snapshots_in_progress: long.describe('The number of shard snapshots currently in progress for this repository.'),
  uploaded_blobs: long.describe('The number of blobs uploaded to this repository.'),
  uploaded_size: ByteSize.describe('The cumulative size of the blobs uploaded to this repository.').optional(),
  uploaded_size_in_bytes: long.describe('The cumulative size, in bytes, of the blobs uploaded to this repository.'),
  total_upload_time: Duration.describe('The cumulative time spent uploading blobs to this repository.').optional(),
  total_upload_time_in_millis: DurationValue.describe('The cumulative time, in milliseconds, spent uploading blobs to this repository.'),
  total_read_time: Duration.describe('The cumulative time spent reading blobs while uploading to this repository.').optional(),
  total_read_time_in_millis: DurationValue.describe('The cumulative time, in milliseconds, spent reading blobs while uploading to this repository.')
...
export const NodesTransportHistogram = z.object({
  ...
  lt: Duration.describe('The exclusive upper bound of the bucket. May be omitted on the last bucket if this bucket has no upper bound.').optional(),
  ...
  ge: Duration.describe('The inclusive lower bound of the bucket. May be omitted on the first bucket if this bucket has no lower bound.').optional(),
...
export const NodesTransportMessageSizeHistogramBucket = z.object({
  count: long.describe('The number of messages with a size that falls within the bounds of this bucket.'),
  ge: ByteSize.describe('The inclusive lower bound of the bucket. May be omitted on the first bucket if this bucket has no lower bound.').optional(),
  ge_bytes: long.describe('The inclusive lower bound of the bucket in bytes. May be omitted on the first bucket if this bucket has no lower bound.').optional(),
  lt: ByteSize.describe('The exclusive upper bound of the bucket. May be omitted on the last bucket if this bucket has no upper bound.').optional(),
  lt_bytes: long.describe('The exclusive upper bound of the bucket in bytes. May be omitted on the last bucket if this bucket has no upper bound.').optional()
...
export const NodesTransportActionMessageStats = z.object({
  count: long.describe('The number of messages of this kind that the node has handled for this action.'),
  total_size: ByteSize.describe('The cumulative size of the messages of this kind that the node has handled for this action.').optional(),
  total_size_in_bytes: long.describe('The cumulative size, in bytes, of the messages of this kind that the node has handled for this action.'),
