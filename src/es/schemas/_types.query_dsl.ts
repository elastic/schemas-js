...
import { SpecUtilsPipeSeparatedFlags } from './_spec_utils.js'
import { DateFormat, Distance, Field, FieldValue, Fields, Fuzziness, GeoDistanceType, GeoHash, GeoHexCell, GeoLocation, GeoShape, GeoShapeRelation, GeoTile, Id, Ids, IndexName, KnnQuery, MinimumShouldMatch, MultiTermQueryRewrite, RelationName, Routing, Script, ScriptSource, TimeZone, TokenPruningConfig, VersionNumber, VersionType, double, float, integer, long } from './_types.js'
import type { ScriptShape, ScriptSourceShape } from './_types.js'
import { AnalysisStopWords } from './_types.analysis.js'
import { QueryDslPinnedDoc } from './query_rules.put_rule.js'
import { SearchInnerHits } from './search.js'
import type { SearchInnerHitsShape } from './search.js'
...
export const QueryDslBoolQuery = z.object({
  ...
  minimum_should_match: z.lazy(() => MinimumShouldMatch).describe('Specifies the number or percentage of `should` clauses returned documents must match.').optional(),
...
export const QueryDslCommonTermsQuery = z.object({
  ...
  minimum_should_match: z.lazy(() => MinimumShouldMatch).optional(),
  query: z.string()
...
export const QueryDslCombinedFieldsQuery = z.object({
  ...
  minimum_should_match: z.lazy(() => MinimumShouldMatch).describe('Minimum number of clauses that must match for a document to be returned.').optional(),
...
export const QueryDslFuzzyQuery = z.object({
  ...
  rewrite: z.lazy(() => MultiTermQueryRewrite).describe('Number of beginning characters left unchanged when creating expansions.').optional(),
...
export const QueryDslGeoDistanceQuery = z.object({
  boost: z.lazy(() => float).describe('Floating point number used to decrease or increase the relevance scores of the query. Boost values are relative to the default value of 1.0. A boost value between 0 and 1.0 decreases the relevance score. A value greater than 1.0 increases the relevance score.').optional(),
  query_name: z.string().optional(),
  distance: z.lazy(() => Distance).describe('The radius of the circle centred on the specified location. Points which fall into this circle are considered to be matches.'),
  distance_type: z.lazy(() => GeoDistanceType).describe('How to compute the distance. Set to `plane` for a faster calculation that\'s inaccurate on long distances and close to the poles.').optional(),
  validation_method: QueryDslGeoValidationMethod.describe('Set to `IGNORE_MALFORMED` to accept geo points with invalid latitude or longitude. Set to `COERCE` to also try to infer correct latitude or longitude.').optional(),
  ignore_unmapped: z.boolean().describe('Set to `true` to ignore an unmapped field and not match any documents for this query. Set to `false` to throw an exception if the field is not mapped.').optional()
...
const QueryDslGeoGridQueryExclusiveProps = z.union([z.object({ geotile: z.lazy(() => GeoTile) }), z.object({ geohash: z.lazy(() => GeoHash) }), z.object({ geohex: z.lazy(() => GeoHexCell) })])
...
export const QueryDslHasChildQuery = z.object({
  ...
  type: z.lazy(() => RelationName).describe('Name of the child relationship mapped for the `join` field.')
...
export const QueryDslHasParentQuery = z.object({
  ...
  get inner_hits () { return SearchInnerHits.describe('If defined, each search hit will contain inner hits.').optional() },
  parent_type: z.lazy(() => RelationName).describe('Name of the parent relationship mapped for the `join` field.'),
...
export const QueryDslMatchQuery = z.object({
  ...
  cutoff_frequency: z.lazy(() => double).optional(),
  fuzziness: z.lazy(() => Fuzziness).describe('Maximum edit distance allowed for matching.').optional(),
  fuzzy_rewrite: z.lazy(() => MultiTermQueryRewrite).describe('Method used to rewrite the query.').optional(),
...
export const QueryDslMatchBoolPrefixQuery = z.object({
  ...
  fuzzy_rewrite: z.lazy(() => MultiTermQueryRewrite).describe('Method used to rewrite the query. Can be applied to the term subqueries constructed for all terms but the final term.').optional(),
  ...
  minimum_should_match: z.lazy(() => MinimumShouldMatch).describe('Minimum number of clauses that must match for a document to be returned. Applied to the constructed bool query.').optional(),
...
export const QueryDslMoreLikeThisQuery = z.object({
  ...
  minimum_should_match: z.lazy(() => MinimumShouldMatch).describe('After the disjunctive query has been formed, this parameter controls the number of terms that must match.').optional(),
...
export const QueryDslParentIdQuery = z.object({
  ...
  ignore_unmapped: z.boolean().describe('Indicates whether to ignore an unmapped `type` and not return any documents instead of an error.').optional(),
  type: z.lazy(() => RelationName).describe('Name of the child relationship mapped for the `join` field.').optional()
...
const QueryDslPinnedQueryExclusiveProps = z.union([z.object({ ids: z.array(z.lazy(() => Id)) }), z.object({ docs: z.array(z.lazy(() => QueryDslPinnedDoc)) })])
...
export const QueryDslPrefixQuery = z.object({
  boost: z.lazy(() => float).describe('Floating point number used to decrease or increase the relevance scores of the query. Boost values are relative to the default value of 1.0. A boost value between 0 and 1.0 decreases the relevance score. A value greater than 1.0 increases the relevance score.').optional(),
  query_name: z.string().optional(),
  rewrite: z.lazy(() => MultiTermQueryRewrite).describe('Method used to rewrite the query.').optional(),
...
export const QueryDslQueryStringQuery = z.object({
  ...
  time_zone: z.lazy(() => TimeZone).describe('Coordinated Universal Time (UTC) offset or IANA time zone used to convert date values in the query string to UTC.').optional(),
...
export const QueryDslUntypedRangeQuery = z.object({
  ...
  time_zone: z.lazy(() => TimeZone).describe('Coordinated Universal Time (UTC) offset or IANA time zone used to convert `date` values in the query to UTC.').optional()
...
const QueryDslSpanQueryExclusiveProps = z.union([z.object({ span_containing: z.lazy(() => QueryDslSpanContainingQuery) }), z.object({ span_field_masking: z.lazy(() => QueryDslSpanFieldMaskingQuery) }), z.object({ span_first: z.lazy(() => QueryDslSpanFirstQuery) }), z.object({ span_gap: QueryDslSpanGapQuery }), z.object({ span_multi: z.lazy(() => QueryDslSpanMultiTermQuery) }), z.object({ span_near: z.lazy(() => QueryDslSpanNearQuery) }), z.object({ span_not: z.lazy(() => QueryDslSpanNotQuery) }), z.object({ span_or: z.lazy(() => QueryDslSpanOrQuery) }), z.object({ span_term: z.record(z.lazy(() => Field), z.union([QueryDslSpanTermQuery, z.lazy(() => FieldValue)])) }), z.object({ span_within: z.lazy(() => QueryDslSpanWithinQuery) })])
...
export interface QueryDslSpanQueryShape {
  ...
  span_term?: Record<Field, QueryDslSpanTermQuery | FieldValue> | undefined
...
const QueryDslSparseVectorQueryCommonProps = z.object({
  ...
  pruning_config: z.lazy(() => TokenPruningConfig).describe('Optional pruning configuration. If enabled, this will omit non-significant tokens from the query in order to improve query performance. This is only used if prune is set to true. If prune is set to true but pruning_config is not specified, default values will be used.').optional()
})
...
export interface QueryDslTermsSetQueryShape {
  ...
  minimum_should_match_script?: ScriptShape | ScriptSourceShape | undefined
  terms: FieldValue[]
}
export const QueryDslTermsSetQuery = z.object({
  boost: z.lazy(() => float).describe('Floating point number used to decrease or increase the relevance scores of the query. Boost values are relative to the default value of 1.0. A boost value between 0 and 1.0 decreases the relevance score. A value greater than 1.0 increases the relevance score.').optional(),
  query_name: z.string().optional(),
  minimum_should_match: z.lazy(() => MinimumShouldMatch).describe('Specification describing number of matching terms required to return a document.').optional(),
...
export const QueryDslTextExpansionQuery = z.object({
  ...
  pruning_config: z.lazy(() => TokenPruningConfig).describe('Token pruning configurations').optional()
...
const QueryDslQueryContainerExclusiveProps = z.union([z.object({ bool: z.lazy(() => QueryDslBoolQuery) }), z.object({ boosting: z.lazy(() => QueryDslBoostingQuery) }), z.object({ common: z.record(z.lazy(() => Field), z.union([QueryDslCommonTermsQuery, z.string()])) }), z.object({ combined_fields: QueryDslCombinedFieldsQuery }), z.object({ constant_score: z.lazy(() => QueryDslConstantScoreQuery) }), z.object({ dis_max: z.lazy(() => QueryDslDisMaxQuery) }), z.object({ distance_feature: QueryDslDistanceFeatureQuery }), z.object({ exists: z.lazy(() => QueryDslExistsQuery) }), z.object({ function_score: z.union([z.lazy(() => QueryDslFunctionScoreQuery), z.array(z.lazy(() => QueryDslFunctionScoreContainer))]) }), z.object({ fuzzy: z.record(z.lazy(() => Field), z.union([QueryDslFuzzyQuery, z.union([z.string(), z.lazy(() => double), z.boolean()])])) }), z.object({ geo_bounding_box: QueryDslGeoBoundingBoxQuery }), z.object({ geo_distance: QueryDslGeoDistanceQuery }), z.object({ geo_grid: z.record(z.lazy(() => Field), QueryDslGeoGridQuery) }), z.object({ geo_polygon: QueryDslGeoPolygonQuery }), z.object({ geo_shape: QueryDslGeoShapeQuery }), z.object({ has_child: z.lazy(() => QueryDslHasChildQuery) }), z.object({ has_parent: z.lazy(() => QueryDslHasParentQuery) }), z.object({ ids: z.lazy(() => QueryDslIdsQuery) }), z.object({ intervals: z.record(z.lazy(() => Field), z.lazy(() => QueryDslIntervalsQuery)) }), z.object({ knn: z.lazy(() => KnnQuery) }), z.object({ match: z.record(z.lazy(() => Field), z.union([z.lazy(() => QueryDslMatchQuery), z.union([z.string(), z.lazy(() => float), z.boolean()])])) }), z.object({ match_all: z.lazy(() => QueryDslMatchAllQuery) }), z.object({ match_bool_prefix: z.record(z.lazy(() => Field), z.union([QueryDslMatchBoolPrefixQuery, z.string()])) }), z.object({ match_none: QueryDslMatchNoneQuery }), z.object({ match_phrase: z.record(z.lazy(() => Field), z.union([QueryDslMatchPhraseQuery, z.string()])) }), z.object({ match_phrase_prefix: z.record(z.lazy(() => Field), z.union([QueryDslMatchPhrasePrefixQuery, z.string()])) }), z.object({ more_like_this: QueryDslMoreLikeThisQuery }), z.object({ multi_match: QueryDslMultiMatchQuery }), z.object({ nested: z.lazy(() => QueryDslNestedQuery) }), z.object({ parent_id: QueryDslParentIdQuery }), z.object({ percolate: QueryDslPercolateQuery }), z.object({ pinned: z.lazy(() => QueryDslPinnedQuery) }), z.object({ prefix: z.record(z.lazy(() => Field), z.union([z.lazy(() => QueryDslPrefixQuery), z.string()])) }), z.object({ query_string: QueryDslQueryStringQuery }), z.object({ range: z.record(z.lazy(() => Field), z.lazy(() => QueryDslRangeQuery)) }), z.object({ rank_feature: QueryDslRankFeatureQuery }), z.object({ regexp: z.record(z.lazy(() => Field), z.union([QueryDslRegexpQuery, z.string()])) }), z.object({ rule: z.lazy(() => QueryDslRuleQuery) }), z.object({ script: z.lazy(() => QueryDslScriptQuery) }), z.object({ script_score: z.lazy(() => QueryDslScriptScoreQuery) }), z.object({ semantic: QueryDslSemanticQuery }), z.object({ shape: QueryDslShapeQuery }), z.object({ simple_query_string: z.lazy(() => QueryDslSimpleQueryStringQuery) }), z.object({ span_containing: z.lazy(() => QueryDslSpanContainingQuery) }), z.object({ span_field_masking: z.lazy(() => QueryDslSpanFieldMaskingQuery) }), z.object({ span_first: z.lazy(() => QueryDslSpanFirstQuery) }), z.object({ span_multi: z.lazy(() => QueryDslSpanMultiTermQuery) }), z.object({ span_near: z.lazy(() => QueryDslSpanNearQuery) }), z.object({ span_not: z.lazy(() => QueryDslSpanNotQuery) }), z.object({ span_or: z.lazy(() => QueryDslSpanOrQuery) }), z.object({ span_term: z.record(z.lazy(() => Field), z.union([QueryDslSpanTermQuery, z.lazy(() => FieldValue)])) }), z.object({ span_within: z.lazy(() => QueryDslSpanWithinQuery) }), z.object({ sparse_vector: QueryDslSparseVectorQuery }), z.object({ term: z.record(z.lazy(() => Field), z.union([z.lazy(() => QueryDslTermQuery), z.lazy(() => FieldValue)])) }), z.object({ terms: z.lazy(() => QueryDslTermsQuery) }), z.object({ terms_set: z.record(z.lazy(() => Field), z.lazy(() => QueryDslTermsSetQuery)) }), z.object({ text_expansion: z.record(z.lazy(() => Field), QueryDslTextExpansionQuery) }), z.object({ weighted_tokens: z.record(z.lazy(() => Field), QueryDslWeightedTokensQuery) }), z.object({ wildcard: z.record(z.lazy(() => Field), z.union([z.lazy(() => QueryDslWildcardQuery), z.string()])) }), z.object({ wrapper: QueryDslWrapperQuery }), z.object({ type: QueryDslTypeQuery })])

export interface QueryDslQueryContainerShape {
  bool?: QueryDslBoolQuery | undefined
  boosting?: QueryDslBoostingQuery | undefined
  common?: Record<Field, QueryDslCommonTermsQuery | string> | undefined
  ...
  function_score?: QueryDslFunctionScoreQuery | QueryDslFunctionScoreContainer[] | undefined
  fuzzy?: Record<Field, QueryDslFuzzyQuery | string | double | boolean> | undefined
  ...
  match?: Record<Field, QueryDslMatchQuery | string | float | boolean> | undefined
  match_all?: QueryDslMatchAllQuery | undefined
  match_bool_prefix?: Record<Field, QueryDslMatchBoolPrefixQuery | string> | undefined
  match_none?: QueryDslMatchNoneQuery | undefined
  match_phrase?: Record<Field, QueryDslMatchPhraseQuery | string> | undefined
  match_phrase_prefix?: Record<Field, QueryDslMatchPhrasePrefixQuery | string> | undefined
  ...
  prefix?: Record<Field, QueryDslPrefixQuery | string> | undefined
  ...
  regexp?: Record<Field, QueryDslRegexpQuery | string> | undefined
  ...
  term?: Record<Field, QueryDslTermQuery | FieldValue> | undefined
  ...
  wildcard?: Record<Field, QueryDslWildcardQuery | string> | undefined
...
export const QueryDslGeoShapeFieldQuery = z.object({
  shape: z.lazy(() => GeoShape).optional(),
  ...
  relation: z.lazy(() => GeoShapeRelation).describe('Spatial relation operator used to search a geo field.').optional()
...
export const QueryDslShapeFieldQuery = z.object({
  ...
  relation: z.lazy(() => GeoShapeRelation).describe('Spatial relation between the query shape and the document shape.').optional(),
  shape: z.lazy(() => GeoShape).describe('Queries using an inline shape definition in GeoJSON or Well Known Text (WKT) format.').optional()
