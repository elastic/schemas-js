...
export const IndicesShrinkRequest = z.object({
  ...
  aliases: z.record(z.lazy(() => IndexName), z.lazy(() => IndicesAlias)).describe('The key is the alias name. Index alias names support date math.').optional().meta({ found_in: 'body' }),
