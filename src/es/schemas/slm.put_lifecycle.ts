...
import { AcknowledgedResponseBase, Duration, Indices, Metadata, Name, integer } from './_types.js'
...
export const SlmPutLifecycleRequest = z.object({
  ...
  schedule: z.lazy(() => WatcherCronExpression).describe('Periodic or absolute schedule at which the policy creates snapshots. SLM applies schedule changes immediately.').optional().meta({ found_in: 'body' })
