...
export const FieldCapsFieldCapability = z.object({
  ...
  non_inference_indices: Indices.describe('The list of indices where this field is not an inference field, or null if all indices have the same definition for the field.').optional(),
