...
export const InferenceEmbeddingContentObjectItem = z.object({
  type: InferenceEmbeddingContentType.describe('The type of input to embed. Not all models support all input types. The `audio`, `video`, and `pdf` types are available in Elasticsearch 9.5.0 and later.'),
