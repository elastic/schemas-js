...
export const WatcherSearchTemplateRequestBody = z.object({
  ...
  lang: ScriptLanguage.describe('The language the template is written in. It is reported in the resolved search input of a watch record.').optional(),
  params: z.record(z.string(), z.any()).optional(),
...
export const WatcherExecutionResultAction = z.object({
  ...
  max_iterations: integer.optional(),
  number_of_actions_executed: integer.optional()
...
export const WatcherExecutionResultHttpInput = z.object({
  request: WatcherHttpInputRequestResult,
  status_code: integer.describe('The HTTP status code returned by the request. It is only present when the request was executed.').optional()
