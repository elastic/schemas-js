...
export const StartDeploymentResourceMaintenanceModeResponse = DeploymentResourceCommandResponse
export type StartDeploymentResourceMaintenanceModeResponse = DeploymentResourceCommandResponse
