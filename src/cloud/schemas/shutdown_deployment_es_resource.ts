...
export const ShutdownDeploymentEsResourceResponse = DeploymentResourceCommandResponse
export type ShutdownDeploymentEsResourceResponse = DeploymentResourceCommandResponse
