...
export const RestartDeploymentStatelessResourceResponse = DeploymentResourceCommandResponse
export type RestartDeploymentStatelessResourceResponse = DeploymentResourceCommandResponse
