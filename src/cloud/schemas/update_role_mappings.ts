...
export const UpdateOrganizationRoleMappingRequest = z.object({
  mappings: z.array(RoleMapping)
}).meta({ id: 'UpdateOrganizationRoleMappingRequest' })
export type UpdateOrganizationRoleMappingRequest = z.infer<typeof UpdateOrganizationRoleMappingRequest>

export const UpdateRoleMappingsRequest = UpdateOrganizationRoleMappingRequest
export type UpdateRoleMappingsRequest = UpdateOrganizationRoleMappingRequest

export const UpdateRoleMappingsResponse = EmptyResponse
export type UpdateRoleMappingsResponse = EmptyResponse
