...
export const StopDeploymentResourceMaintenanceModeResponse = DeploymentResourceCommandResponse
export type StopDeploymentResourceMaintenanceModeResponse = DeploymentResourceCommandResponse
