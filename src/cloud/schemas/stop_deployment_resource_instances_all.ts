...
export const StopDeploymentResourceInstancesAllResponse = DeploymentResourceCommandResponse
export type StopDeploymentResourceInstancesAllResponse = DeploymentResourceCommandResponse
