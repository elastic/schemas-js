...
export const EnableDeploymentResourceCcrResponse = DeploymentResourceCommandResponse
export type EnableDeploymentResourceCcrResponse = DeploymentResourceCommandResponse
