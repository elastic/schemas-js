...
export const RestartDeploymentEsResourceResponse = DeploymentResourceCommandResponse
export type RestartDeploymentEsResourceResponse = DeploymentResourceCommandResponse
