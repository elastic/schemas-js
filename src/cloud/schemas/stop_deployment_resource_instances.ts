...
export const StopDeploymentResourceInstancesResponse = DeploymentResourceCommandResponse
export type StopDeploymentResourceInstancesResponse = DeploymentResourceCommandResponse
