...
export const EnableDeploymentResourceSlmResponse = DeploymentResourceCommandResponse
export type EnableDeploymentResourceSlmResponse = DeploymentResourceCommandResponse
