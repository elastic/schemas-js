...
export const StartDeploymentResourceInstancesResponse = DeploymentResourceCommandResponse
export type StartDeploymentResourceInstancesResponse = DeploymentResourceCommandResponse
