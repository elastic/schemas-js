...
export const serverlessManifest: readonly ApiRegistryMeta[] = [
  ...
  { id: 'elasticsearch-projects.get-elasticsearch-project-can-delete', name: 'get-elasticsearch-project-can-delete', namespace: 'elasticsearch-projects', description: 'Get Elasticsearch project delete status', namespaceFile: 'elasticsearch-projects' },
  ...
  { id: 'elasticsearch-projects.get-elasticsearch-project-link-candidates', name: 'get-elasticsearch-project-link-candidates', namespace: 'elasticsearch-projects', description: 'Get Elasticsearch project link candidates', namespaceFile: 'elasticsearch-projects' },
  ...
  { id: 'observability-projects.get-observability-project-can-delete', name: 'get-observability-project-can-delete', namespace: 'observability-projects', description: 'Get Observability project delete status', namespaceFile: 'observability-projects' },
  ...
  { id: 'observability-projects.get-observability-project-link-candidates', name: 'get-observability-project-link-candidates', namespace: 'observability-projects', description: 'Get Observability project link candidates', namespaceFile: 'observability-projects' },
  ...
  { id: 'security-projects.get-security-project-can-delete', name: 'get-security-project-can-delete', namespace: 'security-projects', description: 'Get Security project delete status', namespaceFile: 'security-projects' },
  ...
  { id: 'security-projects.get-security-project-link-candidates', name: 'get-security-project-link-candidates', namespace: 'security-projects', description: 'Get Security project link candidates', namespaceFile: 'security-projects' },
  ...
  { id: 'vectordb-projects.list-vector-dbprojects', name: 'list-vector-dbprojects', namespace: 'vectordb-projects', description: 'Get VectorDB projects', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.create-vector-dbproject', name: 'create-vector-dbproject', namespace: 'vectordb-projects', description: 'Create a VectorDB project', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.get-vector-dbproject', name: 'get-vector-dbproject', namespace: 'vectordb-projects', description: 'Get a VectorDB project', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.delete-vector-dbproject', name: 'delete-vector-dbproject', namespace: 'vectordb-projects', description: 'Delete a VectorDB project', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.patch-vector-dbproject', name: 'patch-vector-dbproject', namespace: 'vectordb-projects', description: 'Update a VectorDB project', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.get-vector-dbproject-can-delete', name: 'get-vector-dbproject-can-delete', namespace: 'vectordb-projects', description: 'Get VectorDB project delete status', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.reset-vector-dbproject-credentials', name: 'reset-vector-dbproject-credentials', namespace: 'vectordb-projects', description: 'Reset the project credentials', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.resume-vector-dbproject', name: 'resume-vector-dbproject', namespace: 'vectordb-projects', description: 'Resume VectorDB project', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.get-vector-dbproject-link-candidates', name: 'get-vector-dbproject-link-candidates', namespace: 'vectordb-projects', description: 'Get VectorDB project link candidates', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.get-vector-dbproject-roles', name: 'get-vector-dbproject-roles', namespace: 'vectordb-projects', description: 'Get roles for a VectorDB project', namespaceFile: 'vectordb-projects' },
  { id: 'vectordb-projects.get-vector-dbproject-status', name: 'get-vector-dbproject-status', namespace: 'vectordb-projects', description: 'Get the status of a VectorDB project', namespaceFile: 'vectordb-projects' },
]
