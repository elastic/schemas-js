import { z } from 'zod';
export declare const PutFleetFleetServerHostsItemidRequest: z.ZodObject<{
    host_urls: z.ZodOptional<z.ZodArray<z.ZodString>>;
...
export type PutFleetFleetServerHostsItemidRequest = z.infer<typeof PutFleetFleetServerHostsItemidRequest>;
export declare const PutFleetFleetServerHostsItemidResponse: z.ZodObject<{
    item: z.ZodObject<{
...
export type PutFleetFleetServerHostsItemidResponse = z.infer<typeof PutFleetFleetServerHostsItemidResponse>;
//# sourceMappingURL=put_fleet_fleet_server_hosts_itemid.d.ts.map