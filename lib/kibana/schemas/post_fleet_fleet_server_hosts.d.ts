import { z } from 'zod';
export declare const PostFleetFleetServerHostsRequest: z.ZodObject<{
...
export type PostFleetFleetServerHostsRequest = z.infer<typeof PostFleetFleetServerHostsRequest>;
export declare const PostFleetFleetServerHostsResponse: z.ZodObject<{
    item: z.ZodObject<{
        host_urls: z.ZodArray<z.ZodString>;
        id: z.ZodString;
        is_default: z.ZodOptional<z.ZodBoolean>;
...
export type PostFleetFleetServerHostsResponse = z.infer<typeof PostFleetFleetServerHostsResponse>;
//# sourceMappingURL=post_fleet_fleet_server_hosts.d.ts.map