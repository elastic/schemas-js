...
export declare const InitEntityEngineRequest: z.ZodObject<{
    delay: z.ZodOptional<z.ZodString>;
    docsPerSecond: z.ZodOptional<z.ZodNumber>;
...
export type InitEntityEngineRequest = z.infer<typeof InitEntityEngineRequest>;
//# sourceMappingURL=init_entity_engine.d.ts.map