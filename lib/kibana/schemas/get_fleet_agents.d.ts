import { z } from 'zod';
export declare const GetFleetAgentsResponse: z.ZodObject<{
    ...
    nextSearchAfter: z.ZodOptional<z.ZodString>;
    page: z.ZodNumber;
    perPage: z.ZodNumber;
    pit: z.ZodOptional<z.ZodString>;
    statusSummary: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodNumber>>;
    total: z.ZodNumber;
}, z.core.$strip>;
export type GetFleetAgentsResponse = z.infer<typeof GetFleetAgentsResponse>;
//# sourceMappingURL=get_fleet_agents.d.ts.map