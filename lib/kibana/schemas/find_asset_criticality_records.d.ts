...
export declare const FindAssetCriticalityRecordsResponse: z.ZodObject<{
    page: z.ZodNumber;
    per_page: z.ZodNumber;
    records: z.ZodArray<z.ZodIntersection<z.ZodIntersection<z.ZodObject<{
        id_field: z.ZodEnum<{
            "host.name": "host.name";
            "user.name": "user.name";
            "service.name": "service.name";
...
export type FindAssetCriticalityRecordsResponse = z.infer<typeof FindAssetCriticalityRecordsResponse>;
//# sourceMappingURL=find_asset_criticality_records.d.ts.map