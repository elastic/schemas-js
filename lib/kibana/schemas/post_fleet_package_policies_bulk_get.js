...
export const Kibana_HTTP_APIs_bulk_get_package_policies_response = z.object({
    items: z.array(Kibana_HTTP_APIs_package_policy_response)
}).meta({ id: 'Kibana_HTTP_APIs_bulk_get_package_policies_response' });
export const PostFleetPackagePoliciesBulkGetRequest = z.object({
    ids: z.array(z.string()),
    ignoreMissing: z.boolean().optional()
}).meta({ id: 'PostFleetPackagePoliciesBulkGetRequest' });
//# sourceMappingURL=post_fleet_package_policies_bulk_get.js.map