import { z } from 'zod';
export declare const PutFleetSettingsRequest: z.ZodObject<{
    additional_yaml_config: z.ZodOptional<z.ZodString>;
    ...
    kibana_ca_sha256: z.ZodOptional<z.ZodString>;
    kibana_urls: z.ZodOptional<z.ZodArray<z.ZodString>>;
    prerelease_integrations_enabled: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
export type PutFleetSettingsRequest = z.infer<typeof PutFleetSettingsRequest>;
export declare const PutFleetSettingsResponse: z.ZodObject<{
    item: z.ZodObject<{
...
export type PutFleetSettingsResponse = z.infer<typeof PutFleetSettingsResponse>;
//# sourceMappingURL=put_fleet_settings.d.ts.map