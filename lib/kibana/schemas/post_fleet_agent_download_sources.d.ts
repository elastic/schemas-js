import { z } from 'zod';
export declare const PostFleetAgentDownloadSourcesRequest: z.ZodObject<{
...
export type PostFleetAgentDownloadSourcesRequest = z.infer<typeof PostFleetAgentDownloadSourcesRequest>;
export declare const PostFleetAgentDownloadSourcesResponse: z.ZodObject<{
    item: z.ZodObject<{
        auth: z.ZodOptional<z.ZodNullable<z.ZodObject<{
            api_key: z.ZodOptional<z.ZodString>;
            headers: z.ZodOptional<z.ZodArray<z.ZodObject<{
...
export type PostFleetAgentDownloadSourcesResponse = z.infer<typeof PostFleetAgentDownloadSourcesResponse>;
//# sourceMappingURL=post_fleet_agent_download_sources.d.ts.map