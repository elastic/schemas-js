import { z } from 'zod';
export declare const Security_Endpoint_Exceptions_API_ExceptionListVersion: z.ZodNumber;
...
export declare const Security_Endpoint_Exceptions_API_ExceptionListType: z.ZodEnum<{
    endpoint: "endpoint";
    detection: "detection";
...
export declare const Security_Endpoint_Exceptions_API_ExceptionListTags: z.ZodArray<z.ZodString>;
...
export declare const Security_Endpoint_Exceptions_API_ExceptionListName: z.ZodString;
...
export declare const Security_Endpoint_Exceptions_API_ExceptionListMeta: z.ZodRecord<z.ZodString, z.ZodUnknown>;
...
export declare const Security_Endpoint_Exceptions_API_ExceptionListId: z.ZodString;
...
export declare const Security_Endpoint_Exceptions_API_ExceptionListDescription: z.ZodString;
...
export declare const Security_Endpoint_Exceptions_API_ExceptionListOsTypeArray: z.ZodArray<z.ZodEnum<{
    linux: "linux";
    macos: "macos";
    windows: "windows";
}>>;
...
export declare const Security_Endpoint_Exceptions_API_ExceptionList: z.ZodObject<{
...
export type Security_Endpoint_Exceptions_API_ExceptionList = z.infer<typeof Security_Endpoint_Exceptions_API_ExceptionList>;
export declare const Security_Endpoint_Exceptions_API_EndpointList: z.ZodUnion<readonly [z.ZodObject<{
    _version: z.ZodOptional<z.ZodString>;
    created_at: z.ZodString;
    created_by: z.ZodString;
    description: z.ZodString;
...
//# sourceMappingURL=create_endpoint_list.d.ts.map