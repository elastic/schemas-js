...
export const SynonymsGetSynonymRequest = z.object({
    ...
    from: integer.describe('The starting offset for synonym rules to retrieve.').optional().meta({ found_in: 'query' }),
    size: integer.describe('The max number of synonym rules to retrieve.').optional().meta({ found_in: 'query' }),
...
//# sourceMappingURL=synonyms_get_synonym.js.map