 ...
 */
export declare const MlRevertModelSnapshotRequest: z.ZodObject<{
    job_id: z.ZodString;
    snapshot_id: z.ZodString;
    delete_intervening_results: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
export type MlRevertModelSnapshotRequest = z.infer<typeof MlRevertModelSnapshotRequest>;
export declare const MlRevertModelSnapshotResponse: z.ZodObject<{
    model: z.ZodObject<{
        description: z.ZodOptional<z.ZodString>;
        job_id: z.ZodString;
        latest_record_time_stamp: z.ZodOptional<z.ZodNumber>;
...
//# sourceMappingURL=ml_revert_model_snapshot.d.ts.map