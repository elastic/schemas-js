...
export declare const RankEvalDocumentRating: z.ZodObject<{
    _id: z.ZodString;
    _index: z.ZodString;
    rating: z.ZodNumber;
}, z.core.$strip>;
...
export declare const RankEvalRankEvalHit: z.ZodObject<{
    _id: z.ZodString;
    _index: z.ZodString;
    _score: z.ZodNumber;
}, z.core.$strip>;
export type RankEvalRankEvalHit = z.infer<typeof RankEvalRankEvalHit>;
export declare const RankEvalRankEvalHitItem: z.ZodObject<{
    hit: z.ZodObject<{
        _id: z.ZodString;
        _index: z.ZodString;
        _score: z.ZodNumber;
...
export declare const RankEvalRankEvalMetricBase: z.ZodObject<{
    k: z.ZodOptional<z.ZodNumber>;
}, z.core.$strip>;
export type RankEvalRankEvalMetricBase = z.infer<typeof RankEvalRankEvalMetricBase>;
export declare const RankEvalRankEvalMetricRatingTreshold: z.ZodObject<{
    relevant_rating_threshold: z.ZodOptional<z.ZodNumber>;
    k: z.ZodOptional<z.ZodNumber>;
}, z.core.$strip>;
export type RankEvalRankEvalMetricRatingTreshold = z.infer<typeof RankEvalRankEvalMetricRatingTreshold>;
/** Precision at K (P@k) */
export declare const RankEvalRankEvalMetricPrecision: z.ZodObject<{
    ignore_unlabeled: z.ZodOptional<z.ZodBoolean>;
    relevant_rating_threshold: z.ZodOptional<z.ZodNumber>;
    k: z.ZodOptional<z.ZodNumber>;
}, z.core.$strip>;
export type RankEvalRankEvalMetricPrecision = z.infer<typeof RankEvalRankEvalMetricPrecision>;
/** Recall at K (R@k) */
export declare const RankEvalRankEvalMetricRecall: z.ZodObject<{
    relevant_rating_threshold: z.ZodOptional<z.ZodNumber>;
    k: z.ZodOptional<z.ZodNumber>;
}, z.core.$strip>;
export type RankEvalRankEvalMetricRecall = z.infer<typeof RankEvalRankEvalMetricRecall>;
/** Mean Reciprocal Rank */
export declare const RankEvalRankEvalMetricMeanReciprocalRank: z.ZodObject<{
    relevant_rating_threshold: z.ZodOptional<z.ZodNumber>;
    k: z.ZodOptional<z.ZodNumber>;
}, z.core.$strip>;
export type RankEvalRankEvalMetricMeanReciprocalRank = z.infer<typeof RankEvalRankEvalMetricMeanReciprocalRank>;
/** Discounted cumulative gain (DCG) */
export declare const RankEvalRankEvalMetricDiscountedCumulativeGain: z.ZodObject<{
...
export declare const RankEvalRankEvalMetricExpectedReciprocalRank: z.ZodObject<{
    maximum_relevance: z.ZodNumber;
    k: z.ZodOptional<z.ZodNumber>;
}, z.core.$strip>;
export type RankEvalRankEvalMetricExpectedReciprocalRank = z.infer<typeof RankEvalRankEvalMetricExpectedReciprocalRank>;
export declare const RankEvalRankEvalMetric: z.ZodObject<{
    ...
    mean_reciprocal_rank: z.ZodOptional<z.ZodObject<{
        relevant_rating_threshold: z.ZodOptional<z.ZodNumber>;
        k: z.ZodOptional<z.ZodNumber>;
    }, z.core.$strip>>;
    dcg: z.ZodOptional<z.ZodObject<{
        normalize: z.ZodOptional<z.ZodBoolean>;
        k: z.ZodOptional<z.ZodNumber>;
    }, z.core.$strip>>;
    expected_reciprocal_rank: z.ZodOptional<z.ZodObject<{
        maximum_relevance: z.ZodNumber;
        k: z.ZodOptional<z.ZodNumber>;
    }, z.core.$strip>>;
}, z.core.$strip>;
export type RankEvalRankEvalMetric = z.infer<typeof RankEvalRankEvalMetric>;
export declare const RankEvalUnratedDocument: z.ZodObject<{
    _id: z.ZodString;
    _index: z.ZodString;
}, z.core.$strip>;
export type RankEvalUnratedDocument = z.infer<typeof RankEvalUnratedDocument>;
export declare const RankEvalRankEvalMetricDetail: z.ZodObject<{
    metric_score: z.ZodNumber;
    unrated_docs: z.ZodArray<z.ZodObject<{
        _id: z.ZodString;
        _index: z.ZodString;
    }, z.core.$strip>>;
    ...
    metric_details: z.ZodRecord<z.ZodString, z.ZodRecord<z.ZodString, z.ZodAny>>;
}, z.core.$strip>;
...
export declare const RankEvalRankEvalQuery: z.ZodObject<{
...
export declare const RankEvalRankEvalRequestItem: z.ZodObject<{
    id: z.ZodString;
    request: z.ZodOptional<z.ZodUnion<readonly [z.ZodObject<{
        query: z.ZodLazy<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>;
        size: z.ZodOptional<z.ZodNumber>;
    }, z.core.$strip>, z.ZodLazy<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>]>>;
 ...
 */
export declare const RankEvalRequest: z.ZodObject<{
...
export declare const RankEvalResponse: z.ZodObject<{
    metric_score: z.ZodNumber;
    ...
    failures: z.ZodRecord<z.ZodString, z.ZodAny>;
}, z.core.$strip>;
