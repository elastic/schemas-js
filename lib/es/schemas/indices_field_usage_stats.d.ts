...
export declare const IndicesFieldUsageStatsFieldsUsageBody: z.ZodObject<{
    _shards: z.ZodObject<{
        failed: z.ZodNumber;
        successful: z.ZodNumber;
        total: z.ZodNumber;
 ...
 */
export declare const IndicesFieldUsageStatsRequest: z.ZodObject<{
...
export declare const IndicesFieldUsageStatsResponse: z.ZodObject<{
    _shards: z.ZodObject<{
        failed: z.ZodNumber;
        successful: z.ZodNumber;
        total: z.ZodNumber;
...
//# sourceMappingURL=indices_field_usage_stats.d.ts.map