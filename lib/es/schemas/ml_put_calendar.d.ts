...
/** Create a calendar. */
export declare const MlPutCalendarRequest: z.ZodObject<{
    calendar_id: z.ZodString;
    job_ids: z.ZodOptional<z.ZodArray<z.ZodString>>;
    description: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
export type MlPutCalendarRequest = z.infer<typeof MlPutCalendarRequest>;
export declare const MlPutCalendarResponse: z.ZodObject<{
    calendar_id: z.ZodString;
    description: z.ZodOptional<z.ZodString>;
