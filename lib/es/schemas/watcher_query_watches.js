...
export const TransformContainer = TransformContainerExclusiveProps.meta({ id: 'TransformContainer' });
...
export const WatcherAlwaysCondition = z.object({}).meta({ id: 'WatcherAlwaysCondition' });
...
export const WatcherNeverCondition = z.object({}).meta({ id: 'WatcherNeverCondition' });
...
export const WatcherInputContainer = WatcherInputContainerExclusiveProps.meta({ id: 'WatcherInputContainer' });
export const WatcherChainInput = z.object({
    get inputs() { return z.array(z.record(z.string(), WatcherInputContainer)); }
