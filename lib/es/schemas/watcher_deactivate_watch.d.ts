 ...
 */
export declare const WatcherDeactivateWatchRequest: z.ZodObject<{
    watch_id: z.ZodString;
}, z.core.$strip>;
export type WatcherDeactivateWatchRequest = z.infer<typeof WatcherDeactivateWatchRequest>;
export declare const WatcherDeactivateWatchResponse: z.ZodObject<{
    status: z.ZodObject<{
        actions: z.ZodRecord<z.ZodString, z.ZodObject<{
            ack: z.ZodObject<{
                state: z.ZodEnum<{
...
//# sourceMappingURL=watcher_deactivate_watch.d.ts.map