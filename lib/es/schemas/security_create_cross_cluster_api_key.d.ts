 ...
 */
export declare const SecurityCreateCrossClusterApiKeyRequest: z.ZodObject<{
    access: z.ZodObject<{
        replication: z.ZodOptional<z.ZodArray<z.ZodObject<{
            names: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
            allow_restricted_indices: z.ZodOptional<z.ZodBoolean>;
    ...
    name: z.ZodString;
    certificate_identity: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
export type SecurityCreateCrossClusterApiKeyRequest = z.infer<typeof SecurityCreateCrossClusterApiKeyRequest>;
export declare const SecurityCreateCrossClusterApiKeyResponse: z.ZodObject<{
    api_key: z.ZodString;
...
//# sourceMappingURL=security_create_cross_cluster_api_key.d.ts.map