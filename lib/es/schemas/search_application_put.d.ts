...
export declare const SearchApplicationPutRequest: z.ZodObject<{
    name: z.ZodString;
    create: z.ZodOptional<z.ZodBoolean>;
    search_application: z.ZodObject<{
        indices: z.ZodArray<z.ZodString>;
        analytics_collection_name: z.ZodOptional<z.ZodString>;
        template: z.ZodOptional<z.ZodObject<{
            script: z.ZodUnion<readonly [z.ZodLazy<z.ZodObject<{
...
export declare const SearchApplicationPutResponse: z.ZodObject<{
    result: z.ZodEnum<{
        created: "created";
        deleted: "deleted";
        not_found: "not_found";
...
//# sourceMappingURL=search_application_put.d.ts.map