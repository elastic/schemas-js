 ...
 */
export declare const SearchMvtRequest: z.ZodObject<{
    ...
    exact_bounds: z.ZodOptional<z.ZodBoolean>;
    extent: z.ZodOptional<z.ZodNumber>;
    fields: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
    grid_agg: z.ZodOptional<z.ZodEnum<{
        geotile: "geotile";
        geohex: "geohex";
    }>>;
    grid_precision: z.ZodOptional<z.ZodNumber>;
    grid_type: z.ZodOptional<z.ZodEnum<{
        grid: "grid";
        point: "point";
        centroid: "centroid";
    }>>;
    ...
    track_total_hits: z.ZodOptional<z.ZodUnion<readonly [z.ZodBoolean, z.ZodNumber]>>;
    with_labels: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
export type SearchMvtRequest = z.infer<typeof SearchMvtRequest>;
export declare const MapboxVectorTiles: z.ZodCustom<ArrayBuffer, ArrayBuffer>;
export type MapboxVectorTiles = z.infer<typeof MapboxVectorTiles>;
export declare const SearchMvtResponse: z.ZodCustom<ArrayBuffer, ArrayBuffer>;
