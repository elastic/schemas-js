 ...
 */
export declare const GetScriptRequest: z.ZodObject<{
    id: z.ZodString;
...
export declare const StoredScript: z.ZodObject<{
    lang: z.ZodUnion<readonly [z.ZodEnum<{
        painless: "painless";
        expression: "expression";
        mustache: "mustache";
        java: "java";
    ...
    options: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
    source: z.ZodLazy<z.ZodType<ScriptSourceShape, unknown, z.core.$ZodTypeInternals<ScriptSourceShape, unknown>>>;
}, z.core.$strip>;
export type StoredScript = z.infer<typeof StoredScript>;
export declare const GetScriptResponse: z.ZodObject<{
    _id: z.ZodString;
    found: z.ZodBoolean;
