...
export declare const IndicesResponseBase: z.ZodObject<{
 ...
 */
export declare const IndicesPutMappingRequest: z.ZodObject<{
    ...
    timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    write_index_only: z.ZodOptional<z.ZodBoolean>;
    ...
    runtime: z.ZodOptional<z.ZodLazy<z.ZodType<MappingRuntimeFieldsShape, unknown, z.core.$ZodTypeInternals<MappingRuntimeFieldsShape, unknown>>>>;
}, z.core.$strip>;
export type IndicesPutMappingRequest = z.infer<typeof IndicesPutMappingRequest>;
export declare const IndicesPutMappingResponse: z.ZodObject<{
    _shards: z.ZodOptional<z.ZodObject<{
        failed: z.ZodNumber;
        successful: z.ZodNumber;
        total: z.ZodNumber;
...
//# sourceMappingURL=indices_put_mapping.d.ts.map