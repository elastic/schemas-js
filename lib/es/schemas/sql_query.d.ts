...
export declare const SqlQuerySqlFormat: z.ZodEnum<{
    json: "json";
    csv: "csv";
    tsv: "tsv";
    txt: "txt";
 ...
 * Run an SQL request.
 */
export declare const SqlQueryRequest: z.ZodObject<{
    ...
    field_multi_value_leniency: z.ZodOptional<z.ZodBoolean>;
    ...
    index_using_frozen: z.ZodOptional<z.ZodBoolean>;
    keep_alive: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    keep_on_completion: z.ZodOptional<z.ZodBoolean>;
    page_timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    params: z.ZodOptional<z.ZodArray<z.ZodAny>>;
    query: z.ZodOptional<z.ZodString>;
    request_timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
...
export declare const SqlQueryResponse: z.ZodObject<{
...
//# sourceMappingURL=sql_query.d.ts.map