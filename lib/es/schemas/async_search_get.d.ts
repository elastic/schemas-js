 ...
 */
export declare const AsyncSearchGetRequest: z.ZodObject<{
    id: z.ZodString;
    keep_alive: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    ...
    return_intermediate_results: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
export type AsyncSearchGetRequest = z.infer<typeof AsyncSearchGetRequest>;
export declare const AsyncSearchGetResponse: z.ZodObject<{
    response: z.ZodObject<{
        aggregations: z.ZodOptional<z.ZodAny>;
        _clusters: z.ZodOptional<z.ZodObject<{
            skipped: z.ZodNumber;
...
//# sourceMappingURL=async_search_get.d.ts.map