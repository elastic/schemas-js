...
export const IndexingStats = z.object({
    ...
    index_total: long,
    index_failed: long,
    get types() { return z.record(z.string(), IndexingStats).optional(); },
...
export const SearchStats = z.object({
    ...
    get groups() { return z.record(z.string(), SearchStats).optional(); }
}).meta({ id: 'SearchStats' });
...
export const IndicesStatsIndicesStats = z.object({
    ...
    get shards() { return z.record(z.string(), IndicesStatsShardStats.array()).optional(); },
