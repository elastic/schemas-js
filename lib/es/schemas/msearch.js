...
export const SearchHit = z.object({
    ...
    get inner_hits() { return z.record(z.string(), SearchInnerHitsResult).optional(); },
...
export const MsearchMultisearchHeader = z.object({
    ...
    routing: Routing.describe('A custom value used to route operations to a specific shard. Not allowed when `index.slice.enabled` is `true` for the target index; use `_slice` instead.').optional(),
...
export const MsearchRequest = z.object({
    ...
    routing: Routing.describe('Custom routing value used to route search operations to a specific shard. Not allowed when `index.slice.enabled` is `true` for the target index; use `_slice` instead.').optional().meta({ found_in: 'query' }),
