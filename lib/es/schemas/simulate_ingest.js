...
export const MappingPropertyBase = z.object({
    meta: z.record(z.string(), z.string()).describe('Metadata about the field.').optional(),
    get properties() { return z.record(PropertyName, MappingProperty).optional(); },
    ignore_above: integer.optional(),
    dynamic: MappingDynamicMapping.optional(),
    get fields() { return z.record(PropertyName, MappingProperty).optional(); },
...
export const IngestProcessorContainer = IngestProcessorContainerExclusiveProps.meta({ id: 'IngestProcessorContainer' });
