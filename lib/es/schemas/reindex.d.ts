...
export declare const SlicesCalculation: z.ZodEnum<{
    auto: "auto";
}>;
export type SlicesCalculation = z.infer<typeof SlicesCalculation>;
/** Slices configuration used to parallelize a process. */
export declare const Slices: z.ZodUnion<readonly [z.ZodNumber, z.ZodEnum<{
    auto: "auto";
}>]>;
...
export declare const Conflicts: z.ZodEnum<{
    abort: "abort";
    proceed: "proceed";
}>;
 ...
 */
export declare const ReindexRequest: z.ZodObject<{
    ...
    slices: z.ZodOptional<z.ZodUnion<readonly [z.ZodNumber, z.ZodEnum<{
        auto: "auto";
    }>]>>;
    timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
...
export declare const ReindexResponse: z.ZodObject<{
