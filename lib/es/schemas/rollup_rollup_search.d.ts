 ...
 * @deprecated
 */
export declare const RollupRollupSearchRequest: z.ZodObject<{
...
export declare const RollupRollupSearchResponse: z.ZodObject<{
    took: z.ZodNumber;
...
//# sourceMappingURL=rollup_rollup_search.d.ts.map