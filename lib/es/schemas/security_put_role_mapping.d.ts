 ...
 */
export declare const SecurityPutRoleMappingRequest: z.ZodObject<{
    name: z.ZodString;
    ...
    rules: z.ZodOptional<z.ZodLazy<z.ZodType<SecurityRoleMappingRuleShape, unknown, z.core.$ZodTypeInternals<SecurityRoleMappingRuleShape, unknown>>>>;
...
export declare const SecurityPutRoleMappingResponse: z.ZodObject<{
    created: z.ZodOptional<z.ZodBoolean>;
    role_mapping: z.ZodObject<{
        created: z.ZodBoolean;
    }, z.core.$strip>;
}, z.core.$strip>;
export type SecurityPutRoleMappingResponse = z.infer<typeof SecurityPutRoleMappingResponse>;
//# sourceMappingURL=security_put_role_mapping.d.ts.map