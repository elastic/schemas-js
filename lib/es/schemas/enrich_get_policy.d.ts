...
export declare const EnrichPolicy: z.ZodObject<{
    enrich_fields: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
    indices: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
    match_field: z.ZodString;
    ...
    name: z.ZodOptional<z.ZodString>;
    elasticsearch_version: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
export type EnrichPolicy = z.infer<typeof EnrichPolicy>;
export declare const EnrichPolicyType: z.ZodEnum<{
    match: "match";
    geo_match: "geo_match";
    range: "range";
}>;
export type EnrichPolicyType = z.infer<typeof EnrichPolicyType>;
export declare const EnrichSummary: z.ZodObject<{
    config: z.ZodRecord<z.ZodEnum<{
        match: "match";
        geo_match: "geo_match";
        range: "range";
    }>, z.ZodObject<{
 ...
 */
export declare const EnrichGetPolicyRequest: z.ZodObject<{
...
export declare const EnrichGetPolicyResponse: z.ZodObject<{
...
//# sourceMappingURL=enrich_get_policy.d.ts.map