...
export declare const ReindexDestination: z.ZodObject<{
    index: z.ZodString;
...
export declare const ReindexRemoteSource: z.ZodObject<{
    connect_timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    headers: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
    host: z.ZodString;
    username: z.ZodOptional<z.ZodString>;
    password: z.ZodOptional<z.ZodString>;
    api_key: z.ZodOptional<z.ZodString>;
    socket_timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
}, z.core.$strip>;
...
export declare const ReindexSource: z.ZodObject<{
    ...
    source_fields: z.ZodOptional<z.ZodUnion<readonly [z.ZodBoolean, z.ZodUnion<readonly [z.ZodObject<{
        exclude_vectors: z.ZodOptional<z.ZodBoolean>;
        excludes: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
        exclude: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
        includes: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
...
export declare const MlApiKeyAuthorization: z.ZodObject<{
    id: z.ZodString;
    name: z.ZodString;
}, z.core.$strip>;
export type MlApiKeyAuthorization = z.infer<typeof MlApiKeyAuthorization>;
export declare const MlTransformAuthorization: z.ZodObject<{
...
export declare const TransformDestination: z.ZodObject<{
    index: z.ZodOptional<z.ZodString>;
    pipeline: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
export type TransformDestination = z.infer<typeof TransformDestination>;
export declare const TransformLatest: z.ZodObject<{
    sort: z.ZodString;
    unique_key: z.ZodArray<z.ZodString>;
}, z.core.$strip>;
export type TransformLatest = z.infer<typeof TransformLatest>;
export declare const TransformPivotGroupByContainer: z.ZodUnion<readonly [z.ZodObject<{
    date_histogram: z.ZodLazy<z.ZodObject<{
        calendar_interval: z.ZodOptional<z.ZodEnum<{
            second: "second";
            "1s": "1s";
            minute: "minute";
    ...
    histogram: z.ZodLazy<z.ZodObject<{
        extended_bounds: z.ZodOptional<z.ZodObject<{
            max: z.ZodOptional<z.ZodAny>;
            min: z.ZodOptional<z.ZodAny>;
        }, z.core.$strip>>;
...
export declare const TransformPivot: z.ZodObject<{
    aggregations: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodLazy<z.ZodType<AggregationsAggregationContainerShape, unknown, z.core.$ZodTypeInternals<AggregationsAggregationContainerShape, unknown>>>>>;
    aggs: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodLazy<z.ZodType<AggregationsAggregationContainerShape, unknown, z.core.$ZodTypeInternals<AggregationsAggregationContainerShape, unknown>>>>>;
    group_by: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnion<readonly [z.ZodObject<{
        date_histogram: z.ZodLazy<z.ZodObject<{
            calendar_interval: z.ZodOptional<z.ZodEnum<{
                second: "second";
                "1s": "1s";
...
export declare const TransformRetentionPolicy: z.ZodObject<{
    field: z.ZodString;
    max_age: z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>;
}, z.core.$strip>;
export type TransformRetentionPolicy = z.infer<typeof TransformRetentionPolicy>;
export declare const TransformRetentionPolicyContainer: z.ZodUnion<readonly [z.ZodObject<{
    time: z.ZodObject<{
        field: z.ZodString;
        max_age: z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>;
    }, z.core.$strip>;
...
export declare const TransformSettings: z.ZodObject<{
    align_checkpoints: z.ZodOptional<z.ZodBoolean>;
    dates_as_epoch_millis: z.ZodOptional<z.ZodBoolean>;
    deduce_mappings: z.ZodOptional<z.ZodBoolean>;
    docs_per_second: z.ZodOptional<z.ZodNumber>;
    max_page_search_size: z.ZodOptional<z.ZodNumber>;
    use_point_in_time: z.ZodOptional<z.ZodBoolean>;
    num_failure_retries: z.ZodOptional<z.ZodNumber>;
    unattended: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
export type TransformSettings = z.infer<typeof TransformSettings>;
export declare const TransformSource: z.ZodObject<{
    index: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
    query: z.ZodOptional<z.ZodLazy<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>>;
    runtime_mappings: z.ZodOptional<z.ZodLazy<z.ZodType<MappingRuntimeFieldsShape, unknown, z.core.$ZodTypeInternals<MappingRuntimeFieldsShape, unknown>>>>;
}, z.core.$strip>;
export type TransformSource = z.infer<typeof TransformSource>;
export declare const TransformTimeSync: z.ZodObject<{
...
export declare const TransformSyncContainer: z.ZodUnion<readonly [z.ZodObject<{
    time: z.ZodObject<{
        delay: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
        field: z.ZodString;
    }, z.core.$strip>;
 ...
 */
export declare const TransformUpdateTransformRequest: z.ZodObject<{
    transform_id: z.ZodString;
    defer_validation: z.ZodOptional<z.ZodBoolean>;
    timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    ...
    frequency: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    ...
    sync: z.ZodOptional<z.ZodUnion<readonly [z.ZodObject<{
        time: z.ZodObject<{
            delay: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
            field: z.ZodString;
        }, z.core.$strip>;
    }, z.core.$strip>]>>;
    retention_policy: z.ZodOptional<z.ZodUnion<readonly [z.ZodUnion<readonly [z.ZodObject<{
        time: z.ZodObject<{
            field: z.ZodString;
            max_age: z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>;
        }, z.core.$strip>;
...
export declare const TransformUpdateTransformResponse: z.ZodObject<{
    ...
    retention_policy: z.ZodOptional<z.ZodUnion<readonly [z.ZodObject<{
        time: z.ZodObject<{
            field: z.ZodString;
            max_age: z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>;
        }, z.core.$strip>;
...
//# sourceMappingURL=transform_update_transform.d.ts.map