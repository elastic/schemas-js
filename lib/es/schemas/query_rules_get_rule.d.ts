 ...
 */
export declare const QueryRulesGetRuleRequest: z.ZodObject<{
    ruleset_id: z.ZodString;
    rule_id: z.ZodString;
}, z.core.$strip>;
export type QueryRulesGetRuleRequest = z.infer<typeof QueryRulesGetRuleRequest>;
export declare const QueryRulesGetRuleResponse: z.ZodObject<{
    rule_id: z.ZodString;
    type: z.ZodEnum<{
        exclude: "exclude";
        pinned: "pinned";
...
//# sourceMappingURL=query_rules_get_rule.d.ts.map