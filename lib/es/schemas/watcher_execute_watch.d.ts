 ...
 */
export declare const IndicesOptions: z.ZodObject<{
...
export declare const ScriptTransform: z.ZodObject<{
...
export declare const WatcherSearchInputRequestBody: z.ZodObject<{
    query: z.ZodLazy<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>;
}, z.core.$strip>;
...
export declare const WatcherSearchTemplateRequestBody: z.ZodObject<{
    explain: z.ZodOptional<z.ZodBoolean>;
    id: z.ZodOptional<z.ZodString>;
    params: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
    profile: z.ZodOptional<z.ZodBoolean>;
...
export declare const WatcherSearchInputRequestDefinition: z.ZodObject<{
    body: z.ZodOptional<z.ZodObject<{
        query: z.ZodLazy<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>;
    }, z.core.$strip>>;
    indices: z.ZodOptional<z.ZodArray<z.ZodString>>;
    indices_options: z.ZodOptional<z.ZodObject<{
        allow_no_indices: z.ZodOptional<z.ZodBoolean>;
        expand_wildcards: z.ZodOptional<z.ZodUnion<readonly [z.ZodEnum<{
            open: "open";
            all: "all";
...
export declare const SearchTransform: z.ZodObject<{
    request: z.ZodObject<{
        body: z.ZodOptional<z.ZodObject<{
            query: z.ZodLazy<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>;
        }, z.core.$strip>>;
...
export declare const TransformContainer: z.ZodType<TransformContainerShape>;
...
export declare const WatcherActionType: z.ZodEnum<{
    index: "index";
    email: "email";
    webhook: "webhook";
    logging: "logging";
...
export declare const WatcherAlwaysCondition: z.ZodObject<{}, z.core.$strip>;
export type WatcherAlwaysCondition = z.infer<typeof WatcherAlwaysCondition>;
export declare const WatcherArrayCompareCondition: z.ZodObject<{
    path: z.ZodString;
}, z.core.$catchall<z.ZodAny>>;
export type WatcherArrayCompareCondition = z.infer<typeof WatcherArrayCompareCondition>;
export declare const WatcherConditionOp: z.ZodEnum<{
    gt: "gt";
    gte: "gte";
    lt: "lt";
    lte: "lte";
...
export declare const WatcherNeverCondition: z.ZodObject<{}, z.core.$strip>;
export type WatcherNeverCondition = z.infer<typeof WatcherNeverCondition>;
export declare const WatcherScriptCondition: z.ZodObject<{
    lang: z.ZodOptional<z.ZodUnion<readonly [z.ZodEnum<{
        painless: "painless";
        expression: "expression";
        mustache: "mustache";
...
export declare const WatcherConditionContainer: z.ZodUnion<readonly [z.ZodObject<{
    always: z.ZodObject<{}, z.core.$strip>;
}, z.core.$strip>, z.ZodObject<{
    array_compare: z.ZodRecord<z.ZodString, z.ZodObject<{
        path: z.ZodString;
    }, z.core.$catchall<z.ZodAny>>>;
}, z.core.$strip>, z.ZodObject<{
    compare: z.ZodRecord<z.ZodString, z.ZodRecord<z.ZodEnum<{
        gt: "gt";
        gte: "gte";
        lt: "lt";
        lte: "lte";
    ...
    never: z.ZodObject<{}, z.core.$strip>;
}, z.core.$strip>, z.ZodObject<{
    script: z.ZodObject<{
        lang: z.ZodOptional<z.ZodUnion<readonly [z.ZodEnum<{
            painless: "painless";
...
export declare const WatcherIndexAction: z.ZodObject<{
    index: z.ZodString;
...
export declare const WatcherHttpInputBasicAuthentication: z.ZodObject<{
    password: z.ZodString;
    username: z.ZodString;
}, z.core.$strip>;
export type WatcherHttpInputBasicAuthentication = z.infer<typeof WatcherHttpInputBasicAuthentication>;
export declare const WatcherHttpInputAuthentication: z.ZodObject<{
    basic: z.ZodObject<{
        password: z.ZodString;
        username: z.ZodString;
    }, z.core.$strip>;
...
export declare const WatcherHttpInputMethod: z.ZodEnum<{
    delete: "delete";
    get: "get";
    post: "post";
    put: "put";
...
export declare const WatcherHttpInputProxy: z.ZodObject<{
    host: z.ZodString;
    port: z.ZodNumber;
}, z.core.$strip>;
export type WatcherHttpInputProxy = z.infer<typeof WatcherHttpInputProxy>;
export declare const WatcherConnectionScheme: z.ZodEnum<{
    http: "http";
    https: "https";
}>;
export type WatcherConnectionScheme = z.infer<typeof WatcherConnectionScheme>;
export declare const WatcherHttpInputRequestDefinition: z.ZodObject<{
    ...
    connection_timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    ...
    read_timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
...
export declare const WatcherHttpEmailAttachment: z.ZodObject<{
...
export declare const WatcherReportingEmailAttachment: z.ZodObject<{
    url: z.ZodString;
    inline: z.ZodOptional<z.ZodBoolean>;
...
export declare const WatcherDataAttachmentFormat: z.ZodEnum<{
    json: "json";
    yaml: "yaml";
}>;
export type WatcherDataAttachmentFormat = z.infer<typeof WatcherDataAttachmentFormat>;
export declare const WatcherDataEmailAttachment: z.ZodObject<{
...
export declare const WatcherEmailAttachmentContainer: z.ZodUnion<readonly [z.ZodObject<{
    http: z.ZodObject<{
        content_type: z.ZodOptional<z.ZodString>;
        inline: z.ZodOptional<z.ZodBoolean>;
        request: z.ZodOptional<z.ZodObject<{
...
export declare const WatcherEmail: z.ZodObject<{
    id: z.ZodOptional<z.ZodString>;
    ...
    sent_date: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodAny]>>;
    subject: z.ZodString;
    to: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
    attachments: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnion<readonly [z.ZodObject<{
        http: z.ZodObject<{
            content_type: z.ZodOptional<z.ZodString>;
            inline: z.ZodOptional<z.ZodBoolean>;
            request: z.ZodOptional<z.ZodObject<{
...
export declare const WatcherEmailAction: z.ZodObject<{
    id: z.ZodOptional<z.ZodString>;
    bcc: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
    body: z.ZodOptional<z.ZodObject<{
        html: z.ZodOptional<z.ZodString>;
...
export declare const WatcherPagerDutyContextType: z.ZodEnum<{
    image: "image";
    link: "link";
}>;
export type WatcherPagerDutyContextType = z.infer<typeof WatcherPagerDutyContextType>;
export declare const WatcherPagerDutyContext: z.ZodObject<{
...
export declare const WatcherPagerDutyEventType: z.ZodEnum<{
    acknowledge: "acknowledge";
    trigger: "trigger";
    resolve: "resolve";
}>;
export type WatcherPagerDutyEventType = z.infer<typeof WatcherPagerDutyEventType>;
export declare const WatcherPagerDutyEventProxy: z.ZodObject<{
    host: z.ZodOptional<z.ZodString>;
    port: z.ZodOptional<z.ZodNumber>;
}, z.core.$strip>;
export type WatcherPagerDutyEventProxy = z.infer<typeof WatcherPagerDutyEventProxy>;
export declare const WatcherPagerDutyEvent: z.ZodObject<{
    account: z.ZodOptional<z.ZodString>;
    attach_payload: z.ZodBoolean;
...
export declare const WatcherPagerDutyAction: z.ZodObject<{
    account: z.ZodOptional<z.ZodString>;
    attach_payload: z.ZodBoolean;
    client: z.ZodOptional<z.ZodString>;
    client_url: z.ZodOptional<z.ZodString>;
...
export declare const WatcherSlackAttachmentField: z.ZodObject<{
    short: z.ZodBoolean;
    title: z.ZodString;
    value: z.ZodString;
}, z.core.$strip>;
export type WatcherSlackAttachmentField = z.infer<typeof WatcherSlackAttachmentField>;
export declare const WatcherSlackAttachment: z.ZodObject<{
    ...
    ts: z.ZodOptional<z.ZodAny>;
}, z.core.$strip>;
export type WatcherSlackAttachment = z.infer<typeof WatcherSlackAttachment>;
export declare const WatcherSlackDynamicAttachment: z.ZodObject<{
    attachment_template: z.ZodObject<{
        author_icon: z.ZodOptional<z.ZodString>;
        author_link: z.ZodOptional<z.ZodString>;
        author_name: z.ZodString;
        color: z.ZodOptional<z.ZodString>;
...
export declare const WatcherSlackMessage: z.ZodObject<{
    ...
    dynamic_attachments: z.ZodOptional<z.ZodObject<{
        attachment_template: z.ZodObject<{
            author_icon: z.ZodOptional<z.ZodString>;
            author_link: z.ZodOptional<z.ZodString>;
            author_name: z.ZodString;
...
export declare const WatcherSlackAction: z.ZodObject<{
    account: z.ZodOptional<z.ZodString>;
    message: z.ZodObject<{
        attachments: z.ZodArray<z.ZodObject<{
            author_icon: z.ZodOptional<z.ZodString>;
...
export declare const WatcherWebhookAction: z.ZodObject<{
    auth: z.ZodOptional<z.ZodObject<{
        basic: z.ZodObject<{
            password: z.ZodString;
            username: z.ZodString;
...
export declare const WatcherAction: z.ZodObject<{
    ...
    condition: z.ZodOptional<z.ZodUnion<readonly [z.ZodObject<{
        always: z.ZodObject<{}, z.core.$strip>;
    }, z.core.$strip>, z.ZodObject<{
        array_compare: z.ZodRecord<z.ZodString, z.ZodObject<{
            path: z.ZodString;
    ...
    name: z.ZodOptional<z.ZodString>;
    throttle_period: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    throttle_period_in_millis: z.ZodOptional<z.ZodAny>;
    transform: z.ZodOptional<z.ZodLazy<z.ZodType<TransformContainerShape, unknown, z.core.$ZodTypeInternals<TransformContainerShape, unknown>>>>;
...
export declare const WatcherActionExecutionMode: z.ZodEnum<{
    simulate: "simulate";
    skip: "skip";
...
export declare const WatcherActionStatusOptions: z.ZodEnum<{
    success: "success";
    failure: "failure";
    throttled: "throttled";
    simulated: "simulated";
...
export declare const WatcherResponseContentType: z.ZodEnum<{
    json: "json";
    text: "text";
    yaml: "yaml";
}>;
export type WatcherResponseContentType = z.infer<typeof WatcherResponseContentType>;
export declare const WatcherHttpInput: z.ZodObject<{
    extract: z.ZodOptional<z.ZodArray<z.ZodString>>;
    request: z.ZodOptional<z.ZodObject<{
        auth: z.ZodOptional<z.ZodObject<{
            basic: z.ZodObject<{
                password: z.ZodString;
    ...
    response_content_type: z.ZodOptional<z.ZodEnum<{
        json: "json";
        text: "text";
        yaml: "yaml";
    }>>;
...
export declare const WatcherSearchInput: z.ZodObject<{
    extract: z.ZodOptional<z.ZodArray<z.ZodString>>;
    request: z.ZodObject<{
        body: z.ZodOptional<z.ZodObject<{
            query: z.ZodLazy<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>;
...
export declare const WatcherInputContainer: z.ZodType<WatcherInputContainerShape>;
...
export declare const WatcherChainInput: z.ZodObject<{
    inputs: z.ZodArray<z.ZodRecord<z.ZodString, typeof WatcherInputContainer>>;
}, z.core.$strip>;
export type WatcherChainInput = z.infer<typeof WatcherChainInput>;
export declare const WatcherConditionType: z.ZodEnum<{
    never: "never";
    always: "always";
    script: "script";
...
export declare const WatcherDailySchedule: z.ZodObject<{
    at: z.ZodArray<z.ZodUnion<readonly [z.ZodString, z.ZodObject<{
        hour: z.ZodArray<z.ZodNumber>;
        minute: z.ZodArray<z.ZodNumber>;
    }, z.core.$strip>]>>;
}, z.core.$strip>;
export type WatcherDailySchedule = z.infer<typeof WatcherDailySchedule>;
export declare const WatcherDay: z.ZodEnum<{
    sunday: "sunday";
    monday: "monday";
    tuesday: "tuesday";
    wednesday: "wednesday";
...
export declare const WatcherEmailResult: z.ZodObject<{
    account: z.ZodOptional<z.ZodString>;
    message: z.ZodObject<{
        id: z.ZodOptional<z.ZodString>;
        bcc: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
...
export declare const WatcherIndexResultSummary: z.ZodObject<{
...
export declare const WatcherIndexResult: z.ZodObject<{
...
export declare const WatcherLoggingResult: z.ZodObject<{
    logged_text: z.ZodString;
}, z.core.$strip>;
export type WatcherLoggingResult = z.infer<typeof WatcherLoggingResult>;
export declare const WatcherHttpInputRequestResult: z.ZodObject<{
    auth: z.ZodOptional<z.ZodObject<{
        basic: z.ZodObject<{
            password: z.ZodString;
            username: z.ZodString;
...
export declare const WatcherHttpInputResponseResult: z.ZodObject<{
    body: z.ZodString;
...
export declare const WatcherPagerDutyResult: z.ZodObject<{
    event: z.ZodObject<{
        account: z.ZodOptional<z.ZodString>;
        attach_payload: z.ZodBoolean;
        client: z.ZodOptional<z.ZodString>;
...
export declare const WatcherSlackResult: z.ZodObject<{
    account: z.ZodOptional<z.ZodString>;
    message: z.ZodObject<{
        attachments: z.ZodArray<z.ZodObject<{
            author_icon: z.ZodOptional<z.ZodString>;
...
export declare const WatcherWebhookResult: z.ZodObject<{
    request: z.ZodObject<{
        auth: z.ZodOptional<z.ZodObject<{
            basic: z.ZodObject<{
                password: z.ZodString;
...
export declare const WatcherExecutionResultAction: z.ZodObject<{
    email: z.ZodOptional<z.ZodObject<{
        account: z.ZodOptional<z.ZodString>;
        message: z.ZodObject<{
            id: z.ZodOptional<z.ZodString>;
...
export declare const WatcherExecutionResultCondition: z.ZodObject<{
    met: z.ZodBoolean;
    status: z.ZodEnum<{
        success: "success";
        failure: "failure";
...
export declare const WatcherInputType: z.ZodEnum<{
    search: "search";
    simple: "simple";
    http: "http";
}>;
export type WatcherInputType = z.infer<typeof WatcherInputType>;
export declare const WatcherExecutionResultInput: z.ZodObject<{
...
export declare const WatcherExecutionResult: z.ZodObject<{
...
export declare const WatcherExecutionStatus: z.ZodEnum<{
    failed: "failed";
    throttled: "throttled";
...
export declare const WatcherHourlySchedule: z.ZodObject<{
    minute: z.ZodArray<z.ZodNumber>;
}, z.core.$strip>;
export type WatcherHourlySchedule = z.infer<typeof WatcherHourlySchedule>;
export declare const WatcherMonth: z.ZodEnum<{
    january: "january";
    february: "february";
    march: "march";
    april: "april";
...
export declare const WatcherTimeOfMonth: z.ZodObject<{
    at: z.ZodArray<z.ZodString>;
    on: z.ZodArray<z.ZodNumber>;
}, z.core.$strip>;
export type WatcherTimeOfMonth = z.infer<typeof WatcherTimeOfMonth>;
export declare const WatcherTimeOfWeek: z.ZodObject<{
    at: z.ZodArray<z.ZodString>;
...
export declare const WatcherTimeOfYear: z.ZodObject<{
    at: z.ZodArray<z.ZodString>;
    int: z.ZodArray<z.ZodEnum<{
        january: "january";
        february: "february";
        march: "march";
        april: "april";
...
export declare const WatcherScheduleContainer: z.ZodUnion<readonly [z.ZodObject<{
    ...
    interval: z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>;
}, z.core.$strip>, z.ZodObject<{
    monthly: z.ZodUnion<readonly [z.ZodObject<{
        at: z.ZodArray<z.ZodString>;
        on: z.ZodArray<z.ZodNumber>;
    }, z.core.$strip>, z.ZodArray<z.ZodObject<{
        at: z.ZodArray<z.ZodString>;
    ...
    weekly: z.ZodUnion<readonly [z.ZodObject<{
        at: z.ZodArray<z.ZodString>;
        on: z.ZodArray<z.ZodEnum<{
            sunday: "sunday";
            monday: "monday";
    ...
    yearly: z.ZodUnion<readonly [z.ZodObject<{
        at: z.ZodArray<z.ZodString>;
        int: z.ZodArray<z.ZodEnum<{
            january: "january";
            february: "february";
...
export declare const WatcherScheduleTriggerEvent: z.ZodObject<{
    scheduled_time: z.ZodUnion<readonly [z.ZodString, z.ZodAny]>;
    triggered_time: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodAny]>>;
}, z.core.$strip>;
...
export declare const WatcherSimulatedActions: z.ZodObject<{
    actions: z.ZodArray<z.ZodString>;
    all: z.ZodObject</*elided*/ any, z.core.$strip>;
    use_all: z.ZodBoolean;
}, z.core.$strip>;
export type WatcherSimulatedActions = z.infer<typeof WatcherSimulatedActions>;
export declare const WatcherTriggerContainer: z.ZodUnion<readonly [z.ZodObject<{
    schedule: z.ZodUnion<readonly [z.ZodObject<{
        timezone: z.ZodString;
    }, z.core.$strip>, z.ZodObject<{
        cron: z.ZodString;
    }, z.core.$strip>, z.ZodObject<{
...
export declare const WatcherTriggerEventContainer: z.ZodUnion<readonly [z.ZodObject<{
...
export declare const WatcherTriggerEventResult: z.ZodObject<{
    manual: z.ZodUnion<readonly [z.ZodObject<{
        schedule: z.ZodObject<{
            scheduled_time: z.ZodUnion<readonly [z.ZodString, z.ZodAny]>;
            triggered_time: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodAny]>>;
        }, z.core.$strip>;
...
export declare const WatcherWatch: z.ZodObject<{
    actions: z.ZodRecord<z.ZodString, z.ZodObject<{
        action_type: z.ZodOptional<z.ZodEnum<{
            index: "index";
            email: "email";
    ...
    input: z.ZodLazy<z.ZodType<WatcherInputContainerShape, unknown, z.core.$ZodTypeInternals<WatcherInputContainerShape, unknown>>>;
 ...
 */
export declare const WatcherExecuteWatchRequest: z.ZodObject<{
    id: z.ZodOptional<z.ZodString>;
    debug: z.ZodOptional<z.ZodBoolean>;
    action_modes: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodEnum<{
        simulate: "simulate";
        skip: "skip";
        force_simulate: "force_simulate";
        execute: "execute";
    ...
    alternative_input: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
    ignore_condition: z.ZodOptional<z.ZodBoolean>;
    record_execution: z.ZodOptional<z.ZodBoolean>;
    simulated_actions: z.ZodOptional<z.ZodLazy<z.ZodObject<{
        actions: z.ZodArray<z.ZodString>;
        all: z.ZodObject</*elided*/ any, z.core.$strip>;
        use_all: z.ZodBoolean;
    }, z.core.$strip>>>;
    trigger_data: z.ZodOptional<z.ZodObject<{
        scheduled_time: z.ZodUnion<readonly [z.ZodString, z.ZodAny]>;
        triggered_time: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodAny]>>;
    }, z.core.$strip>>;
...
export declare const WatcherExecuteWatchWatchRecord: z.ZodObject<{
    condition: z.ZodUnion<readonly [z.ZodObject<{
        always: z.ZodObject<{}, z.core.$strip>;
    }, z.core.$strip>, z.ZodObject<{
        array_compare: z.ZodRecord<z.ZodString, z.ZodObject<{
...
export declare const WatcherExecuteWatchResponse: z.ZodObject<{
    _id: z.ZodString;
    watch_record: z.ZodObject<{
        condition: z.ZodUnion<readonly [z.ZodObject<{
            always: z.ZodObject<{}, z.core.$strip>;
        }, z.core.$strip>, z.ZodObject<{
            array_compare: z.ZodRecord<z.ZodString, z.ZodObject<{
...
//# sourceMappingURL=watcher_execute_watch.d.ts.map