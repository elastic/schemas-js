 ...
 */
export declare const SynonymsDeleteSynonymRuleRequest: z.ZodObject<{
    set_id: z.ZodString;
    rule_id: z.ZodString;
}, z.core.$strip>;
export type SynonymsDeleteSynonymRuleRequest = z.infer<typeof SynonymsDeleteSynonymRuleRequest>;
export declare const SynonymsDeleteSynonymRuleResponse: z.ZodObject<{
    result: z.ZodEnum<{
        created: "created";
        deleted: "deleted";
        not_found: "not_found";
...
//# sourceMappingURL=synonyms_delete_synonym_rule.d.ts.map