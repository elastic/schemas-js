...
export declare const GraphConnection: z.ZodObject<{
    doc_count: z.ZodNumber;
    source: z.ZodNumber;
    target: z.ZodNumber;
    weight: z.ZodNumber;
...
export declare const GraphSampleDiversity: z.ZodObject<{
    field: z.ZodString;
    max_docs_per_value: z.ZodNumber;
}, z.core.$strip>;
export type GraphSampleDiversity = z.infer<typeof GraphSampleDiversity>;
export declare const GraphExploreControls: z.ZodObject<{
    sample_diversity: z.ZodOptional<z.ZodObject<{
        field: z.ZodString;
        max_docs_per_value: z.ZodNumber;
    }, z.core.$strip>>;
    sample_size: z.ZodOptional<z.ZodNumber>;
    timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    use_significance: z.ZodBoolean;
}, z.core.$strip>;
export type GraphExploreControls = z.infer<typeof GraphExploreControls>;
export declare const GraphVertexInclude: z.ZodObject<{
    boost: z.ZodOptional<z.ZodNumber>;
    term: z.ZodString;
}, z.core.$strip>;
export type GraphVertexInclude = z.infer<typeof GraphVertexInclude>;
export declare const GraphVertexDefinition: z.ZodObject<{
    exclude: z.ZodOptional<z.ZodArray<z.ZodString>>;
    field: z.ZodString;
    include: z.ZodOptional<z.ZodArray<z.ZodUnion<readonly [z.ZodObject<{
        boost: z.ZodOptional<z.ZodNumber>;
        term: z.ZodString;
    }, z.core.$strip>, z.ZodString]>>>;
    min_doc_count: z.ZodOptional<z.ZodNumber>;
...
export declare const GraphHop: z.ZodObject<{
    connections: z.ZodOptional<z.ZodObject</*elided*/ any, z.core.$strip>>;
    query: z.ZodOptional<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>;
...
export declare const GraphVertex: z.ZodObject<{
    depth: z.ZodNumber;
    field: z.ZodString;
    term: z.ZodString;
    weight: z.ZodNumber;
 ...
 */
export declare const GraphExploreRequest: z.ZodObject<{
    index: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
    routing: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
    timeout: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodLiteral<-1>, z.ZodLiteral<0>]>>;
    connections: z.ZodOptional<z.ZodLazy<z.ZodObject<{
        connections: z.ZodOptional<z.ZodObject</*elided*/ any, z.core.$strip>>;
        query: z.ZodOptional<z.ZodType<QueryDslQueryContainerShape, unknown, z.core.$ZodTypeInternals<QueryDslQueryContainerShape, unknown>>>;
        vertices: z.ZodArray<z.ZodObject<{
            exclude: z.ZodOptional<z.ZodArray<z.ZodString>>;
    ...
    vertices: z.ZodOptional<z.ZodArray<z.ZodObject<{
        exclude: z.ZodOptional<z.ZodArray<z.ZodString>>;
        field: z.ZodString;
        include: z.ZodOptional<z.ZodArray<z.ZodUnion<readonly [z.ZodObject<{
            boost: z.ZodOptional<z.ZodNumber>;
...
export declare const GraphExploreResponse: z.ZodObject<{
...
//# sourceMappingURL=graph_explore.d.ts.map