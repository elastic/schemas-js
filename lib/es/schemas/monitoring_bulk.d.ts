 ...
 */
export declare const MonitoringBulkRequest: z.ZodObject<{
    system_id: z.ZodString;
    system_api_version: z.ZodString;
...
export declare const MonitoringBulkResponse: z.ZodObject<{
...
//# sourceMappingURL=monitoring_bulk.d.ts.map