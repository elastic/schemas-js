 ...
 */
export declare const SnapshotRepositoryVerifyIntegrityRequest: z.ZodObject<{
    name: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
    blob_thread_pool_concurrency: z.ZodOptional<z.ZodNumber>;
    index_snapshot_verification_concurrency: z.ZodOptional<z.ZodNumber>;
    index_verification_concurrency: z.ZodOptional<z.ZodNumber>;
    max_bytes_per_sec: z.ZodOptional<z.ZodString>;
    max_failed_shard_snapshots: z.ZodOptional<z.ZodNumber>;
    meta_thread_pool_concurrency: z.ZodOptional<z.ZodNumber>;
    snapshot_verification_concurrency: z.ZodOptional<z.ZodNumber>;
    verify_blob_contents: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
export type SnapshotRepositoryVerifyIntegrityRequest = z.infer<typeof SnapshotRepositoryVerifyIntegrityRequest>;
export declare const SnapshotRepositoryVerifyIntegrityResponse: z.ZodAny;
export type SnapshotRepositoryVerifyIntegrityResponse = z.infer<typeof SnapshotRepositoryVerifyIntegrityResponse>;
//# sourceMappingURL=snapshot_repository_verify_integrity.d.ts.map