...
export declare const InferenceGoogleAiServiceType: z.ZodEnum<{
...
export declare const InferenceGoogleAiStudioServiceSettings: z.ZodObject<{
    api_key: z.ZodString;
...
export declare const InferenceGoogleAiStudioTaskType: z.ZodEnum<{
...
export declare const InferenceTaskTypeGoogleAIStudio: z.ZodEnum<{
    completion: "completion";
    text_embedding: "text_embedding";
}>;
export type InferenceTaskTypeGoogleAIStudio = z.infer<typeof InferenceTaskTypeGoogleAIStudio>;
export declare const InferenceInferenceEndpointInfoGoogleAIStudio: z.ZodObject<{
 ...
 */
export declare const InferencePutGoogleaistudioRequest: z.ZodObject<{
    task_type: z.ZodEnum<{
        completion: "completion";
        text_embedding: "text_embedding";
    }>;
    googleaistudio_inference_id: z.ZodString;
...
export declare const InferencePutGoogleaistudioResponse: z.ZodObject<{
    inference_id: z.ZodString;
    task_type: z.ZodEnum<{
        completion: "completion";
        text_embedding: "text_embedding";
...
//# sourceMappingURL=inference_put_googleaistudio.d.ts.map