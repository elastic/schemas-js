...
export const ReindexTaskInfo = z.object({
    ...
    start_time_in_millis: EpochTime.describe('The time at which the reindex task started, in milliseconds since the Unix epoch. Remains the same across graceful shutdown relocations.'),
    ...
    running_time: Duration.describe('The elapsed running time of the reindex task, including relocations, in a human-readable format. Only present when the request includes the `?human=true` query parameter.').optional(),
    running_time_in_nanos: DurationValue.describe('The elapsed running time of the reindex task, including relocations, in nanoseconds.'),
